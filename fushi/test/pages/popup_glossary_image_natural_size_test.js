...
//
// Run: node fushi/test/pages/popup_glossary_image_natural_size_test.js
...
function renderImage(imageData, naturalSize) {
  ...
  const renderer = sandbox.__fushiYomitanGlossaryRenderer;
  const entry = {
    glossaries: [{
      dictionary: 'ImgDict',
...
function renderContent(content) {
  ...
  vm.createContext(sandbox);
  vm.runInContext(source, sandbox, {filename: 'popup.js'});
  return sandbox.__fushiYomitanGlossaryRenderer.render({
    glossaries: [{
