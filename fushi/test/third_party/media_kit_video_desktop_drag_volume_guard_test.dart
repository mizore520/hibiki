...
void main() {
  ...
  test('desktop controls no longer bind onPanUpdate', () {
    expect(
      ...
      isFalse,
      reason:
          'TODO-1097: the desktop GestureDetector must not bind '
  ...
  test('scroll-wheel volume path (onPointerSignal) is preserved', () {
    ...
    expect(
      ...
      isTrue,
      reason:
          'TODO-1097 must keep the scroll-wheel volume path '
    ...
    expect(
      ...
      isTrue,
      reason:
          'the scroll-wheel handler must still react to PointerScrollEvent '
