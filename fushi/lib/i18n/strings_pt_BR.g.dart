...
class _StringsPtBr extends _StringsEn {
	...
	@override String get book_file_location_open => 'Abrir local do arquivo';
	@override String get book_file_location_failed => 'Não foi possível abrir o local do arquivo deste livro.';
	...
	@override String get onboarding_pack_action_download_desc => 'Baixa o pacote inteiro em segundo plano e depois o importa. Dá para cancelar a qualquer momento; da próxima vez ele retoma de onde parou.';
	@override String get onboarding_pack_action_import_existing_desc => 'O pacote já foi baixado; isto o importa. Escolha «Mesclar» na caixa de confirmação e seus dados atuais ficam intactos.';
	@override String get onboarding_pack_action_pick_desc => 'Já pegou o zip do pacote em outro lugar? Importe do disco e pule o download por completo.';
	@override String get onboarding_pack_action_website => 'Abrir a página de download do site';
	@override String get onboarding_pack_action_website_desc => 'Abre o site oficial no navegador. A seção do pacote lista links por partes que você pode passar a um gerenciador de downloads; depois volte aqui e use «Escolher um arquivo de pacote local» para importar o que baixou.';
	@override String get onboarding_pack_action_dictionary_desc => 'Está aprendendo um idioma que não é japonês? Pule o pacote e importe aqui dicionários do seu próprio idioma.';
	@override String get onboarding_pack_action_audio_desc => 'De onde vem o áudio de pronúncia. O pacote já cobre japonês e inglês; adicione aqui fontes on-line para outros idiomas.';
	@override String get onboarding_anki_action_test_desc => 'Verifica se o Fushi consegue falar com o Anki e carrega seus baralhos e tipos de nota. Nada é criado ainda.';
	@override String get onboarding_anki_action_refresh_desc => 'Recarrega baralhos e tipos de nota a partir do Anki. Use depois de criar um baralho novo dentro do Anki.';
	@override String get onboarding_anki_action_get_ankidroid_desc => 'Abre a página do AnkiDroid na loja. O Fushi grava os cartões nele, então precisa estar instalado antes.';
	@override String get onboarding_anki_action_get_anki_desc => 'Abre a página de download do Anki. Instale o Anki e deixe-o aberto enquanto cria cartões.';
	@override String get onboarding_anki_action_install_addon_desc => 'Descompacta para você o complemento AnkiConnect embutido dentro do Anki, que é o que permite ao Fushi conversar com ele. Reinicie o Anki depois.';
	@override String get onboarding_step_anki_action_desc => 'Modelo de cartão, mapeamento de campos, capturas e áudio: os detalhes de como fica um cartão criado. O baralho e o tipo de nota acima já bastam para começar, então abra isto só se quiser mudar como os cartões são montados.';
	@override String get onboarding_step_backup_action_desc => 'Escolha um serviço de backup e entre na conta, para que sua biblioteca sobreviva à perda ou troca de aparelho.';
	@override String get onboarding_step_interconnect_action_desc => 'Pareia este aparelho com seus outros aparelhos para compartilhar uma mesma biblioteca e manter o progresso em sincronia.';
	@override String get onboarding_step_extension_action_desc => 'Mostra como instalar a extensão de navegador e conectá-la ao Fushi, para você também consultar palavras em páginas da web.';
	@override String get onboarding_step_fonts_action_desc => 'Adicione seus próprios arquivos de fonte e escolha qual cada idioma usa.';
	@override String get onboarding_pack_sources_hint => 'Baixado em partes paralelas do GitHub, do site oficial e de um espelho reserva ao mesmo tempo, com checksum em cada parte. O Fushi mede as fontes durante o processo e dá mais partes para a que estiver mais rápida no momento, então não há nada a escolher aqui.';
	...
	@override String get network_proxy_p2p_label => 'Rotear o tráfego P2P (torrent) pelo proxy';
	...
	@override String get onboarding_step_click_lookup_title => 'Toque para consultar palavras';
	@override String get onboarding_click_lookup_tap_title => 'Toque no texto';
	@override String get onboarding_click_lookup_nested_title => 'Continue explorando no pop-up';
	@override String get onboarding_click_lookup_nested_body => 'Toque em outra palavra dentro de uma definição para abrir uma consulta mais profunda. Volte ou toque fora para fechar um nível.';
	@override String get onboarding_click_lookup_mine_title => 'Transforme o resultado em um cartão';
	@override String get onboarding_click_lookup_mine_body => 'Se a definição estiver certa, toque em + para enviar a palavra, a frase, o áudio e a imagem ao criador de cartões.';
	@override String get onboarding_step_global_lookup_title => 'Consultar texto fora do Fushi';
	@override String get onboarding_global_lookup_windows_body => 'No Windows, selecione um texto em outro aplicativo e chame o dicionário sem voltar para o Fushi.';
	@override String get onboarding_global_lookup_windows_select_title => 'Selecione texto em qualquer aplicativo';
	@override String get onboarding_global_lookup_windows_shortcut_title => 'Pressione Ctrl+Alt+D';
	@override String get onboarding_global_lookup_windows_shortcut_body => 'Esse é o atalho global padrão. O Fushi captura a seleção atual e abre um cartão de consulta perto do ponteiro.';
	@override String get onboarding_global_lookup_windows_customize_title => 'Mude o atalho se precisar';
	@override String get onboarding_global_lookup_windows_customize_body => 'Abra Configurações → Atalhos → Global (fora do aplicativo) para definir outra combinação de teclas.';
	@override String get onboarding_global_lookup_windows_action => 'Abrir configurações de atalhos';
	@override String get onboarding_global_lookup_windows_action_desc => 'Permite mudar o atalho de consulta fora do aplicativo. O padrão Ctrl+Alt+D já funciona, então isso é opcional.';
	@override String get onboarding_global_lookup_android_body => 'No Android, o sistema entrega o texto selecionado ao Fushi pelo menu de texto ou pelo painel Compartilhar. Não existe atalho global personalizável.';
	@override String get onboarding_global_lookup_android_select_title => 'Selecione texto em outro aplicativo';
	@override String get onboarding_global_lookup_android_open_title => 'Escolha o Fushi';
	@override String get onboarding_global_lookup_android_open_body => 'Toque em Fushi no menu de seleção de texto. Se ele não aparecer, toque em Compartilhar e escolha o Fushi no painel de compartilhamento.';
	@override String get onboarding_global_lookup_android_continue_title => 'Use o pop-up independente';
	@override String get onboarding_global_lookup_android_continue_body => 'A consulta abre separada do aplicativo de origem. Você pode tocar em mais palavras dentro dela e, ao fechar, volta de onde estava.';
	@override String get onboarding_feature_manual_resources => 'Importar dicionários e áudio manualmente';
	...
	@override String get onboarding_step_manual_resources_title => 'Prepare dicionários e áudio manualmente';
	...
	@override String get onboarding_manual_dictionary_action_desc => 'Abra o gerenciador de dicionários e importe pelo menos um arquivo ou pacote de dicionário compatível. Os tutoriais de consulta só fazem sentido quando uma busca retorna uma definição.';
	@override String get onboarding_manual_audiobook_action => 'Importar um livro com áudio de audiolivro';
	@override String get onboarding_manual_audiobook_action_desc => 'Abra a importação de livros e escolha o livro ou o texto, as legendas alinhadas e um ou mais arquivos de áudio. O áudio precisa de legendas para o Fushi alinhá-lo às frases.';
	@override String get onboarding_manual_pronunciation_action => 'Configurar áudio de pronúncia das palavras';
	@override String get onboarding_manual_pronunciation_action_desc => 'Adicione fontes de pronúncia locais ou on-line usadas pelos verbetes do dicionário. Isso é diferente do áudio de audiolivro anexado a um livro.';
	@override String get onboarding_lookup_verify_action => 'Confirme uma palavra no seu dicionário';
	@override String get onboarding_lookup_verify_action_desc => 'Abra a consulta, digite qualquer palavra que você esteja aprendendo e siga em frente só depois que o dicionário instalado retornar uma definição. O tutorial não fixa nenhuma palavra de exemplo.';
	@override String get onboarding_step_first_anki_card_title => 'Crie seu primeiro cartão do Anki';
	@override String get onboarding_step_first_anki_card_body => 'Esta etapa só aparece depois que esta configuração se conectou ao Anki e um baralho e um tipo de nota utilizáveis foram escolhidos.';
	@override String get onboarding_first_anki_lookup_title => 'Comece por um resultado real do dicionário';
	@override String get onboarding_first_anki_lookup_body => 'Consulte uma palavra que o seu dicionário instalado realmente define. Não há palavra de exemplo fixa que possa faltar no seu dicionário.';
	@override String get onboarding_first_anki_plus_title => 'Toque no botão de mais do verbete';
	@override String get onboarding_first_anki_plus_body => 'O botão de mais abre o criador de cartões com a palavra atual, a leitura, o significado, a frase, o áudio e a imagem disponível.';
	@override String get onboarding_first_anki_save_title => 'Revise e salve';
	@override String get onboarding_first_anki_save_body => 'Confirme o baralho de destino, o tipo de nota e a prévia dos campos e salve. Abra o Anki para conferir se o primeiro cartão chegou.';
	@override String get onboarding_first_anki_action => 'Abrir a consulta e criar um cartão';
	@override String get onboarding_first_anki_action_desc => 'Use uma palavra com definição visível, toque no botão de mais, revise os campos e salve no baralho do Anki conectado.';
	@override String get onboarding_step_click_lookup_body => 'Primeiro confirme uma palavra que o seu dicionário instalado realmente define. Depois use essa mesma palavra para praticar a consulta direta em livros, no texto de OCR de mangás e nas legendas de vídeo.';
	@override String get onboarding_click_lookup_tap_body => 'No celular, toque em um caractere da palavra confirmada; no computador, clique com o botão esquerdo. O Fushi começa por ali e busca a palavra mais longa que encaixa.';
	@override String get onboarding_global_lookup_windows_select_body => 'Selecione a mesma palavra que você já confirmou ter definição no dicionário e deixe a seleção ativa.';
	@override String get onboarding_global_lookup_android_select_body => 'Mantenha pressionada essa mesma palavra confirmada e ajuste as alças de seleção para cobri-la inteira.';
