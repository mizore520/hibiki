...
class _StringsEn implements BaseTranslations<AppLocale, _StringsEn> {
	...
	String get ai_assist_empty => 'AI did not return a usable result. Try describing it differently.';
	String ai_assist_failed({required Object reason}) => 'AI request failed: ${reason}';
	String get ai_assist_generate => 'Generate';
	String get ai_assist_no_provider => 'Choose an AI provider for this feature under Settings and AI first';
	...
	String ai_error_http({required Object code}) => 'Service returned an error (${code})';
	...
	String get ai_feature_custom_theme_summary => 'Let AI pick theme colors from a description';
	String get ai_feature_dict_style => 'Dictionary popup style';
	String get ai_feature_dict_style_summary => 'Let AI generate popup style rules and CSS from a description';
	String get ai_feature_galgame_text_process => 'Game text processing';
	String get ai_feature_galgame_text_process_summary => 'Let AI write cleanup rules for hooked game text';
	String get ai_feature_lapis_style => 'Lapis card style';
	String get ai_feature_lapis_style_summary => 'Let AI generate Lapis card style rules and CSS from a description';
	String get ai_feature_unset => 'Not set';
	String get ai_feature_video_acquire => 'AI video download';
	String get ai_feature_video_acquire_summary => 'Tell AI a work; it parses what you want, picks among matching works and versions, then downloads or subscribes';
	String get ai_feature_video_identify => 'Video identification';
	String get ai_feature_video_identify_summary => 'Let AI pick the matching work when scraping finds several candidates';
	String get ai_feature_video_search => 'Video search assist';
	String get ai_feature_video_search_summary => 'Let AI suggest extra search terms and rank subtitle and torrent results';
	String get ai_features_section => 'Feature providers';
	String get ai_features_section_summary => 'Choose which provider each feature uses';
	String get ai_provider_add => 'Add provider';
	String get ai_provider_allow_http => 'Allow plain HTTP';
	String get ai_provider_allow_http_summary => 'Required for local servers on http://localhost';
	String get ai_provider_api_key => 'API Key';
	String get ai_provider_base_url => 'Base URL';
	String get ai_provider_base_url_invalid => 'Enter a valid HTTP or HTTPS endpoint';
	...
	String ai_provider_models_fetched({required Object count}) => 'Found ${count} models';
	...
	String ai_provider_test_failed({required Object reason}) => 'Test failed: ${reason}';
	String get ai_provider_test_ok => 'Connected';
	String get ai_providers_section => 'Provider configuration';
	String get ai_providers_section_summary => 'Add providers Fushi can call. Built-in presets, plus any Chat Completions compatible API.';
	String get ai_settings_summary => 'Configure AI providers and choose which one powers each feature';
	String get ai_settings_title => 'AI';
	String ai_video_acquire_ai_picked({required Object title, required Object confidence}) => 'Picked: ${title} (AI, ${confidence}). Tap a candidate below to change.';
	String ai_video_acquire_ai_unavailable({required Object reason}) => 'AI is unavailable (${reason}); please pick with the buttons.';
	String get ai_video_acquire_airing_unknown => 'I could not tell whether it is still airing, so subscribing stays available.';
	String ai_video_acquire_already_in_library({required Object title}) => '${title} is already in your library.';
	String ai_video_acquire_already_in_library_episode({required Object title, required Object episode}) => '${title} is already in your library (up to episode ${episode}).';
	String ai_video_acquire_already_subscribed({required Object title}) => '${title} is already subscribed.';
	String get ai_video_acquire_ask_mode => 'It is still airing. Download what is out now, or subscribe for new episodes?';
	String get ai_video_acquire_ask_presence => 'Continue anyway?';
	String get ai_video_acquire_ask_quality => 'Which quality?';
	String ai_video_acquire_ask_resolution_fallback({required Object wanted}) => 'No ${wanted} release. Take one of these instead?';
	String get ai_video_acquire_ask_resource => 'Use this version?';
	String get ai_video_acquire_ask_season => 'Which season?';
	String get ai_video_acquire_ask_subscribe_fallback => 'No release has enough version evidence to subscribe. Download now instead?';
	String get ai_video_acquire_ask_subtitle_language => 'Which subtitle language? (asked once; change it later in settings)';
	String get ai_video_acquire_ask_target_source => 'Download to which video source?';
	...
	String get ai_video_acquire_evidence_original_language => 'the work\'s original language';
	String get ai_video_acquire_evidence_title_script => 'the title\'s script';
	String ai_video_acquire_failed({required Object message}) => 'Failed: ${message}';
	String get ai_video_acquire_greeting => 'Which work do you want? I will find it, pick a release and download or subscribe for you.';
	String get ai_video_acquire_input_hint => 'Tell me which work to download, e.g. "SPY×FAMILY season 2"';
	...
	String ai_video_acquire_submitted_download({required Object count}) => 'Queued ${count} download(s). See the downloads page for progress.';
	String get ai_video_acquire_submitted_subscribe => 'Subscribed. New episodes will download automatically.';
	String ai_video_acquire_subtitle_remembered({required Object language}) => 'Subtitle language ${language} is saved as this work\'s preference.';
	String ai_video_acquire_subtitle_resolved({required Object language, required Object evidence}) => 'Subtitles: ${language} (follows the work\'s language, by ${evidence}).';
	String get ai_video_acquire_subtitle_unresolved => 'I could not tell this work\'s language. Which subtitle language do you want?';
	String ai_video_acquire_summary({required Object version, required Object count, required Object seeders}) => '${version} · ${count} episode(s) · ${seeders} seeders';
	String ai_video_acquire_summary_batch({required Object version, required Object seeders}) => '${version} · complete batch · ${seeders} seeders';
	String ai_video_acquire_summary_missing({required Object episodes}) => 'Not found: episode ${episodes}';
	String get ai_video_acquire_title => 'AI download';
	String get ai_video_acquire_unclear => 'I did not get that. Pick an option or say it differently.';
	String ai_video_acquire_work_chosen({required Object title}) => 'Picked: ${title}';
	String ai_video_acquire_work_not_found({required Object query}) => 'I could not find "${query}". Try another name?';
	...
	String get ai_video_download_quality_hint => 'Used when the AI download assistant picks a release; "Ask each time" asks on every request.';
	...
	String get ai_video_download_subtitle_language_hint => 'Subtitles are always fetched; this decides which language. "Follow the work" uses the work\'s own language.';
	String get ai_video_download_subtitle_language_none => 'No subtitles';
	String get ai_video_download_subtitle_language_original => 'Follow the work\'s language';
	String get ai_video_download_subtitle_language_unset => 'Not set (ask on first use)';
	...
	String get anki_ankimobile_opened => 'AnkiMobile opened. Approve the request there, then return to Fushi.';
	...
	String anki_connect_port_auto_fix_done({required Object port}) => 'Switched AnkiConnect to port ${port}. Restart Anki to apply.';
	String get anki_connect_port_auto_fix_hint => 'Picks a free port and writes it to both Hibiki and the AnkiConnect add-on config. Restart Anki to apply.';
	String anki_connect_port_auto_fix_manual({required Object port}) => 'Hibiki now uses port ${port}, but the AnkiConnect add-on config was not found. Set webBindPort to ${port} in Anki (Tools -> Add-ons -> AnkiConnect -> Config), then restart Anki.';
	String get anki_connect_port_auto_fix_none => 'No free port found on this machine.';
	...
	String get anki_create_lapis_hint => 'Adds the Lapis note type and a Lapis deck to Anki, then selects them as the mining target.';
	String get anki_create_lapis_not_found => 'Anki said the Lapis deck and note type were created, but they are still missing when Hibiki reads the collection back. Open Anki, make sure it is not busy, and try again.';
	...
	String get anki_error_ankidroid_unavailable => 'AnkiDroid is not installed (or its API is disabled), so card access cannot be granted. Install AnkiDroid and enable its API, or switch to AnkiConnect.';
	String get anki_error_ankimobile_no_decks => 'AnkiMobile returned no decks or note types.';
	String get anki_error_ankimobile_not_active => 'Fushi did not come back to the foreground in time, so the clipboard could not be read. Return to Fushi and try again.';
	String get anki_error_ankimobile_pasteboard_denied => 'iOS blocked reading the clipboard. Choose Allow Paste when returning to Fushi, then try again.';
	String get anki_error_ankimobile_pasteboard_empty => 'AnkiMobile did not return any configuration. Approve the request in AnkiMobile, then come back to Fushi.';
	String get anki_error_ankimobile_unavailable => 'Could not open AnkiMobile. Install AnkiMobile and try again.';
	...
	String get anki_error_paired_device_unreachable => 'Couldn\'t create the card because the Fushi Interconnect server could not be reached. Make sure Fushi is running there, or turn off Mine to Fushi Interconnect server in Anki settings to create cards locally.';
	...
	String get anki_error_permission_permanently_denied => 'AnkiDroid card access was permanently denied, so the system no longer shows the permission dialog. Open app settings and grant the AnkiDroid permission, then try again.';
	...
	String get anki_lapis_suggest_body => 'The selected deck and note type can\'t produce a card Anki will accept. Hibiki can add its Lapis note type and deck and select them for you.';
	...
	String get anki_mine_to_server_hint => 'Send mined cards to the Fushi Interconnect server\'s Anki (its decks and settings) instead of this device. Requires an interconnect pairing.';
	...
	String get anki_mined_unverified_subtitle => 'Fushi cannot read your AnkiMobile collection, so the mined mark comes from this device\'s own record — it cannot tell whether the card is still in Anki.';
	...
	String anki_reposition_auto_failed({required Object deck}) => 'Auto reposition failed for ${deck}';
	String get anki_reposition_auto_hint => 'Reposition new cards by frequency about 30 seconds after the last card is mined. AnkiConnect only.';
	String get anki_reposition_auto_title => 'Auto-reposition after mining';
	String get anki_reposition_cancelled => 'Reorder cancelled; nothing was written.';
	String get anki_reposition_dicts_hint => 'Hidden frequency dictionaries are not loaded; unhide them in dictionary management first. Nothing selected means all loaded dictionaries.';
	String get anki_reposition_dicts_none => 'No frequency dictionaries are loaded.';
	String anki_reposition_done({required Object count}) => 'Repositioned ${count} new cards.';
	String anki_reposition_done_skipped({required Object count, required Object skipped}) => 'Repositioned ${count} new cards; ${skipped} were skipped because they are no longer new.';
	String get anki_reposition_empty => 'This deck has no new cards.';
	String anki_reposition_failed({required Object error}) => 'Reorder failed: ${error}';
	String get anki_reposition_gather_order_hint => 'If the deck\'s options use random new card order, positions are ignored. Set the new card gather/sort order to sequential.';
	String get anki_reposition_hint => 'Rewrites the learning order of a deck\'s new cards so common words come first. Review cards are never touched.';
	String get anki_reposition_include_subdecks_hint => 'Includes subdecks; cards in filtered decks are skipped.';
	String get anki_reposition_no_frequency => 'no frequency';
	String anki_reposition_partial({required Object failed, required Object error}) => '${failed} cards could not be written: ${error}';
	String get anki_reposition_preview => 'Preview';
	String get anki_reposition_progress_fetch => 'Reading cards from Anki…';
	String anki_reposition_progress_rank({required Object done, required Object total}) => 'Looking up frequencies (${done}/${total})';
	...
	String get anki_reposition_source_field_hint => 'Reads the field mapped to {frequency-harmonic-rank} (FreqSort in Lapis); no dictionary lookup.';
	String anki_reposition_summary({required Object total, required Object ranked, required Object unranked, required Object changed}) => '${total} new cards: ${ranked} with frequency, ${unranked} without (kept at the end). ${changed} positions will change.';
	...
	String anki_reposition_undo_done({required Object count, required Object skipped}) => 'Restored ${count} cards to their previous positions (${skipped} skipped).';
	String anki_reposition_undo_hint({required Object time}) => 'Restores the positions saved before the last reorder (${time}). Cards studied since then are left alone.';
	...
	String get asr_models_delete_confirm_message => 'Transcription in this language will need the model downloaded again.';
	String get asr_models_delete_confirm_title => 'Delete this model?';
	String asr_models_delete_done_freed({required Object size}) => 'Deleted, freed ${size}';
	String get asr_models_download => 'Download';
	String asr_models_download_failed({required Object error}) => 'Download failed: ${error}';
	String get asr_models_section => 'Speech recognition models';
	String get asr_models_section_summary => 'On-device speech recognition models. Download only the languages you need.';
	String asr_models_status_missing({required Object size}) => 'Not downloaded · ${size}';
	String asr_models_status_partial({required Object obtained, required Object total}) => 'Partially downloaded · ${obtained} / ${total}';
	String asr_models_status_ready({required Object size}) => 'Downloaded · ${size} on disk';
	...
	String get audiobook_export_clip_share_unavailable => 'Clip saved, but the share sheet didn\'t open';
	...
	String get audiobook_material_library_hint => 'Folders of subtitle and text files named by work id. Downloads are paired against them automatically.';
	String get audiobook_material_missing_dir => 'Missing';
	String get audiobook_material_none => 'No folders added yet';
	String audiobook_material_status({required Object dirs, required Object works}) => '${dirs} folder(s), ${works} work(s) recognized';
	...
	String get audiobook_subtitle_source_transcribe_hint => 'Generate from the selected audio with the on-device speech model';
	...
	String get audiobook_transcribe_alignment_hint => 'Generated text is aligned to the audio in a second model pass before saving. The alignment model is downloaded if needed.';
	String get audiobook_transcribe_discard => 'Discard progress';
	String audiobook_transcribe_done({required Object cues, required Object segments}) => 'Done: ${cues} cues from ${segments} speech segments';
	String audiobook_transcribe_elapsed_total({required Object elapsed}) => 'Total time ${elapsed}';
	String get audiobook_transcribe_engine_system => 'System speech (Apple)';
	String get audiobook_transcribe_engine_system_hint => 'Uses the built-in speech model — no 1 GB download from us. The system still fetches its own language assets the first time, and keeps them shared across apps.';
	String get audiobook_transcribe_engine_system_install => 'Install language';
	String get audiobook_transcribe_engine_system_installing => 'Asking the system to install the language…';
	String get audiobook_transcribe_engine_system_no_pause => 'This engine can\'t pause mid-file — stopping discards the current file\'s progress.';
	...
	String audiobook_transcribe_failed({required Object error}) => 'Transcription failed: ${error}';
	String audiobook_transcribe_fallback({required Object reason}) => 'GPU unavailable, fell back to CPU: ${reason}';
	String get audiobook_transcribe_intro => 'Transcribes the audio locally with an on-device speech model for the selected language and generates subtitles for alignment. Nothing is uploaded.';
	...
	String audiobook_transcribe_model_custom_added({required Object name}) => 'Added ${name}';
	...
	String get audiobook_transcribe_model_custom_blank_hint => 'The blank symbol in tokens.txt. sherpa-onnx exports use <blk>; Omnilingual uses <s>. Getting it wrong garbles the whole transcript.';
	String get audiobook_transcribe_model_custom_context => 'Decoder context size';
	String get audiobook_transcribe_model_custom_detach => 'Remove from list';
	String get audiobook_transcribe_model_custom_detach_hint => 'Only removes it from the model list. Your files are not deleted.';
	String get audiobook_transcribe_model_custom_error_model => 'No .onnx model file in that folder.';
	String get audiobook_transcribe_model_custom_error_tokens => 'No tokens.txt in that folder.';
	String get audiobook_transcribe_model_custom_error_transducer => 'Found an encoder but no decoder / joiner next to it.';
	String get audiobook_transcribe_model_custom_index => 'Index tensor type';
	String get audiobook_transcribe_model_custom_intro => 'Point Hibiki at a folder holding a sherpa-onnx export (encoder / decoder / joiner, or a single CTC model, plus tokens.txt). The files stay where they are — only the small VAD model (640 KB) is fetched if the folder has none.';
	...
	String get audiobook_transcribe_model_discarded => 'The model file could not be read and was removed. Download it again.';
	String get audiobook_transcribe_model_download => 'Download model';
	String audiobook_transcribe_model_download_needed({required Object size}) => 'Model download required: ${size}';
	String audiobook_transcribe_model_downloading({required Object name, required Object received, required Object total}) => 'Downloading ${name}… ${received} / ${total}';
	String get audiobook_transcribe_model_fit_desktop => 'Large — best on a desktop GPU';
	String get audiobook_transcribe_model_fit_heavy_mobile => 'Large — runs on phones, but slowly';
	String get audiobook_transcribe_model_fit_light => 'Light — fine on phones and desktop';
	String get audiobook_transcribe_model_label => 'Model';
	String audiobook_transcribe_model_ready({required Object variant}) => 'Model ready (${variant})';
	String get audiobook_transcribe_model_scope_dedicated => 'Dedicated — most accurate for this language';
	String get audiobook_transcribe_model_scope_multilingual => 'Multilingual — wide coverage, less accurate per language';
	String get audiobook_transcribe_needs_audio => 'Pick audio files first';
	String get audiobook_transcribe_pause => 'Pause';
	String get audiobook_transcribe_paused_hint => 'Progress is saved. Pick the same audio files later to resume.';
	...
	String audiobook_transcribe_probe_failed({required Object reason}) => 'GPU detection failed, planning for CPU: ${reason}';
	String audiobook_transcribe_progress({required Object done, required Object total, required Object file, required Object files}) => '${done} / ${total} · file ${file}/${files}';
	String audiobook_transcribe_remote_model_missing({required Object device}) => '${device} has no model for this language';
	String audiobook_transcribe_remote_running({required Object device, required Object percent}) => 'Transcribing on ${device}… ${percent}%';
	String audiobook_transcribe_remote_uploading({required Object device, required Object done, required Object total}) => 'Uploading audio to ${device}… (${done}/${total})';
	String get audiobook_transcribe_result_name => 'Generated by on-device transcription';
	...
	String audiobook_transcribe_run_remote({required Object device}) => '${device} (interconnect host)';
	String audiobook_transcribe_running_on({required Object provider}) => 'Running on ${provider}';
	String audiobook_transcribe_running_on_static({required Object provider}) => 'Running on ${provider} · fused static graph';
	String audiobook_transcribe_speed({required Object elapsed, required Object eta, required Object speed}) => 'Elapsed ${elapsed} · remaining ${eta} · ${speed}× realtime';
	String get audiobook_transcribe_start => 'Start transcription';
	String get audiobook_transcribe_title => 'On-device transcription';
	String get audiobook_transcribe_unavailable => 'On-device transcription is not available on this platform';
	...
	String get auto_add_char_position_to_tags => 'Auto-add mining position to tags';
	String get auto_add_char_position_to_tags_hint => 'Tags each card with chars_12345 — how many characters into the book it was mined.';
	...
	String get backup_category_games_desc => 'Game library, metadata sources and covers';
	...
	String backup_export_dictionaries_skipped({required Object n, required Object names}) => 'Exported, but ${n} dictionary(s) were skipped: their files are missing on this device (${names})';
	...
	String get browser_extension_test_page_action_desc => 'Opens a page served by Fushi in your browser to check the toolbar popup and Shift lookup.';
	String get browser_extension_test_page_intro => 'This page is served by Fushi itself, so the extension can inject it. Try the two things below.';
	String get browser_extension_test_page_probe_checking => 'Checking whether the extension is injected…';
	String get browser_extension_test_page_probe_missing => 'The extension was not injected. Load it in your browser and reload this page.';
	String get browser_extension_test_page_probe_ok => 'The extension is injected on this page.';
	String get browser_extension_test_page_sample_label => 'Practice sentence';
	String get browser_extension_test_page_server_off => 'Enable the lookup server first, then try again.';
	String get browser_extension_test_page_step_lookup_body => 'Hold Shift and hover a word in the sentence below; the dictionary popup should appear.';
	String get browser_extension_test_page_step_lookup_title => 'Look a word up with Shift';
	String get browser_extension_test_page_step_popup_body => 'Click the Fushi icon in the top-right toolbar; the extension popup should open.';
	String get browser_extension_test_page_step_popup_title => 'Open the extension from the toolbar';
	...
	String get card_source_review_conflict_warning => 'Avoid editing this note in Anki and Fushi at the same time. If a conflict occurs, your changes stay in a local draft.';
	String get card_source_review_continue => 'Continue reading here';
	String get card_source_review_draft_discard => 'Discard draft';
	String get card_source_review_draft_existing => 'A draft already exists. Resume or discard it before making another edit.';
	String get card_source_review_draft_resume => 'Resume draft';
	String get card_source_review_draft_saved => 'Changes remain in a local draft. Resume it to review and submit again.';
	String get card_source_review_failed => 'Changes were not saved. The note may have changed or the device is unavailable.';
	String get card_source_review_fingerprint_mismatch => 'This file does not match the card source. Open the matching file to continue.';
	String get card_source_review_invalid => 'This source link is invalid or uses an unsupported version.';
	String get card_source_review_local_required => 'Download this video before reviewing it without changing server progress.';
	String get card_source_review_media_missing => 'Source media is unavailable on this device. Import or download it first.';
	String get card_source_review_missing => 'The original note could not be found. Sync Anki or connect the Fushi Interconnect server it lives on.';
	...
	String get card_source_review_title => 'Reviewing card source · Reading progress is preserved';
	String get card_source_review_video_continue => 'Continue watching here';
	String get card_source_review_video_return => 'Return to original watch position';
	String get card_source_review_video_title => 'Reviewing card clip · Watch progress is preserved';
	String get card_source_review_video_watching => 'Watching normally · Watch progress is being saved';
	...
	String collection_episode_anidb_number({required Object number}) => 'AniDB ep ${number}';
	...
	String get collection_episode_link_cleared => 'Manual pin cleared; the next scrape links automatically';
	String collection_episode_link_episode({required Object number}) => 'Episode ${number}';
	String get collection_episode_link_hint => 'Pin which episode this file is. Kept on every rescrape (Shoko UserVerified).';
	String get collection_episode_link_manual => 'Pin to season/episode…';
	String get collection_episode_link_saved => 'Episode pinned; kept on rescrape';
	String collection_episode_link_season({required Object number}) => 'Season ${number}';
	...
	String get collection_rescrape_not_planned => 'This collection isn\'t in any local video source\'s scrape plan';
	...
	String collection_tmdb_ordering_counts({required Object groups, required Object episodes}) => '${groups} groups · ${episodes} episodes';
	String get collection_tmdb_ordering_default => 'TMDB default ordering';
	String get collection_tmdb_ordering_hint => 'Pick which TMDB ordering decides seasons and episodes for this show. AniDB episode links are recomputed against it.';
	String get collection_tmdb_ordering_none => 'TMDB has no alternate orderings for this show';
	String get collection_tmdb_ordering_saved => 'Ordering saved, rescraping…';
	String get collection_tmdb_ordering_unavailable => 'No TMDB identity yet; scrape the show first';
	...
	String get delete_local_files_video_desc => 'The video, its sidecar subtitles and its download task are removed from this device. This cannot be undone.';
	...
	String get delete_statistics_video_desc => 'Watch time, subtitle characters and lookup/mining counts for this video are removed from statistics on every device';
	...
	String dict_error_connect_timeout({required Object host}) => 'Could not reach ${host} (connection timed out)';
	String dict_error_connection({required Object host}) => 'Could not connect to ${host}';
	String dict_error_http_status({required Object host, required Object status}) => '${host} returned HTTP ${status}';
	String dict_error_stall_timeout({required Object host}) => '${host} stopped sending data';
	...
	String get dict_style_ai_applied => 'AI suggestion loaded into the draft. Check the preview, then save.';
	String get dict_style_ai_hint => 'Describe the look you want, e.g. bold blue headwords, smaller glossary text';
	...
	String dict_task_failed_download({required Object name, required Object reason}) => 'Download failed: ${name} (${reason})';
	String dict_task_failed_import({required Object name, required Object reason}) => 'Import failed: ${name} (${reason})';
	String dict_task_failed_summary({required Object n}) => '${n} dictionary(s) failed';
	...
	String get discovery_alist_allow_http_hint => 'Needed for a self-hosted site on your local network';
	String get discovery_alist_enabled => 'Enabled';
	String get discovery_alist_kinds => 'Show in';
	String get discovery_alist_kinds_hint => 'Pick at least one library to list this site in';
	...
	String get discovery_alist_settings_hint => 'Browse and download files from your own AList or OpenList site. Leave the account empty to browse as a guest';
	String get discovery_alist_settings_title => 'AList / OpenList sites';
	String get discovery_alist_test => 'Test connection';
	String discovery_alist_test_failed({required Object reason}) => 'Connection failed: ${reason}';
	String discovery_alist_test_ok({required Object count}) => 'Connected. Root folder has ${count} entries';
	String get discovery_alist_url => 'Site URL';
	String get discovery_alist_url_hint => 'The site root, for example https://od.example.com';
	String get discovery_alist_url_invalid => 'Enter a valid HTTP or HTTPS site URL';
	String get discovery_alist_url_needs_http_optin => 'Plain HTTP needs the switch below';
	String get discovery_alist_username => 'Username';
	String get discovery_alist_username_hint => 'Leave empty to browse as a guest';
	...
	String discovery_hidden_suspected_manga_count({required Object n}) => '${n} suspected manga hidden';
	String discovery_hidden_zero_seeders_count({required Object n}) => '${n} unseeded hidden';
	...
	String get discovery_opds_allow_http_hint => 'Needed for a self-hosted server on your local network';
	...
	String get discovery_opds_settings_hint => 'Browse and download books and comics from your own OPDS server, such as BookOrbit, Calibre-Web, Komga or Kavita';
	String get discovery_opds_settings_title => 'OPDS catalogs';
	String get discovery_opds_test => 'Test connection';
	String discovery_opds_test_failed({required Object reason}) => 'Connection failed: ${reason}';
	String discovery_opds_test_ok({required Object count}) => 'Connected. Root catalog has ${count} entries';
	String get discovery_opds_url => 'Catalog URL';
	String get discovery_opds_url_hint => 'The OPDS endpoint, for example https://books.example.com/api/v1/opds';
	String get discovery_opds_url_invalid => 'Enter a valid HTTP or HTTPS catalog URL';
	String get discovery_opds_url_needs_http_optin => 'Plain HTTP needs the switch below';
	...
	String download_batch_delete_confirm({required Object n}) => 'Delete ${n} download task(s)?';
	String download_batch_done({required Object n}) => '${n} task(s) processed';
	String download_batch_failed({required Object n}) => '${n} failed';
	String download_batch_unsupported({required Object n}) => '${n} skipped (not supported)';
	...
	String get download_execution_host_hint => 'New download tasks are handed to this device and saved into its library. Pair a device under Interconnect first.';
	String get download_execution_host_title => 'Download on device';
	String get download_execution_host_unreachable => 'The download device set in Downloads settings is not reachable. Nothing was started.';
	String get download_execution_remote_kind_unsupported => 'The download device does not import this content kind';
	String get download_execution_remote_magnet_only => 'The download device only accepts magnet links';
	String get download_execution_remote_queued => 'Handed to the download device';
	String get download_no_managed_video_source => 'No managed video source yet. Add a local folder to store downloaded files so finished videos can land in your library.';
	...
	String download_remote_jobs_title({required Object device}) => 'Tasks on ${device}';
	String get download_request_failed => 'Could not create the download. Check the download settings and task list, then try again.';
	String get download_resource_resolve_failed => 'Could not fetch the download resource. Check the network and proxy settings, then try again.';
	...
	String download_subscription_choice_hint_batch({required Object group, required Object resolution}) => 'Download the whole ${group} · ${resolution} batch once. A batch has no next episode to follow.';
	...
	String download_target_remote({required Object device}) => '${device} (interconnect host)';
	...
	String get download_task_audiobook_needs_alignment => 'Audio only - an alignment file (subtitle) is still needed before this can open as a book.';
	...
	String get download_torrent_invalid => 'The source returned invalid torrent data. Retry later or choose another source.';
	String get download_torrent_selection_failed => 'Could not uniquely match this volume in the torrent. Refresh the catalog or choose another source.';
	String get download_tracker_auto_add => 'Automatically add subscription trackers to new downloads';
	String get download_tracker_auto_add_hint => 'The list is cached for 6 hours. A subscription failure will not block the download.';
	String download_tracker_fetch_failed({required Object message}) => 'Could not fetch trackers: ${message}';
	String download_tracker_preview_count({required Object count}) => 'Fetched ${count} trackers';
	String get download_tracker_preview_empty => 'Fetch the subscription to preview supported HTTP, HTTPS, and UDP trackers.';
	...
	String get drag_drop_unsupported_on_downloads => 'Drop .torrent files here to add a download task. Other files belong to the Books, Manga, or Video pages.';
	...
	String get gal_card_lookup_independent_size => 'Independent in-game card size';
	String get gal_card_lookup_independent_size_hint => 'Size the in-game lookup card separately from the desktop overlay card';
	...
	String get gal_hook_click_lookup_hint => 'Off means clicks on the caption never trigger a lookup — useful with click-through on, when you would rather not hit a word by accident.';
	String get gal_hook_fold_progressive_lines => 'Merge split dialogue lines';
	String get gal_hook_fold_progressive_lines_hint => 'Some engines redraw the whole line on every click, so one line is captured several times. Fold those snapshots into a single line.';
	String get gal_hook_ingame_lookup => 'In-game dictionary lookup';
	String get gal_hook_ingame_lookup_engine_unsupported => 'This game engine has no in-game lookup sensor yet';
	String get gal_hook_ingame_lookup_exe_hash_copied => 'Executable SHA-256 copied';
	String get gal_hook_ingame_lookup_exe_hash_copy => 'Copy game executable SHA-256';
	String get gal_hook_ingame_lookup_exe_hash_unavailable => 'Could not read the game executable';
	...
	String get gal_hook_ingame_lookup_version_unsupported => 'This game version is not on the supported list yet';
	String get gal_hook_lookup_trigger => 'Lookup trigger';
	String get gal_hook_lookup_trigger_hint => 'Which mouse button looks up the word under the pointer. Independent of the switch above: you can turn tap-lookup off and still look up with a side button.';
	...
	String get gal_hook_passthrough_blocks_mouse => 'Caption still catches clicks while clicking through';
	String get gal_hook_passthrough_blocks_mouse_hint => 'On: text lines still take clicks so you can tap a word. Off: the whole overlay is transparent to the mouse — you can click whatever is underneath, but tapping words no longer works.';
	...
	String get gal_hook_toolbar_auto_hide_hint => 'Hide the toolbar until the pointer reaches the caption box, LunaHook style. Hidden means really hidden — those pixels go back to the game.';
	...
	String get gal_mining_image_mode_video_clip_hint => 'Records the game window from the moment the line appears until you mine the card, mixed with the sentence audio. Falls back to an animated image or screenshot when recording has not started or fewer than 2 frames were captured.';
	...
	String get game_hook_reason_native_loopback_ack_timeout => 'The audio capture policy was not confirmed in time. Text capture still works; try again if game audio is missing.';
	...
	String get game_japanese_locale_evidence_dir_file_name_chinese_patch => 'File names mark a Chinese patch';
	String get game_japanese_locale_evidence_dir_file_name_japanese => 'File names contain kana';
	String get game_japanese_locale_evidence_dir_text_gbk => 'Text files are GBK';
	String get game_japanese_locale_evidence_dir_text_shift_jis => 'Text files are Shift-JIS';
	String get game_japanese_locale_evidence_dir_text_simplified_hanzi => 'Text files contain Simplified Chinese';
	String get game_japanese_locale_evidence_exe_shift_jis_strings => 'Executable contains Shift-JIS strings';
	String get game_japanese_locale_evidence_manifest_utf8_code_page => 'Manifest declares a UTF-8 code page';
	String get game_japanese_locale_evidence_user_language_japanese => 'Content language is Japanese';
	String get game_japanese_locale_evidence_user_language_other => 'Content language is not Japanese';
	String get game_japanese_locale_evidence_version_info_chinese => 'Version resource is Chinese';
	String get game_japanese_locale_evidence_version_info_japanese => 'Version resource is Japanese';
	...
	String get game_lookup_attached_calibration_ended => 'Calibration has ended. Close this dialog before starting again.';
	String get game_lookup_attached_calibration_failed => 'Calibration was not applied. Make sure the game window and dialogue are working normally, then try again.';
	String get game_lookup_attached_calibration_paused => 'Calibration is paused while the game is hidden or in the background. Return with Alt+Tab and wait for the highlighted boxes before clicking. You can still adjust and confirm here.';
	String get game_lookup_attached_calibration_preparing => 'Preparing click protection. Do not click the game dialogue yet.';
	String get game_lookup_attached_calibration_ready => 'Ready. Click the highlighted character boxes in order; clicks outside the boxes still control the game.';
	String get game_lookup_attached_calibration_region_help => 'Adjust the region here, or drag the frame on a screenshot in the calibration window. In the game, only clicks on the highlighted boxes are used.';
	String get game_lookup_attached_calibration_short_text => 'The line needs at least three characters to calibrate.';
	String get game_lookup_attached_calibration_text_changed => 'The dialogue changed. Cancel and reopen calibration for the current line.';
	String get game_lookup_attached_calibration_title => 'Calibrate body text';
	String get game_lookup_attached_calibration_unavailable => 'Calibration is unavailable. Stop clicking the game dialogue; adjust the parameters or cancel calibration.';
	...
	String get game_lookup_attached_letter_spacing => 'Letter spacing / client height';
	...
	String get game_lookup_attached_no_ocr => 'No OCR · horizontal body text only';
	...
	String get game_lookup_attached_probe_waiting => 'Waiting for the matching click in the game';
	String get game_lookup_attached_probes_hint => 'In the game, click the highlighted first, middle and last characters in order, then confirm each character below.';
	String get game_lookup_attached_profile => 'Profile';
	String get game_lookup_attached_profile_clear => 'Clear profile';
	String get game_lookup_attached_profile_clear_body => 'The saved rectangle, text layout, and executable-specific click authorization will be removed.';
	String get game_lookup_attached_profile_clear_title => 'Clear lookup profile?';
	...
	String get game_lookup_attached_risk_active => 'Risk accepted · may double-trigger';
	String get game_lookup_attached_risk_body => 'The input shield is not verified for this executable. Clicking a glyph may also advance dialogue or trigger a choice. This authorization is stored only for the current executable hash and is revoked after an update.';
	...
	String get game_lookup_attached_thread_required => 'Select one body-text thread before calibration.';
	...
	String get game_lookup_samples_anchor_hint => 'Select a character, then click its center in the screenshot. Add points near the beginning and end of a line.';
	String get game_lookup_samples_apply => 'Apply to game';
	String get game_lookup_samples_auto_align => 'Align from screenshot';
	String get game_lookup_samples_auto_align_all => 'Align all calibration samples';
	String get game_lookup_samples_auto_align_current => 'Align current screenshot';
	String get game_lookup_samples_auto_all_hint => 'Use all calibration samples together and check the result against the complete set.';
	String get game_lookup_samples_auto_character_positions_inconsistent => 'The generated cells differ too much from the detected positions. This result was not applied.';
	String get game_lookup_samples_auto_current_hint => 'Measures this screenshot. A complete line of dialogue spanning two or more rows works best, because it shows how many characters fit on a row.';
	String get game_lookup_samples_auto_failed => 'Could not measure the cells reliably. Use a screenshot of a complete line spanning two or more rows, and make sure the orange frame covers all of the dialogue but not the speaker name or buttons. Nothing was changed.';
	String get game_lookup_samples_auto_geometry_out_of_bounds => 'The measured cells extend beyond the screenshot. Keep the orange frame inside the dialogue area and try again.';
	String get game_lookup_samples_auto_geometry_weak => 'Too few characters could be read to work out the layout. Use a longer line.';
	String get game_lookup_samples_auto_grid => 'Cells were measured automatically';
	String get game_lookup_samples_auto_hint => 'Cells are measured. Hover the small blue boxes to check which character each one covers; if they are off, adjust the orange frame and align again.';
	String get game_lookup_samples_auto_inconsistent => 'The samples have inconsistent wrapping or character grids, so one layout cannot be applied. Check whether the highlighted sample captured the complete dialogue.';
	String get game_lookup_samples_auto_indent_ambiguous => 'Could not tell which cell the second row starts at. Use a line with two or more rows and a longer second row.';
	...
	String get game_lookup_samples_auto_line_wrap_inconsistent => 'The measured cell width does not reproduce where the screenshot wraps. Try another screenshot.';
	...
	String get game_lookup_samples_auto_pending => 'Not aligned yet. Frame the dialogue text with the orange frame (leave out the speaker name and buttons), then select “Align current screenshot”.';
	...
	String get game_lookup_samples_auto_preview_text_overflow => 'The measured cells go beyond the orange frame. Make the frame a little larger and try again.';
	String get game_lookup_samples_auto_preview_unavailable => 'The layout preview is unavailable right now. Try again in a moment.';
	...
	String get game_lookup_samples_auto_text_alignment_failed => 'The text read from the screenshot does not match the received dialogue. Make sure the screenshot shows the current line fully displayed.';
	String get game_lookup_samples_auto_text_alignment_weak => 'The text read from the screenshot only partly matches the received dialogue, so the result may be inaccurate.';
	String get game_lookup_samples_auto_unsupported => 'This screenshot contains characters whose width cannot be measured yet. Use another line, or fine-tune the cells by hand.';
	...
	String get game_lookup_samples_capture_changed => 'The dialogue or window changed while capturing. Keep a complete line visible, then capture again.';
	String get game_lookup_samples_capture_failed => 'Could not capture a sample. Try again; if it still fails, keep this window open and report this message.';
	String get game_lookup_samples_capture_overlay => 'Could not safely hide or restore the lookup layer. Close the calibration window, reattach to the game, and try again.';
	String get game_lookup_samples_capture_replace => 'Replace current sample';
	String get game_lookup_samples_capture_source => 'No dialogue has been received yet. Make sure the game is attached and a body text thread is selected in the dialogue workbench.';
	String get game_lookup_samples_capture_surface_mapping => 'The game window and the upscaled image cannot be aligned right now, so a calibration screenshot cannot be captured.';
	String get game_lookup_samples_capture_surface_not_ready => 'The lookup layer is switching state and cannot capture right now. Wait a second or two and try again; if it keeps failing, reattach the game.';
	String get game_lookup_samples_capture_unavailable => 'This window could not be captured. Your saved calibration is unchanged; the capture failure has been logged for diagnosis.';
	String get game_lookup_samples_capture_unsupported => 'This text contains a ruby format that is not supported yet. Capture a normal dialogue line instead.';
	String get game_lookup_samples_capture_window => 'Could not get the complete game image. Confirm that the game window is not minimized, then capture again.';
	String get game_lookup_samples_clear_anchors => 'Clear marked points';
	String get game_lookup_samples_continuation_cells => 'cells';
	String get game_lookup_samples_continuation_hint => 'How many cells the second and later rows shift right (positive) or left (negative) from the first row; 0 lines them up with the first row.';
	...
	String get game_lookup_samples_few_points => 'Few training points: alignment is sensitive to small marking errors. Add spread-out points in multiple samples before judging accuracy.';
	String get game_lookup_samples_fit => 'Align from marked points';
	String get game_lookup_samples_fit_all => 'Fit all calibration samples together';
	String get game_lookup_samples_fit_all_hint => 'Use this when several complete samples share one grid; the complete set is checked together.';
	String get game_lookup_samples_fit_failed => 'The marked points do not fit one layout. Check the points or adjust the font and wrapping.';
	...
	String get game_lookup_samples_grid_edit_hint => 'Drag inside the blue frame to move all cells; drag its corners to resize; drag the right edge of any cell to change the width of every cell.';
	...
	String get game_lookup_samples_grid_line_width => 'Adjust cells per line (whole numbers)';
	String get game_lookup_samples_grid_move => 'Move text grid';
	String get game_lookup_samples_grid_start => 'Correct grid start';
	String get game_lookup_samples_hint => 'Capture once the line is fully shown. A line spanning two or more rows makes automatic alignment more reliable.';
	String get game_lookup_samples_hover => 'Move the pointer over a box to inspect its character.';
	String get game_lookup_samples_layout_title => 'Character layout (blue boxes)';
	String get game_lookup_samples_limit => 'Keep up to eight samples. Remove a sample before capturing another.';
	String get game_lookup_samples_load_failed => 'The saved sample draft could not be read.';
	...
	String get game_lookup_samples_nudge_right => 'Move right by one screenshot pixel';
	String get game_lookup_samples_nudge_up => 'Move up by one screenshot pixel';
	String get game_lookup_samples_pan_mode => 'Pan image';
	String get game_lookup_samples_pixel_advanced_hint => 'These are source screenshot pixels for the orange recognition frame. They are a manual backup, not character size.';
	String get game_lookup_samples_pixel_hint => 'Values are screenshot pixels. Enter a number and press Enter, or use the minus/plus buttons.';
	...
	String get game_lookup_samples_region_hint => 'Drag inside the orange frame to move it; drag its corners to resize it.';
	String get game_lookup_samples_region_mode => 'Move/resize area';
	String get game_lookup_samples_region_title => 'Dialogue area (orange outline)';
	String get game_lookup_samples_remove => 'Remove sample';
	String get game_lookup_samples_residual => 'Point error';
	String get game_lookup_samples_residual_hint => 'Distance from your reference points, not measured accuracy of the game glyphs.';
	String get game_lookup_samples_save => 'Save draft';
	String get game_lookup_samples_save_failed => 'Automatic save failed. The current samples remain in this window; try again.';
	String get game_lookup_samples_saved => 'Saved automatically on this device';
	String get game_lookup_samples_saved_hint => 'Samples and screenshots are saved automatically on this device.';
	String get game_lookup_samples_search_hint => 'Enclose the whole dialogue text area, leaving out the speaker name and buttons; a slightly larger frame is fine. Text is only searched inside the frame, so align again after moving it.';
	String get game_lookup_samples_search_title => 'Recognition region (orange frame)';
	String get game_lookup_samples_special_chars_add => 'Add special characters';
	String get game_lookup_samples_special_chars_hint => 'Set a separate width for punctuation that occupies a narrower or wider cell. Other characters keep the normal width.';
	String get game_lookup_samples_special_chars_input => 'Characters';
	String get game_lookup_samples_special_chars_input_hint => 'Enter one or more characters, such as 、。';
	String get game_lookup_samples_special_chars_remove => 'Remove special character';
	String get game_lookup_samples_special_chars_title => 'Special-character cell width';
	String get game_lookup_samples_title => 'Calibrate with samples';
	String get game_lookup_samples_unavailable => 'This layout cannot cover the complete line. Adjust the area or font size.';
	String get game_lookup_samples_validation => 'Validation sample';
	String get game_lookup_samples_validation_hint => 'Validation points are checked but do not change the fitted layout.';
	...
	String game_session_japanese_locale_evidence({required Object evidence}) => 'Evidence: ${evidence}';
	String get game_session_japanese_locale_evidence_insufficient => 'insufficient evidence';
	...
	String game_session_japanese_locale_skipped_hint({required Object evidence}) => 'The game was started without a Japanese locale (auto verdict: ${evidence}). If its text looks garbled, set this game\'s Japanese locale to Always on.';
	String get game_session_japanese_locale_skipped_hint_not_32bit => 'The game was started without a Japanese locale: the auto verdict says it needs one, but Locale Emulator only supports 32-bit games.';
	String get game_session_japanese_locale_skipped_hint_system_japanese => 'The game was started without a Japanese locale: this system already uses the Japanese (CP932) code page, so nothing needs to change.';
	...
	String get game_stream_android_only => 'Game stream receiving is available on Android only.';
	...
	String get game_stream_hook_required => 'Start a game with an active Hook session first.';
	String get game_stream_host_connecting => 'Connecting…';
	String get game_stream_host_launch_off => 'Remote launch is off on this host. You can still join streams started on the PC.';
	String game_stream_host_online({required Object n}) => 'Online · ${n} games';
	String get game_stream_host_outdated => 'This host runs an older Fushi without the game library. Update Fushi on Windows.';
	...
	String get game_stream_input_pointer_unsupported => 'This game does not accept touch clicks; use the pad buttons';
	String get game_stream_input_rejected => 'Input was rejected. Bring the game window to the foreground on the host.';
	String get game_stream_input_window_hidden => 'The game window is minimized or hidden on the host';
	...
	String get game_stream_keys_hint => 'These key mappings apply only to this streaming session.';
	String game_stream_last_played({required Object time}) => 'Played ${time}';
	String get game_stream_launch_busy => 'The host is already running another game. Close it on the PC or join its stream.';
	String get game_stream_launch_connecting => 'Connecting to the stream…';
	String get game_stream_launch_disabled => 'Remote launch is off on this host. On the Windows PC, turn on “Allow remote launch” in Interconnect settings.';
	String get game_stream_launch_exe_missing => 'The game executable was not found on the host.';
	String get game_stream_launch_failed => 'The host could not start the game.';
	String get game_stream_launch_helper_missing => 'The host is missing its capture helper. Reinstall or update Fushi on Windows.';
	String get game_stream_launch_starting => 'Starting the game…';
	String get game_stream_launch_stream_failed => 'The game is running, but the host could not start streaming.';
	String get game_stream_launch_superseded => 'Another launch replaced this one.';
	String get game_stream_launch_timeout => 'The host did not finish launching in time.';
	String get game_stream_launch_unknown_game => 'This game is no longer in the host library. Refresh and try again.';
	String get game_stream_launch_waiting_window => 'Waiting for the game window…';
	String get game_stream_launch_window_missing => 'The game started, but its window did not appear in time.';
	String get game_stream_leave_failed => 'Could not notify the host that streaming has ended';
	String get game_stream_library_empty => 'This host has no games. Add games on the Windows PC first.';
	String get game_stream_library_subtitle => 'Launch games on your PC and stream them here';
	...
	String get game_stream_mine_audio_fallback_disabled => 'This line has no voice clip and the host only mines with the game\'s own voice';
	String get game_stream_mine_capture_failed => 'The host could not capture media for this card';
	String get game_stream_mine_duplicate => 'This card is already in the host\'s Anki';
	String get game_stream_mine_failed => 'Host card creation failed';
	String get game_stream_mine_host_error => 'The host failed to add the card; check Anki on the host';
	String get game_stream_mine_line_expired => 'This line has expired on the host; look up the current line';
	String get game_stream_mine_snapshot_missing => 'The host has no screenshot for this line; look up the current line';
	String get game_stream_mine_success => 'Card created on the host';
	String get game_stream_module_hint => 'Launch and stream games from your Windows PC';
	String get game_stream_more => 'More';
	String get game_stream_no_hosts => 'No paired Windows host yet. Pair this device with your PC in Interconnect settings.';
	String get game_stream_none => 'No paired host is streaming. Start streaming from the Windows game page first.';
	String get game_stream_open_interconnect => 'Open Interconnect settings';
	String get game_stream_remote_launch_hint => 'Paired Android devices can start games from this PC\'s library and stream them';
	...
	String get game_stream_settings_adaptive_hint => 'Lower the bitrate when the network is congested';
	String get game_stream_settings_apply_failed => 'Could not apply stream settings';
	String get game_stream_settings_audio => 'Play game audio';
	String get game_stream_settings_bitrate => 'Bitrate';
	String get game_stream_settings_capped => 'The host is capturing at a lower limit; restart the stream to go higher';
	String get game_stream_settings_codec => 'Video codec';
	String get game_stream_settings_codec_auto => 'Auto';
	String get game_stream_settings_codec_hint => 'Takes effect on the next connection; falls back automatically if the device cannot decode it';
	...
	String get game_stream_settings_input_focus_hint => 'Window only lets the game stay in the background. Some engines ignore input while unfocused; switch to Bring to front if taps do nothing.';
	...
	String get game_stream_settings_resolution_hint => 'Never upscales beyond the host\'s window size';
	...
	String get game_stream_stats_codec_fallback => 'Preferred codec unavailable; using the default';
	...
	String get game_stream_waiting => 'Streaming is enabled. Waiting for a paired device.';
	...
	String game_text_process_ai_added({required Object count}) => 'Added ${count} steps';
	String get game_text_process_ai_empty => 'AI did not return a usable rule. Try describing it differently.';
	String game_text_process_ai_failed({required Object reason}) => 'Generation failed: ${reason}';
	String get game_text_process_ai_generate => 'Generate';
	String get game_text_process_ai_hint => 'Describe what should be cleaned up';
	String get game_text_process_ai_no_provider => 'Choose an AI provider under Settings and AI first';
	String get game_text_process_ai_section => 'Ask AI';
	String get game_text_process_empty => 'No steps yet. Add one below, or ask AI.';
	String get game_text_process_fold_warning => 'Automatic dedupe can break progressive-redraw folding, leaving the same line several times in the workbench';
	String get game_text_process_kind_dedupe_ascending => 'Collapse a typewriter redraw';
	String get game_text_process_kind_dedupe_ascending_desc => 'AABABCABCD becomes ABCD';
	String get game_text_process_kind_dedupe_block_fixed => 'Collapse a repeated block';
	String get game_text_process_kind_dedupe_block_fixed_desc => 'ABCDABCDABCD becomes ABCD';
	String get game_text_process_kind_dedupe_chars => 'Collapse repeated characters';
	String get game_text_process_kind_dedupe_chars_desc => 'AAAABBBBCCCC becomes ABC';
	String get game_text_process_kind_dedupe_descending => 'Collapse a shrinking redraw';
	String get game_text_process_kind_dedupe_descending_desc => 'ABCDBCDCDD becomes ABCD';
	String get game_text_process_kind_dedupe_lines_auto => 'Collapse repeated lines';
	String get game_text_process_kind_dedupe_lines_auto_desc => 'S1S1S1S2S2S2 becomes S1S2';
	String get game_text_process_kind_filter_ascii_punctuation => 'Drop ASCII punctuation';
	String get game_text_process_kind_filter_ascii_punctuation_desc => 'Removes half-width punctuation';
	String get game_text_process_kind_filter_control_chars => 'Drop control characters';
	String get game_text_process_kind_filter_control_chars_desc => 'Removes ASCII control codes; line breaks and tabs are left alone';
	String get game_text_process_kind_filter_digits => 'Drop digits';
	String get game_text_process_kind_filter_digits_desc => 'Removes half-width and full-width digits';
	String get game_text_process_kind_filter_latin_letters => 'Drop Latin letters';
	String get game_text_process_kind_filter_latin_letters_desc => 'Removes half-width and full-width Latin letters';
	String get game_text_process_kind_filter_line_breaks => 'Drop line breaks';
	String get game_text_process_kind_filter_line_breaks_desc => 'Removes line breaks, or replaces them with text you choose';
	String get game_text_process_kind_filter_non_japanese => 'Drop non-Japanese charset characters';
	String get game_text_process_kind_filter_non_japanese_desc => 'Removes characters that cannot be encoded in Shift-JIS';
	String get game_text_process_kind_keep_japanese_quotes => 'Keep only quoted text';
	String get game_text_process_kind_keep_japanese_quotes_desc => 'Keeps dialogue and drops narration; a line without quotes is dropped entirely';
	String get game_text_process_kind_normalize_width => 'Normalise character width';
	String get game_text_process_kind_normalize_width_desc => 'Full-width ASCII to half-width, half-width katakana to full-width';
	String get game_text_process_kind_replace => 'Find and replace';
	String get game_text_process_kind_replace_desc => 'Your own regular expression or literal replacement';
	String get game_text_process_kind_strip_angle_brackets => 'Remove angle-bracket tags';
	String get game_text_process_kind_strip_angle_brackets_desc => 'Removes markup such as ruby and br tags';
	String get game_text_process_kind_strip_curly_braces => 'Remove furigana braces';
	String get game_text_process_kind_strip_curly_braces_desc => 'A brace with a slash keeps its base text; one without is removed entirely';
	String get game_text_process_kind_take_lines => 'Keep N lines';
	String get game_text_process_kind_take_lines_desc => 'Keeps only the first or last N lines';
	String get game_text_process_param_from_end => 'Take from the end';
	String get game_text_process_param_line_replacement => 'Replace line breaks with';
	String get game_text_process_param_lines => 'Line count';
	String get game_text_process_param_pattern => 'Pattern';
	String get game_text_process_param_pattern_invalid => 'Invalid regular expression';
	...
	String get game_text_process_preview_emptied => 'This step empties the line, so it would be dropped';
	...
	String get game_text_process_ruby_warning => 'This step removes the markup furigana is parsed from, so those lines lose their ruby';
	String game_text_process_step_count({required Object count}) => '${count} steps active';
	String get game_text_process_summary => 'Clean up the text of the selected hook thread';
	...
	String get game_text_thread_artifact_hint => 'Repeated-character artifact thread, no usable lines';
	...
	String get global_context_capture_hint => 'Read surrounding text from the foreground app to show the current sentence (Windows / macOS)';
	...
	String get interconnect_backup_backend_active => 'Backups already go to the Fushi Interconnect server. Pick another backend in Sync & backup to switch away.';
	...
	String get interconnect_backup_backend_hint => 'Back up and sync to the Fushi Interconnect server instead of a cloud drive. Everything the upload switches above allow is what gets written there.';
	String get interconnect_backup_backend_needs_pairing => 'Connect to a device above first.';
	String get interconnect_devices_hint => 'Peer addresses, pairing and LAN discovery';
	String get interconnect_devices_page => 'Pairing & devices';
	String interconnect_devices_paired_count({required Object n}) => 'Paired devices: ${n}';
	...
	String get interconnect_host_hint => 'Port, TLS, access token and paired devices';
	String get interconnect_host_off => 'Off';
	String get interconnect_host_page => 'Host service';
	String interconnect_host_running({required Object port}) => 'Running on port ${port}';
	...
	String get interconnect_profile_download => 'Download configuration from host';
	String get interconnect_profile_download_desc => 'Import the host\'s active configuration as a new configuration here. Your current one is untouched.';
	String interconnect_profile_downloaded({required Object name}) => 'Configuration imported: ${name}';
	String interconnect_profile_failed({required Object message}) => 'Configuration transfer failed: ${message}';
	String get interconnect_profile_host_toggle => 'Allow paired devices to read/write configuration';
	String get interconnect_profile_host_toggle_desc => 'Off by default. Requires HTTPS and a paired-device token. Incoming configurations are always added as new ones.';
	String get interconnect_profile_section => 'Configuration file';
	String get interconnect_profile_unsupported => 'The paired host does not offer configuration transfer (needs HTTPS and a newer version).';
	String get interconnect_profile_upload => 'Upload configuration to host';
	String get interconnect_profile_upload_desc => 'Send this device\'s active configuration to the paired host, where it lands as a new configuration.';
	String interconnect_profile_uploaded({required Object name}) => 'Configuration uploaded: ${name}';
	String get interconnect_related_entry => 'Remote lookup, audio sources & remote entries';
	String get interconnect_related_entry_hint => 'Configured in the Lookup and Sync categories';
	String get interconnect_section_client => 'Connect to other devices';
	String get interconnect_section_delegate => 'Delegate to the Fushi Interconnect server';
	...
	String get interconnect_transcode_host_toggle_desc => 'When a paired device plays a video from this host over a slow network, re-encode it to a lower bitrate on the fly. Needs ffmpeg; costs CPU on this device.';
	...
	String get jellyfin_host_lookup_hint => 'This device could not resolve the host name. Android and iOS cannot resolve .local or Windows computer names; use the server\'s IP address instead (for example http://192.168.1.10:8096).';
	...
	String jellyfin_route_verify_failed({required Object url, required Object reason}) => 'The server at ${url} did not accept the current sign-in. It may be a different server, or the sign-in has expired: ${reason}';
	String get jellyfin_routes_hint => 'Add this server\'s other addresses (LAN, public, reverse proxy) and switch between them at any time. Your sign-in works on every route.';
	String get jellyfin_routes_title => 'Routes';
	String jellyfin_server_unreachable({required Object url, required Object reason}) => 'Could not reach the server at ${url}: ${reason}';
	...
	String get jellyfin_show_in_library_hint => 'Mix media server items into Home, Series and All videos. Off: browse them only in the Media servers section.';
	...
	String get lapis_style_ai_applied => 'AI suggestion loaded into the editor. Check the preview, then apply.';
	String get lapis_style_ai_hint => 'Describe how the card should look, e.g. larger sentence, hide frequency';
	...
	String get local_audio_file_unavailable => 'Audio database unavailable. Select the original DB file again.';
	...
	String get local_audio_reference_unavailable => 'The selected file is a temporary copy. Importing a persistent copy instead.';
	...
	String get lookup_accessibility_permission_granted => 'Accessibility permission granted';
	String get lookup_accessibility_permission_hint => 'macOS needs Accessibility access to read the text selected in other apps. Without it the shortcut looks up the current clipboard text.';
	String get lookup_accessibility_permission_missing => 'Accessibility permission not granted yet. Enable Fushi under Privacy & Security > Accessibility, then try again.';
	String get lookup_accessibility_permission_request => 'Grant Accessibility permission for app-external lookup';
	String get lookup_audio_volume => 'Lookup audio volume';
	String get lookup_block_capture => 'Block screen capture';
	String get lookup_block_capture_hint => 'Excludes the lookup popup window from screenshots, screen recording, and live streaming (Windows / macOS). Turn this off to let screenshots, recording, and streaming capture the lookup popup.';
	String get lookup_hover_leave_resume => 'Resume when leaving lookup';
	String get lookup_hover_leave_resume_hint => 'After a hover lookup, moving the pointer away from the subtitle and the lookup window closes it and resumes playback';
	...
	String manga_chapter_download_status_downloading({required Object done, required Object total}) => 'Downloading ${done}/${total}';
	...
	String get manga_chapter_locked_hint => 'The source requires signing in and purchasing or renting this chapter before it can be downloaded.';
	String get manga_chapter_locked_login_unsupported_hint => 'This chapter must be purchased or rented on the site; signing in inside the app cannot unlock this kind of series yet.';
	String get manga_chapter_locked_title => 'Chapter locked';
	String get manga_chapter_not_downloaded => 'This chapter has not been downloaded yet';
	...
	String manga_chapter_ocr_status_running({required Object done, required Object total}) => 'Recognizing ${done}/${total}';
	String get manga_chapter_transition => 'Next chapter';
	String get manga_chrome_floating => 'Floating toolbar';
	String get manga_chrome_floating_subtitle => 'Hide the toolbar over the page; tap the middle of the page or hover at the top edge to reveal it. Off keeps the toolbar pinned above the page.';
	String get manga_cover_cache_max_age => 'Cover cache retention';
	String get manga_cover_cache_max_age_subtitle => 'Online source covers are re-downloaded after this many days';
	...
	String get manga_ocr_baberu_desc => 'About 284 MB including horizontal-line models. Windows uses GPU image encoding with CPU text decoding when available, otherwise CPU. Some names and handwriting may be less accurate. Applies to new OCR tasks.';
	...
	String get manga_ocr_cuda_desc => 'Original manga-ocr with GPU batching. Requires NVIDIA GPU; the first download includes a private Python and CUDA runtime (about 4 GB). No separate installation needed.';
	...
	String get manga_ocr_engine_local_onnx_desc => 'Fully offline. Download the selected model once; speed and accuracy depend on the model and hardware.';
	String get manga_ocr_engine_none => 'No OCR engine available. Download built-in models or set the mokuro CLI path in settings.';
	String get manga_ocr_engine_paired_host_desc => 'Hands the work to the paired Fushi interconnect server. Nothing is downloaded here.';
	...
	String get manga_ocr_manga_model_desc => 'Japanese manga model with horizontal-line recognition. Runs on CPU on Windows.';
	...
	String get manga_ocr_parallel_tasks_desc => 'Recognize different books at once. Chapters of the same book stay in order. Higher values use more memory; low-memory mode limits this to one.';
	...
	String get manga_panel_model_desc => 'Download, verify or remove the panel detection model';
	String get manga_panel_model_download => 'Download';
	String manga_panel_model_download_failed({required Object error}) => 'Panel model download failed: ${error}';
	String get manga_panel_model_downloading => 'Downloading';
	String manga_panel_model_downloading_bytes({required Object bytes}) => 'Downloading ${bytes} bytes';
	...
	String get manga_panel_navigation_subtitle => 'Focus detected panels before turning the page';
	...
	String get manga_reader_disable_zoom_out => 'Prevent zooming below fitted size';
	...
	String get manga_reader_ocr_engine_note => 'With "On open", opening a volume or chapter recognizes the whole volume in the background, starting from the current page; progress shows in the top-right corner. It uses the engine chosen below. "Manual" adds a "Recognize this volume" button to the toolbar instead.';
	...
	String get manga_reader_ocr_unavailable => 'No OCR engine is ready. Download the local model or pick another engine in OCR settings.';
	String get manga_reader_ocr_unavailable_short => 'No OCR engine · download a model or switch engines in OCR settings';
	...
	String get manga_remote_ocr_no_host => 'No Fushi Interconnect server with manga OCR is reachable.';
	String get manga_remote_ocr_not_ready => 'The Fushi Interconnect server\'s OCR models are not downloaded. Download them on the server first.';
	String get manga_remote_ocr_running => 'Fushi Interconnect server is running OCR…';
	String get manga_remote_ocr_unsupported => 'The Fushi Interconnect server does not support manga OCR.';
	...
	String manga_series_download_all_locked_skipped({required Object count}) => 'Skipped ${count} locked chapters';
	String get manga_series_download_all_none => 'Every chapter is already downloaded or queued';
	String manga_series_download_all_queued({required Object count}) => '${count} chapters queued';
	...
	String manga_series_no_chapters_in_language({required Object language}) => 'This source only lists ${language} chapters';
	String get manga_series_ocr_all_downloaded => 'Recognize all downloaded';
	String get manga_series_ocr_all_none => 'No downloaded chapter needs recognition';
	String get manga_series_ocr_no_engine => 'No OCR engine is available';
	String get manga_series_ocr_queued => 'Recognition queued';
	String manga_series_ocr_queued_count({required Object count}) => '${count} chapters waiting';
	String manga_series_ocr_running({required Object chapter, required Object done, required Object total}) => 'Recognizing ${chapter}: page ${done}/${total}';
	...
	String get manga_series_remove_confirm => 'Remove this series from the shelf? Downloaded chapters and reading progress will be deleted.';
	...
	String manga_series_try_sibling_language({required Object language}) => 'Try ${language}';
	...
	String get manga_source_interconnect_disabled => 'Turn on Fushi Interconnect in settings to use this source';
	String get manga_source_interconnect_subtitle => 'Browse the manga library on the Fushi Interconnect server';
	...
	String get manga_spread_offset_subtitle => 'Which page the two-page pairing starts from';
	...
	String get manga_wide_page_solo_subtitle => 'Show a double-width spread page on its own';
	...
	String get media_server_items_load_failed => 'Could not load items from the server';
	...
	String get media_source_alist_account_hint => 'Leave the account empty to browse as a guest';
	String get media_source_alist_folder => 'Folder on the site';
	String get media_source_alist_missing_fields => 'Enter the site URL (http or https)';
	...
	String media_source_root_already_added({required Object path}) => 'Already a source — rescanning: ${path}';
	...
	String mihon_extension_bulk_install_confirm({required Object count}) => 'Install ${count} extensions from this repository? Extensions run code from their sources.';
	String mihon_extension_bulk_install_done({required Object installed, required Object skipped, required Object failed}) => 'Installed ${installed}, skipped ${skipped}, failed ${failed}';
	String get mihon_extension_bulk_install_nothing => 'Every extension matching the current filters is already installed.';
	String mihon_extension_bulk_install_progress({required Object current, required Object total, required Object name}) => 'Installing ${current}/${total}: ${name}';
	String get mihon_extension_disabled => 'Disabled';
	String mihon_extension_download_count({required Object count}) => '${count} downloads';
	...
	String mihon_extension_update_all_confirm({required Object count}) => 'Update ${count} installed extensions to the newest version in their repositories?';
	String mihon_extension_update_all_done({required Object installed, required Object skipped, required Object failed}) => 'Updated ${installed}, skipped ${skipped}, failed ${failed}';
	String get mihon_extension_update_all_nothing => 'Every installed extension is already up to date.';
	String mihon_extension_update_all_progress({required Object current, required Object total, required Object name}) => 'Updating ${current}/${total}: ${name}';
	...
	String get mihon_source_login_empty => 'No session cookies were captured; nothing was saved';
	String get mihon_source_login_forward => 'Forward';
	String get mihon_source_login_hint => 'Sign in on the site, then tap Done to save the session';
	String get mihon_source_login_import_browser => 'Import from browser';
	String get mihon_source_login_import_hint => 'The site was opened in your browser. The Fushi extension will send its session here; sign in there if needed, then tap Done.';
	String get mihon_source_login_import_none => 'No session received from the browser yet';
	String mihon_source_login_import_received({required Object count}) => 'Imported ${count} cookies from the browser';
	...
	String get mihon_source_website_unavailable => 'This source has no web page for this title';
	String get mihon_sources_search_hint => 'Search sources';
	String get mihon_sources_sort_by_downloads => 'Sort by downloads';
	String get mihon_sources_sort_by_downloads_done => 'Sources reordered by extension downloads';
	String get mihon_sources_sort_by_downloads_no_data => 'No download counts available yet; refresh the extension repositories first';
	...
	String get mining_audio_follow_playback_speed => 'Match sentence audio to playback speed';
	String get mining_audio_follow_playback_speed_hint => 'When the audiobook is playing faster or slower than 1×, the sentence audio on the card is time-stretched to the same speed with pitch preserved. Audiobook mining only.';
	String get mining_audio_head_pad => 'Audio padding before sentence';
	String get mining_audio_head_pad_hint => 'Extra audio kept before the subtitle starts, so the first syllable is not clipped. Never runs into the previous line.';
	...
	String get mining_audio_tail_pad_hint => 'Extra audio kept after the subtitle ends, so trailing sounds are not cut short. Never runs into the next line.';
	...
	String get module_disabled_hint => 'This feature module is turned off in Settings > Appearance > Feature modules.';
	...
	String get network_proxy_address_hint => 'HTTP proxy server used by all public internet requests';
	String get network_proxy_auto_hint => 'Applies to every internet request the app makes: updates, cloud sync, dictionaries, downloads, subtitles and metadata. Leave blank for automatic: environment variables, then the enabled system proxy. P2P (torrent) transfers connect directly unless enabled below.';
	String get network_proxy_credentials_scope_hint => 'Credentials apply to HTTP requests only; the built-in torrent engine cannot use them';
	String get network_proxy_hint => 'host:port, e.g. 127.0.0.1:7890 (IPv4/host only)';
	...
	String get network_proxy_mode_auto_hint => 'Use environment variables, then the enabled system proxy';
	...
	String get network_proxy_mode_manual_hint => 'Use the server and optional credentials below';
	...
	String get network_proxy_p2p_warning => 'Direct by default. Via proxy: all P2P traffic goes through the global proxy — speed may drop, and many proxy providers forbid BitTorrent traffic (throttling, warnings, or account termination). Mixed: tracker requests go through the proxy while DHT and peer connections stay direct — widest peer discovery, but your real IP is visible to trackers, DHT and peers (connectivity only, not privacy). Built-in engine only; external qBittorrent uses its own proxy settings.';
	...
	String get onboarding_anki_action_get_anki_desc => 'Opens the Anki download page. Keep Anki running while you make cards.';
	String get onboarding_anki_action_get_ankidroid_desc => 'Opens the store page. Fushi writes cards into AnkiDroid, so it must be installed first.';
	String get onboarding_anki_action_install_addon_desc => 'Unpacks the bundled AnkiConnect add-on into Anki. Restart Anki afterwards.';
	String get onboarding_anki_action_refresh_desc => 'Reloads decks and note types. Use it after creating a deck in Anki.';
	String get onboarding_anki_action_test_desc => 'Checks that Fushi can reach Anki and loads your decks and note types. Creates nothing.';
	String onboarding_anki_addon_failed({required Object message}) => 'Install failed: ${message}';
	String get onboarding_anki_addon_installed => 'AnkiConnect installed. Start or restart Anki, then test the connection.';
	String get onboarding_anki_addon_no_anki => 'Anki data folder not found. Install Anki, open it once, then try again.';
	...
	String get onboarding_anki_fsrs_step_optimize_desc => 'Press Optimize under the switch to fit the parameters to your own review history, then save. Below roughly 1000 reviews the defaults already beat SM-2, so just optimize again once you have studied for a while.';
	String get onboarding_anki_fsrs_step_optimize_title => 'Optimize, then save';
	String get onboarding_anki_fsrs_step_options_desktop_desc => 'In Anki, click the gear next to a deck and choose Options.';
	String get onboarding_anki_fsrs_step_options_mobile_desc => 'In AnkiDroid (2.17 or newer) or AnkiMobile, long-press the deck and choose Options.';
	String get onboarding_anki_fsrs_step_options_title => 'Open deck options';
	String get onboarding_anki_fsrs_step_toggle_desc => 'Scroll to the FSRS section at the bottom of the options page (older builds hide it under Advanced) and turn the switch on. It applies to your whole collection, so once is enough.';
	...
	String get onboarding_anki_intro_body => 'Anki is a free spaced-repetition flashcard app. After a lookup, Fushi turns the word into a card with meaning, sentence, audio and screenshot in one tap.';
	String get onboarding_anki_mobile_ankiconnect_hint => 'Create cards into Anki on a computer in the same network: enable AnkiConnect in card creation settings and enter the computer\'s address.';
	String get onboarding_anki_mobile_ankiconnect_title => 'Advanced: use AnkiConnect from this device';
	String get onboarding_anki_setup_android_hint => 'Install AnkiDroid and open it once. On your first card, tap Allow in the permission dialog — nothing else to configure.';
	String get onboarding_anki_setup_desktop_hint => 'Install Anki, add the AnkiConnect add-on (one tap below, or add-on code 2055492159), and keep Anki running while you make cards.';
	String get onboarding_anki_setup_ios_hint => 'With AnkiMobile installed, cards are added directly. For the full feature set, connect to Anki on a computer in the same network via AnkiConnect.';
	...
	String get onboarding_click_lookup_intro => 'Tap any word in a book, manga or subtitle to see its definition. Try it on the practice sentence below.';
	String get onboarding_click_lookup_mine_body => 'Tap + on the entry to send the word, sentence, audio and image to the card creator.';
	String get onboarding_click_lookup_mine_title => 'Make a card';
	String get onboarding_click_lookup_nested_body => 'Tap a word inside a definition to go one level deeper. Go back or tap outside to close a level.';
	String get onboarding_click_lookup_nested_title => 'Keep exploring';
	String get onboarding_click_lookup_tap_desc => 'Tap (or left-click) a character; Fushi matches the longest word starting there. The sentence opens in the lookup page.';
	String get onboarding_click_lookup_tap_title => 'Tap a word';
	String get onboarding_feature_anki => 'Anki cards';
	String get onboarding_feature_anki_hint => 'Turn lookups into flashcards with one tap';
	String get onboarding_feature_backup => 'Backup & sync';
	String get onboarding_feature_backup_hint => 'Google Drive, WebDAV or a local file';
	String get onboarding_feature_books => 'Novels';
	String get onboarding_feature_books_hint => 'EPUB reading with lookup and audiobook sync';
	...
	String get onboarding_feature_fonts_hint => 'Use your own fonts for the interface, book text and dictionary';
	String get onboarding_feature_games => 'Galgames';
	String get onboarding_feature_games_hint => 'Text-hook lookup while playing (Windows only)';
	String get onboarding_feature_interconnect => 'Device interconnect';
	String get onboarding_feature_interconnect_hint => 'Share libraries and progress across devices on your LAN';
	...
	String get onboarding_feature_manual_resources_hint => 'Dictionaries, audiobooks and pronunciation sources from your own files';
	String get onboarding_feature_pack => 'Recommended pack';
	String get onboarding_feature_pack_hint => 'Japanese dictionaries plus JA/EN pronunciation audio in one download';
	String get onboarding_feature_video => 'Video';
	String get onboarding_feature_video_hint => 'Subtitle lookup and card mining';
	String get onboarding_features_modules_hint => 'Unchecked pages are hidden from the navigation bar. Change anytime in Settings → Appearance.';
	String get onboarding_features_modules_title => 'Library pages';
	String get onboarding_features_setup_hint => 'Only checked items get a step in this guide.';
	String get onboarding_features_setup_title => 'Set up next';
	String get onboarding_features_title => 'What will you use?';
	String get onboarding_finish_body => 'You can reopen this guide anytime from Settings → System.';
	...
	String get onboarding_first_anki_action_desc => 'Opens the practice sentence in the lookup page. Tap a word, tap +, check the fields and save.';
	String get onboarding_first_anki_card_intro => 'Anki is connected. Make one real card now so you know the whole path works.';
	String get onboarding_first_anki_lookup_desc => 'Open the practice sentence and tap a word.';
	String get onboarding_first_anki_lookup_title => 'Look up a word';
	String get onboarding_first_anki_plus_body => 'The card creator opens with the word, reading, meaning, sentence, audio and image filled in.';
	String get onboarding_first_anki_plus_title => 'Tap +';
	String get onboarding_first_anki_save_body => 'Confirm the deck and note type, then save. Open Anki to see the card.';
	String get onboarding_first_anki_save_title => 'Check and save';
	String get onboarding_global_lookup_android_body => 'Android hands selected text to Fushi through the text menu or Share sheet.';
	String get onboarding_global_lookup_android_continue_body => 'The lookup opens on top of the other app. Close it to return.';
	String get onboarding_global_lookup_android_continue_title => 'Read the popup';
	String get onboarding_global_lookup_android_open_body => 'Tap Fushi in the selection menu, or tap Share and pick Fushi.';
	String get onboarding_global_lookup_android_open_title => 'Choose Fushi';
	String get onboarding_global_lookup_android_select_desc => 'Long-press a word in another app and adjust the handles to cover it.';
	String get onboarding_global_lookup_android_select_title => 'Select text';
	String get onboarding_global_lookup_windows_action => 'Open shortcut settings';
	String get onboarding_global_lookup_windows_action_desc => 'Only if you want a different key combination.';
	String get onboarding_global_lookup_windows_body => 'Select text in any app and summon the dictionary without switching windows.';
	String get onboarding_global_lookup_windows_customize_body => 'Settings → Shortcuts → Global (app-external).';
	String get onboarding_global_lookup_windows_customize_title => 'Change the shortcut';
	String get onboarding_global_lookup_windows_select_desc => 'Highlight a word in any app and keep it selected.';
	String get onboarding_global_lookup_windows_select_title => 'Select text';
	String get onboarding_global_lookup_windows_shortcut_body => 'Fushi grabs the selection and opens a lookup card next to the pointer.';
	String get onboarding_global_lookup_windows_shortcut_press => 'Press the shortcut';
	String get onboarding_lookup_practice_action => 'Practise with this sentence';
	String get onboarding_lookup_practice_desc => 'Opens the lookup page with the sentence loaded. Tap a word there to see its definition; if nothing comes back, your dictionaries are not installed yet.';
	String get onboarding_manual_audiobook_action => 'Import a book with audio';
	String get onboarding_manual_audiobook_action_desc => 'Book or text, aligned subtitles and audio files. Subtitles are what lets Fushi sync audio to sentences.';
	String get onboarding_manual_dictionary_action => 'Import a dictionary';
	String get onboarding_manual_dictionary_action_desc => 'Opens dictionary management. Lookups only return results once a dictionary is installed.';
	String get onboarding_manual_pronunciation_action => 'Set up pronunciation audio';
	String get onboarding_manual_pronunciation_action_desc => 'Local or online sources for word pronunciation in dictionary entries. Separate from audiobook audio.';
	String get onboarding_online_services_account => 'Personal account required';
	String get onboarding_online_services_anidb => 'Identify anime and episodes by file fingerprint. Fushi has a registered app client; you still need your own AniDB account. Enter it in settings and enable file hash identification when wanted.';
	String get onboarding_online_services_body => 'Set up only the services you need, or skip this step. Selecting this tutorial does not enable services or submit credentials, and leaving it unselected does not change existing settings.';
	String get onboarding_online_services_build_missing => 'App credentials missing in this build';
	String get onboarding_online_services_configure => 'Open online service settings';
	String get onboarding_online_services_dandanplay => 'This build includes the danmaku service app credentials. Users do not need to apply for an API; enable online danmaku matching when wanted.';
	String get onboarding_online_services_dandanplay_missing => 'This build has no danmaku app credentials, so official online matching is unavailable. The developer provides these credentials; you do not need to register a personal API.';
	String get onboarding_online_services_embedded => 'App credentials included';
	String get onboarding_online_services_hint => 'Explore accounts, API keys and available services';
	String get onboarding_online_services_jimaku => 'Find subtitles. Register or sign in to Jimaku, generate a personal API key on your account page, then enter it in settings and enable this subtitle source.';
	String get onboarding_online_services_key => 'API key required';
	String get onboarding_online_services_link => 'Open official account / API page';
	String get onboarding_online_services_opensubtitles => 'Find and download subtitles. Register an account, create an API consumer and obtain an API key. User login is optional and uses the account download quota.';
	String get onboarding_online_services_opensubtitles_embedded => 'The app API key is included. You can optionally sign in to your OpenSubtitles account for your download allowance, or use your own API key.';
	String get onboarding_online_services_public => 'MAL / Jikan provides metadata; AniList supports discovery and related queries. Public read-only queries need no personal account or API key.';
	...
	String get onboarding_online_services_servers => 'These services have no shared registration page. Enter your existing server address and the account or key provided by its administrator, or skip if you do not have a server.';
	String get onboarding_online_services_subdl => 'Find English and multilingual subtitles for movies and TV. Register a free SubDL account, generate an API key in the panel, then enter it in settings and enable this subtitle source.';
	String get onboarding_online_services_title => 'Online services (optional)';
	String get onboarding_online_services_tmdb => 'This build includes a TMDB key for metadata fallback and missing fields. Add your own key only if you want your own quota.';
	String get onboarding_online_services_tmdb_missing => 'This build has no TMDB key. Request an API key and enter it in settings if you need TMDB metadata fallback; MAL / Jikan remains available.';
	String get onboarding_pack_action_audio_desc => 'Add online pronunciation sources for languages the pack does not cover.';
	String get onboarding_pack_action_dictionary_desc => 'Learning another language? Import dictionaries for it here instead.';
	String get onboarding_pack_action_download_desc => 'Downloads from several sources at once in the background, then imports. Cancel anytime; it resumes where it stopped.';
	String get onboarding_pack_action_import_existing_desc => 'The pack is already on disk. Choose Merge in the confirmation dialog to keep your existing data.';
	String get onboarding_pack_action_pick_desc => 'Already have the pack zip? Import it from disk and skip the download.';
	String get onboarding_pack_action_website => 'Open the download page';
	String get onboarding_pack_action_website_desc => 'Chunk links for download managers. Come back and use Choose a pack file afterwards.';
	String get onboarding_pack_discard_confirm => 'The partial download on disk will be deleted. Downloading again later starts from zero.';
	String get onboarding_pack_discard_failed => 'Could not remove the downloaded files. Close any app using them, then try again.';
	String get onboarding_pack_discard_running => 'Removing downloaded files…';
	String get onboarding_pack_download_background_hint => 'The download keeps running in the background — you can move to the next step or close this guide. Progress, cancel and import live in Settings → System.';
	...
	String get onboarding_pack_download_finished => 'Recommended pack finished downloading. Import it from Settings → System.';
	String get onboarding_pack_download_ready_hint => 'Import the pack to use its dictionaries and pronunciation resources. You can do this later.';
	String get onboarding_pack_download_ready_notice => 'Recommended pack downloaded. Choose Import now in the bottom bar when you are ready.';
	String get onboarding_pack_download_resume => 'Resume download';
	String get onboarding_pack_downloading => 'Downloading… cancel anytime and resume later';
	String get onboarding_pack_import_now => 'Import now';
	String get onboarding_pack_intro => 'Japanese dictionaries, pitch accent, word frequency and JA/EN pronunciation audio in one download. Learning another language? Skip this and import your own dictionaries.';
	String get onboarding_pack_mini_bar_hide => 'Hide';
	String get onboarding_pack_paused_desc => 'Progress is kept on disk — resuming picks up where it stopped.';
	String onboarding_pack_pick_failed({required Object message}) => 'Could not use the chosen file: ${message}';
	String get onboarding_pack_pick_no_path => 'The system did not hand over a path for that file. Move the pack into device storage and pick it again, or grant all-files access.';
	String get onboarding_pack_status_downloading => 'Downloading recommended pack';
	String get onboarding_pack_status_paused => 'Recommended pack download paused';
	String get onboarding_pack_status_ready => 'Recommended pack downloaded';
	String get onboarding_pack_tutorial_desc => 'Try looking up a word with your new dictionaries and pronunciation resources.';
	...
	String get onboarding_sample_sentence_hint => 'Tap to open it in the lookup page, then tap any word.';
	...
	String get onboarding_step_anki_action_desc => 'Template, field mapping, screenshots and audio. Deck and note type above are enough to start.';
	String get onboarding_step_anki_title => 'Set up Anki';
	String get onboarding_step_backup_action => 'Open backup settings';
	String get onboarding_step_backup_action_desc => 'Choose a backend and sign in, or export a local backup file.';
	String get onboarding_step_backup_body => 'Keep your library safe when you switch or lose a device.';
	...
	String get onboarding_step_extension_action_desc => 'Shows how to install the extension and connect it to Fushi.';
	String get onboarding_step_extension_body => 'Look up words on any web page with the companion extension.';
	...
	String get onboarding_step_fonts_action_desc => 'Import font files and pick one per language.';
	String get onboarding_step_fonts_body => 'Use your own fonts for the interface, book text and dictionary.';
	...
	String get onboarding_step_interconnect_action_desc => 'Enable interconnect and pair this device with your others.';
	String get onboarding_step_interconnect_body => 'Pair devices on your LAN to share one library and keep progress in sync.';
	String get onboarding_step_interconnect_title => 'Interconnect';
	String get onboarding_step_manual_resources_body => 'Import at least one dictionary before the lookup tutorial. Audiobooks and pronunciation audio are optional.';
	String get onboarding_step_manual_resources_title => 'Your own dictionaries and audio';
	String get onboarding_step_pack_download_action => 'Download and import';
	String get onboarding_step_pack_import_existing_action => 'Import the downloaded pack';
	...
	String get onboarding_welcome_body => 'Pick your interface language and theme. The next few steps set up the rest.';
	...
	String get popup_compact_glossaries_hint => 'Show dictionary glossary entries inline, separated by \' | \', instead of one per line in the lookup popup.';
	...
	String get popup_ctx_confirm_failed => 'Mining did not start - the lookup popup closed before the card could be created. Try again.';
	...
	String get popup_dismiss_animation_hint => 'Play a slide-out animation when a lookup popup is closed by swiping. Turn it off to close instantly (always off in e-ink mode).';
	...
	String get popup_full_width_hint => 'Ignore the maximum width and let the popup span the available width. Its position still follows the selected word.';
	...
	String get popup_instant_scroll_touch_step_hint => 'How far a finger must swipe before the popup jumps one step, as a share of its height.';
	String get popup_instant_scroll_wheel_step => 'Instant scroll wheel step';
	String get popup_instant_scroll_wheel_step_hint => 'How far one mouse-wheel notch jumps the popup, as a share of its height (also scaled by popup scroll speed).';
	...
	String get profile_language_bindings_hint => 'Applies when an item has its content language set. EPUB books read it from the file; for other formats set it on the item itself.';
	...
	String get reader_control_editor_hint => 'Drag buttons between the top and bottom bars, or remove them.';
	...
	String get reader_control_reject_required => 'Required buttons must stay on the reader.';
	String get reader_control_reject_title => 'The book title only fits the top center; nothing else goes there.';
	String get reader_control_reset_layout => 'Restore default reader button layout';
	...
	String get reader_floating_ball_hint => 'A translucent ball docked at the edge of the page. Tap it to fan its buttons out around it, tap again to collapse; drag to move it or switch sides. Choose its buttons in the button layout editor above.';
	...
	String get reader_gallery_locked_blur_hint => 'Image blur is on; reveal to view';
	String get reader_gallery_locked_reveal => 'View anyway';
	String get reader_gallery_locked_title => 'Not reached yet';
	String reader_gallery_locked_unlock_hint({required Object chapter}) => 'Unlocks automatically once you reach ${chapter}';
	...
	String reader_gallery_unlocked_count({required Object unlocked, required Object total}) => 'Unlocked ${unlocked} / ${total}';
	...
	String get reader_popup_scroll_dismiss_hint => 'In scroll mode, keep scrolling the page (horizontal or vertical text) to close the lookup popup';
	...
	String reader_stats_position_progress({required Object current, required Object total}) => '${current} / ${total} chars';
	...
	String get reader_vn_merge_spoken_sentence => 'Keep spoken sentence on one screen';
	...
	String get reading_stats_idle_timeout_hint => 'Stop counting reading time after this many minutes without turning a page, scrolling, or looking up a word. Applies to novels, PDFs and manga only; video counts while playing.';
	...
	String get remote_book_list_failed => 'Couldn\'t fetch the remote library from the Fushi Interconnect server.';
	String get remote_book_unavailable => 'Fushi Interconnect server unavailable';
	String remote_collection_download_done({required Object ok, required Object failed}) => 'Downloaded ${ok} remote episode(s), ${failed} failed';
	String get remote_collection_download_members => 'Download remote episodes';
	String get remote_collection_download_nothing => 'No remote episodes to download';
	String remote_collection_download_started({required Object count}) => 'Downloading ${count} remote episode(s) in the background';
	String get remote_collection_scrape_done => 'Metadata updated from host';
	String get remote_collection_scrape_failed => 'Remote scrape failed: the work is not in the host library plan';
	String remote_collection_scrape_identity_conflict({required Object provider, required Object id}) => 'The host already binds this work to ${provider} ID ${id}. Replace it?';
	String get remote_collection_scrape_on_host => 'Scrape on host';
	String get remote_collection_scrape_pick_work => 'Choose which work to scrape';
	String get remote_collection_scrape_push_to_host => 'Scrape here and send to host';
	String get remote_collection_scrape_unavailable => 'Remote scraping is not available for this host';
	String get remote_collection_tmdb_ordering_on_host => 'TMDB episode ordering on host…';
	...
	String get remote_manga_added_to_shelf => 'Added to the manga shelf; chapters download from the peer';
	...
	String get remote_video_unavailable => 'Fushi Interconnect server unavailable';
	...
	String get settings_destination_appearance_interaction => 'Appearance and interaction';
	...
	String get settings_downloads_advanced_hint => 'Connections, memory, peer discovery and protection';
	...
	String get settings_downloads_routing_hint => 'Path mapping and target video source';
	...
	String get settings_lookup_ime_language_description => 'Which language the keyboard switches to when you type in a lookup box. The input method must already be installed on the system. Does not affect search results.';
	String get settings_lookup_ime_language_title => 'Lookup input language';
	String get settings_lookup_ime_language_unavailable => 'That input method is not installed on this system yet.';
	...
	String get settings_study_diag_export_hint => 'Page credits, segment open/close, audiobook resume and jump trace, for troubleshooting reading-speed anomalies. Saved as a text file.';
	String get settings_video_diag_export => 'Export video diagnostics log';
	String get settings_video_diag_export_hint => 'Timeline plus libmpv\'s own verbose log';
	String get settings_video_diag_toggle => 'Video & lookup diagnostics log';
	String get settings_video_diag_toggle_hint => 'Records frame timings, libmpv playback stats and per-stage lookup timings. Off by default; turn it on, reproduce the stutter or slow lookup, then export.';
	...
	String get shortcut_action_global_external_open_lookup_page => 'Bring to front and open lookup page';
	...
	String get shortcut_action_reader_toggle_study_clock => 'Pause / resume reading timer';
	...
	String get shortcut_action_video_screenshot_subtitled => 'Screenshot (with subtitles)';
	...
	String get shortcut_action_video_toggle_mini_chrome => 'Toggle mini window controls';
	...
	String get shortcut_conflict_keep_both_hint => 'Both actions keep this binding. Whichever scope resolves first wins at press time.';
	...
	String get shortcut_lookup_page_escape_minimize => 'Back key on the lookup page minimizes the window';
	String get shortcut_lookup_page_escape_minimize_hint => 'After the bring-to-front hotkey, press the back key (Esc by default) on the lookup page to send the window away and return to what you were doing. The query and results are kept.';
	String get shortcut_mouse_back => 'Back button';
	String get shortcut_mouse_button => 'Mouse button';
	String get shortcut_mouse_button_not_supported => 'This action only accepts mouse side buttons (back/forward).';
	...
	String get shortcut_scope_global_external_desktop_note => 'Mouse triggers accept side buttons only (back/forward). Other buttons keep their normal meaning in other apps, so they are rejected here.';
	...
	String get srt_import_audio_needs_subtitle => 'Audio must be paired with subtitles. To attach audio to an existing book, long-press the book on the shelf.';
	...
	String get srt_import_hint_epub_or_srt => 'Pick a book or subtitle file to import.';
	String get srt_import_missing_input => 'Please pick at least a book or subtitle file';
	...
	String get stat_center_day_reset_hour_hint => 'Reading, watching and gaming before this hour count toward the previous day. Affects today and the last N days in statistics; only records written after the change use the new boundary.';
	String stat_center_profile_scope({required Object name}) => 'Showing statistics for profile "${name}" only';
	...
	String get stat_clear_all_overview_message => 'Clear reading, watching and game statistics all at once? Time, character counts and lookup/mining counts across all three go away. Your saved words and sentences, mined cards, game library and activity timeline are kept. This cannot be undone.';
	...
	String get stat_session_delete_message => 'Delete this session\'s time, character and page counts? Your saved words and sentences are not affected.';
	String get stat_session_edit => 'Edit session';
	String get stat_session_edit_chars => 'Characters';
	String get stat_session_edit_chars_invalid => 'Characters must be a whole number of 0 or more.';
	String get stat_session_edit_date => 'Date';
	String get stat_session_edit_date_invalid => 'Enter the date as YYYY-MM-DD.';
	String get stat_session_edit_message => 'Changing the date moves the whole session and keeps its time of day. The character count is split back across the session\'s segments.';
	String get stat_sessions_clear_all => 'Clear all sessions';
	String stat_sessions_clear_all_ack({required Object n}) => 'I understand this deletes all ${n} session records.';
	String stat_sessions_clear_all_message({required Object n}) => 'Clear all ${n} session records? Their time, character and page counts go away. Your saved words and sentences, mined cards and game library are kept. This cannot be undone.';
	...
	String storage_entry_backups_label({required Object n}) => '${n} archive(s) left by the last export';
	String storage_entry_database_snapshots_label({required Object n}) => 'Database backup snapshots (${n} files)';
	String get storage_entry_delete_backups_confirm_body => 'Delete these temporary local backup archives? Make sure you have saved or shared any copy you still need.';
	...
	String get subscription_items_empty_ongoing_hint => 'Ongoing subscriptions only queue new single-episode releases. If this title has finished airing, or you subscribed from a batch release, download the batch once instead.';
	...
	String subscription_remote_provider_unavailable({required Object provider}) => 'The host has no indexer for this resource (${provider})';
	String subscription_remote_section_title({required Object device}) => 'Subscriptions on ${device}';
	String get subscription_remote_unsupported => 'The host has no download backend configured';
	...
	String get sync_asset_transfer_hint => 'Upload what only this device has, or download what only the remote has';
	...
	String get sync_desktop_oauth_browser_open_failed => 'Could not open the browser. Copy the link and open it in a browser yourself.';
	String get sync_desktop_oauth_browser_reopen => 'Open browser again';
	String get sync_desktop_oauth_link_copy => 'Copy sign-in link';
	String get sync_desktop_oauth_link_copy_failed => 'Could not copy the link. Select the link text and copy it manually.';
	String get sync_desktop_oauth_waiting_body => 'The sign-in page was opened in your default browser. If nothing opened, or the page shows an error, copy the link and open it in another browser or a private window.';
	String get sync_desktop_oauth_waiting_title => 'Waiting for the browser sign-in';
	...
	String get sync_err_html_page => 'The server answered with a web page instead of a sync response. Check that the URL points at a WebDAV or Fushi Interconnect endpoint, not a website.';
	String sync_err_html_page_detail({required Object title}) => 'The server answered with a web page ("${title}") instead of a sync response. Check that the URL points at a WebDAV or Fushi Interconnect endpoint, not a website.';
	...
	String get sync_err_not_paired => 'No paired device yet — set up pairing in Fushi Interconnect first.';
	String get sync_err_pairing_rejected => 'The paired device rejected this device\'s credentials — pair again to resume syncing.';
	String get sync_err_peer_unreachable => 'Can\'t reach the Fushi Interconnect server - it may be offline or not running Fushi.';
	...
	String get sync_interconnect_service_config_toggle_desc => 'Receive external service settings and API keys (Jimaku, TMDB, Torznab, OpenSubtitles, tracking) from the Fushi Interconnect server over the encrypted Interconnect channel. Requires TLS.';
	...
	String get sync_server_settings_hint => 'Credentials and connection test for the selected sync method';
	...
	String get sync_show_remote_entries_warning => 'Show books and videos that exist on the Fushi Interconnect server or the cloud as placeholder cards you can download or stream.';
	...
	String get theme_accent_auto_tone_desc => 'Off: the exact color is used. On: a lighter or darker tone is generated for each mode, so what you see differs from what you picked.';
	String get theme_accent_follow_system => 'Follow the system accent color';
	String get theme_accent_follow_system_desc => 'Use the wallpaper color on Android (Material You) or the OS accent color on desktop instead of a picked color.';
	String get theme_accent_follow_system_unavailable => 'The system does not expose an accent color on this device.';
	String get theme_accent_low_contrast_dark => 'Hard to see on the dark-mode background. Pick a lighter color.';
	String get theme_accent_low_contrast_light => 'Hard to see on the light-mode background. Pick a darker color.';
	String get theme_ai_applied => 'AI suggestion loaded into the editor. Check the preview, then apply.';
	String get theme_ai_hint => 'Describe the theme you want, e.g. warm paper reading theme with a dark green accent';
	...
	String get theme_neutral_derived_desc => 'Tags, selected items, menus and surfaces stay gray instead of taking on the accent\'s hue; only the accent color itself stands out (like the Windows light theme). White, gray or black accents do this automatically.';
	String get theme_preview_button => 'Button';
	String get theme_preview_card => 'Card';
	String get theme_preview_dark => 'Dark';
	String get theme_preview_hint => 'Pick a color to see where it is used outlined in the preview.';
	String get theme_preview_light => 'Light';
	String get theme_preview_tag => 'Tag';
	String get theme_role_accent => 'Accent color';
	String get theme_role_accent_desc => 'Used exactly as picked for buttons, switches, icons and progress bars. Every other color is derived from it.';
	String get theme_role_actual_color => 'Shown as';
	String get theme_role_audio_highlight => 'Current sentence';
	String get theme_role_audio_highlight_desc => 'Follows audiobook playback. Applies to every theme, not just this one.';
	String get theme_role_container => 'Control fill';
	String get theme_role_container_desc => 'Switch tracks, floating buttons and the play bar';
	String get theme_role_follows_theme => 'Follows theme';
	String get theme_role_link => 'Links';
	String get theme_role_link_desc => 'Hyperlinks inside books and the selection handles';
	String get theme_role_reader_background => 'Page background';
	String get theme_role_reader_background_desc => 'Reader page, toolbar and dictionary popup background';
	String get theme_role_reader_text => 'Body text';
	String get theme_role_reader_text_desc => 'Reader text, toolbar icons and dictionary popup text';
	String get theme_role_reset => 'Follow theme again';
	String get theme_role_secondary => 'Secondary accent';
	String get theme_role_secondary_desc => 'Tags, badges and selected list items';
	String get theme_role_selection => 'Lookup highlight';
	String get theme_role_selection_desc => 'Background of the word or sentence being looked up';
	String get theme_role_surface => 'Interface background';
	String get theme_role_surface_desc => 'Base color of pages, cards and menus; the other layers get a faint tint of gray from it.';
	...
	String get update_download_source_preference_hint => 'The selected source is tried first; unavailable sources still fall back automatically.';
	String update_download_source_proxy({required Object host}) => 'Proxy: ${host}';
	String update_download_source_unavailable({required Object source}) => '${source} is not available for this file; falling back to the automatic order';
	...
	String get updates_center_empty_hint => 'Subscribed anime, manga chapters, extension and app releases show up here.';
	...
	String updates_notification_summary({required Object first, required Object count}) => '${first} and ${count} more';
	String get updates_notification_view_all => 'View updates';
	String get updates_notify_app_release => 'Notify about app releases';
	String get updates_notify_app_release_hint => 'Alert when a newer Fushi release is available.';
	String get updates_notify_manga_chapter => 'Notify about new manga chapters';
	String get updates_notify_manga_chapter_hint => 'Check followed online manga for new chapters in the background.';
	String get updates_notify_manga_extension => 'Notify about manga extension updates';
	String get updates_notify_manga_extension_hint => 'Alert when an installed extension has a newer version in its repository.';
	...
	String get updates_notify_video_episode_hint => 'Alert when a subscribed series finishes downloading a new episode.';
	String get updates_system_notifications => 'System notifications';
	String get updates_system_notifications_hint => 'Also send a system notification. Turning this off keeps the in-app badge.';
	String get url => 'URL';
	...
	String get video_ajatt_enabled_hint => 'Off means the AJATT archive is skipped when searching subtitles.';
	String get video_ajatt_settings_hint => 'Free Japanese subtitle archive (kitsunekko mirror). No account needed; subtitle files download from GitHub.';
	...
	String get video_anidb_hash_hint => 'Requires an AniDB account and a registered client. Uploads only file size and hash. AniDB UDP login is unencrypted; enable only on a trusted network.';
	String get video_anidb_login_test => 'Test AniDB login';
	String video_anidb_login_test_client_update({required Object client}) => 'AniDB login succeeded, but AniDB reports a newer version of client ${client}';
	String get video_anidb_login_test_failed_auth => 'AniDB rejected the username or password';
	String get video_anidb_login_test_failed_backoff => 'AniDB has not answered several requests in a row; backing off, try again shortly';
	String get video_anidb_login_test_failed_blocked => 'AniDB is rate limiting or under maintenance; requests are paused for now';
	String get video_anidb_login_test_failed_client => 'AniDB rejected the client name/version (unregistered, outdated or banned)';
	String get video_anidb_login_test_failed_network => 'AniDB UDP connection failed: check UDP port 9000 and the firewall; an HTTP proxy cannot carry UDP';
	String video_anidb_login_test_failed_other({required Object reason}) => 'AniDB login failed (${reason})';
	String get video_anidb_login_test_hint => 'Sends one UDP login with the saved account and client, then logs out. No file is hashed.';
	String get video_anidb_login_test_incomplete => 'Not tested: fill in the username, password and a registered client name/version first';
	String get video_anidb_login_test_running => 'Testing AniDB login…';
	String video_anidb_login_test_success({required Object client, required Object version}) => 'AniDB login succeeded as ${client} v${version}';
	String get video_anidb_password => 'AniDB password';
	String get video_anidb_username => 'AniDB username';
	String get video_anilist_error_api_disabled => 'AniList has temporarily disabled its public API because of server-side stability problems. This is not a problem with your network or proxy - the request reached AniList and was refused. Please try again later.';
	String get video_anilist_error_rate_limited => 'AniList is rate-limiting this app right now. Wait a moment and retry.';
	String get video_anilist_error_unreachable => 'Cannot reach AniList (graphql.anilist.co). Check your network connection, or configure a proxy in download settings.';
	...
	String video_clip_export_share_unavailable({required Object path}) => 'Clip saved, but the share sheet didn\'t open: ${path}';
	...
	String get video_discovery_anidb_identity_confirm_hint => 'AniDB has more than one possible match. Pick the right work and the imported download will scrape with that identity directly; skip and you can assign it later from the pending list.';
	String get video_discovery_anidb_identity_confirm_title => 'Confirm the work identity';
	String get video_discovery_anidb_identity_not_found => 'Could not identify this work on AniDB. It will download normally and wait in the pending list for manual identification.';
	String video_discovery_cancel_downloads_body({required Object n}) => '${n} download task(s) for this title will be stopped. Downloaded pieces stay on disk; you can start the download again later.';
	String get video_discovery_cancel_downloads_failed => 'Could not cancel the download. The task may have already finished, or the download backend is unavailable.';
	...
	String get video_discovery_provider_failed => 'Some sources failed temporarily; showing the rest';
	String get video_discovery_provider_rate_limited => 'Some sources are rate limited; showing the rest';
	...
	String video_home_subscription_unwatched_episode({required Object n, required Object count}) => 'Episode ${n} · ${count} unwatched';
	...
	String get video_library_scrape_auto_backfill => 'Auto-fill missing series info';
	String get video_library_scrape_auto_backfill_hint => 'Entering the video library scrapes entries that still have no confirmed identity. Turn off to stop all background metadata downloads.';
	String video_library_scrape_pending_banner({required Object count}) => '${count} works still need identity confirmation';
	...
	String get video_load_failed_not_opened => 'The player couldn\'t open this video. The file may be in use, or the video engine needs the app restarted.';
	...
	String get video_metadata_download_staff_images => 'Download cast & staff photos';
	String get video_metadata_download_staff_images_hint => 'Save cast/staff profile photos locally while scraping (up to 10 per work). Off: photos load from TMDB on demand.';
	...
	String get video_metadata_identifier_words_hint => 'Rewrite, block or offset titles before they are matched';
	String get video_metadata_identifier_words_invalid => 'Invalid rules';
	String get video_metadata_identifier_words_syntax => 'One rule per line, # starts a comment. Block: a regular expression. Replace: A => B. Episode offset: front <> back >> EP+1. Combined: A => B && front <> back >> EP+1.';
	String get video_metadata_image_limit_hint => '0 = unlimited. Best-rated images are kept in the order: metadata language, original language, English, textless.';
	...
	String get video_metadata_primary_provider_hint => 'The other source is used as a fallback when the primary source has no exact match or is unavailable.';
	String get video_metadata_provider_anidb => 'AniDB (hash identity + anime XML)';
	...
	String get video_mining_image_mode_video_clip_hint => 'Export picture and sentence sound together in one MP4. Anki plays it through its media player; autoplay follows the card settings. Playback may open in a separate player depending on the client.';
	...
	String get video_online_services_setup_description => 'Optional accounts and API keys can improve video identification and subtitle search. Basic playback works without them.';
	String get video_online_services_setup_dismiss => 'Never show again';
	String get video_online_services_setup_register => 'Learn about and register services';
	String get video_online_services_setup_settings => 'Open settings';
	String get video_online_services_setup_title => 'Configure optional online services';
	String get video_online_sources_empty => 'No enabled video sources. Install and enable an extension first.';
	String get video_online_sources_hint => 'Third-party Aniyomi extensions (extensions-lib 14). Content comes from each extension\'s website and plays in the built-in player.';
	String get video_online_stream_none => 'This episode returned no playable stream.';
	String get video_opensubtitles_app_key_hint => 'Leave blank to use the bundled app API key.';
	...
	String video_quality_auto_lowered({required Object label}) => 'Network is slow — quality lowered to ${label}';
	String video_quality_auto_raised({required Object label}) => 'Network improved — quality raised to ${label}';
	...
	String video_scrape_ai_confidence({required Object percent}) => 'AI confidence ${percent}%';
	...
	String get video_screenshot_clipboard_unsupported => 'Copying images to the clipboard is not supported on this platform';
	...
	String video_search_ai_expanded({required Object count}) => 'AI suggested ${count} extra search terms';
	...
	String get video_setting_clip_export_video_bitrate => 'Clip export video bitrate';
	String get video_setting_clip_export_video_bitrate_hint => '0 = follow the source (the stream is copied when possible); any other value re-encodes the video at that bitrate';
	...
	String get video_setting_hdr_compute_peak_hint => 'Measure each frame\'s real peak brightness instead of trusting the stream metadata. Better highlights, costs some GPU.';
	...
	String get video_setting_hdr_output_hint => 'Windows only. Auto hands HDR sources straight to an HDR display through a native video window; Always uses that window for every video (10-bit output); Off keeps the standard renderer.';
	String get video_setting_hdr_output_off => 'Off';
	String get video_setting_hdr_tone_mapping => 'HDR tone mapping';
	String get video_setting_hdr_tone_mapping_hint => 'Curve used when an HDR source has to be squeezed onto an SDR display. Auto lets mpv pick per source.';
	...
	String get video_setting_mpv_lua_scripts_empty => 'No scripts in the mpv_scripts folder yet';
	...
	String get video_setting_mpv_lua_scripts_input_note => 'Keyboard and mouse input stays in the app and never reaches mpv: scripts that rely on key bindings or the OSC cannot be triggered. Scripts driven by properties/events and OSD messages work.';
	String get video_setting_mpv_lua_scripts_status_error => 'Error';
	String get video_setting_mpv_lua_scripts_status_loaded => 'Loaded, no errors reported';
	String get video_setting_mpv_lua_scripts_status_not_loaded => 'Not loaded in this player yet (turn on the switch or reopen the video)';
	String get video_setting_mpv_lua_scripts_unavailable => 'The bundled libmpv on this platform was built without Lua (-Dlua=disabled), so scripts cannot run here.';
	...
	String get video_setting_screenshot_destination_hint => 'Where screenshots go: a save dialog, the clipboard, or straight into a folder';
	String get video_setting_screenshot_directory => 'Screenshot folder';
	String get video_setting_screenshot_directory_hint => 'Where screenshots land when the destination is Save to folder';
	...
	String get video_setting_slim_progress_bar => 'Slim progress bar at the bottom';
	String get video_setting_slim_progress_bar_hint => 'When the controls fade out, keep a thin accent-coloured progress line along the very bottom of the video. In the mini window it is always shown, since the full seek bar is hidden there.';
	...
	String get video_setting_subtitle_obscure_reveal => 'Reveal when paused or hovered';
	String get video_setting_subtitle_obscure_reveal_hint => 'While subtitles are blurred or hidden, pausing, looking a word up, hovering (desktop) or tapping them reveals them temporarily. Turn this off to keep them obscured no matter what.';
	...
	String get video_shader_tier_high_hint_mobile => 'Anime4K deblur (M) at the source resolution. Larger kernel than Medium; still no upscaling passes. For faster phone GPUs.';
	...
	String get video_shader_tier_low_hint_mobile => 'mpv\'s built-in sharpening (spline36 on phones). No download, no extra GPU passes. The safe choice if anything above this drops frames.';
	...
	String get video_shader_tier_medium_hint_mobile => 'Anime4K deblur (S) at the source resolution. No upscaling passes, so the cost does not scale with your screen. Start here on phones.';
	...
	String get video_shader_tier_ultra_hint_mobile => 'Anime4K deblur (M) plus an extra soft restore pass, both at the source resolution. Strongest phone tier; still no upscaling. Drop a tier if it drops frames.';
	...
	String get video_source_grouping_change_hint => 'The next scan uses this setting. Existing collections and metadata are kept.';
	String get video_source_grouping_folder => 'By folder';
	String get video_source_grouping_folder_hint => 'Create one collection per first-level subfolder. Files directly in the selected folder share a collection. Metadata scraping is unavailable in this mode; switch to By work to scrape.';
	String get video_source_grouping_mode => 'Video organization';
	String get video_source_grouping_series => 'By work';
	String get video_source_grouping_series_hint => 'Recognize works and episodes from filenames, then match metadata.';
	String get video_source_scrape_action => 'Scrape this source';
	String get video_source_scrape_anidb_client => 'AniDB client name';
	String get video_source_scrape_anidb_client_hint => 'Fushi includes a registered app client. Leave this blank normally; set a custom registered client only if needed.';
	String get video_source_scrape_anidb_client_version => 'AniDB client version';
	String get video_source_scrape_anidb_client_version_hint => 'Only custom clients need their own registered version here. Fushi maintains the default app identity; your personal AniDB login is still required.';
	...
	String get video_source_scrape_background_hint => 'Tasks continue when this window is closed.';
	...
	String get video_source_scrape_enabled_toggle => 'Enable scraping for this source';
	String get video_source_scrape_enabled_toggle_hint => 'When off, manual, post-scan, post-download and background scraping all skip this source.';
	...
	String get video_source_scrape_list_load_failed => 'Could not load this list. Try again.';
	String get video_source_scrape_list_reload => 'Reload';
	String get video_source_scrape_locale => 'Metadata language';
	String get video_source_scrape_locale_follow_ui => 'Leave empty to follow the interface language';
	String get video_source_scrape_locale_hint => 'Preferred language for TMDB fallback and supplementary details. MAL uses the titles and text supplied by MAL.';
	String get video_source_scrape_manual_ambiguous => 'Several works have this title. Open the pending works tab and select the specific item to match.';
	...
	String get video_source_scrape_manual_id_invalid => 'Enter a positive work ID or an official URL matching the selected source and type.';
	String get video_source_scrape_manual_query_hint => 'Search by title, or select MAL / TMDB movie / TMDB TV and enter an ID or official URL. Select a result to apply it to the current work.';
	...
	String get video_source_scrape_metadata_locale_hint => 'BCP-47 language tag such as ja or zh-CN. Leave empty to follow the global metadata language.';
	String get video_source_scrape_nfo_policy => 'NFO write policy';
	String get video_source_scrape_pending_empty => 'No works need manual matching.';
	String get video_source_scrape_pending_tab => 'Unmatched';
	String get video_source_scrape_pending_works => 'Works awaiting identification';
	String get video_source_scrape_pending_works_hint => 'These entries have no confirmed identity yet. Search and pick the right work to scrape them.';
	...
	String get video_source_scrape_provider_follow_global => 'Follow global default';
	String get video_source_scrape_provider_policy => 'MAL (via Jikan) is the primary metadata source; TMDB is the fallback.';
	...
	String get video_source_scrape_work_missing => 'This work is no longer in the current source plan (its files may have been renamed, moved or deleted). Rescrape the source to refresh the pending list.';
	...
	String get video_subdl_api_key_hint => 'Get a free API key at subdl.com/panel/api';
	String get video_subdl_enabled_hint => 'Off means SubDL is skipped even when an API key is saved.';
	String get video_subdl_settings_hint => 'Subtitles in English and many other languages for movies and TV, matched by IMDb / TMDB id. A free API key is required; downloads count toward an anonymous daily limit per IP.';
	...
	String get video_subtitle_collection_language_hint => 'Applies to every episode in this collection. Empty = follow the video\'s own language.';
	String get video_subtitle_collection_members_hint => 'Episodes are matched by number from file names; season packs are split automatically.';
	...
	String get video_subtitle_collection_release_group_hint => 'Batch downloads pick this version first so the whole season shares one timing.';
	String get video_subtitle_collection_settings => 'Collection subtitle settings';
	...
	String video_subtitle_remote_player_rendered({required Object label}) => 'Server cannot extract this subtitle track; the player renders it directly (no word lookup): ${label}';
	String get video_subtitle_replay => 'Replay this line';
	String get video_subtitle_retime_action => 'Retime with speech model';
	String video_subtitle_retime_done({required Object matched, required Object total, required Object percent, required Object ms}) => 'Retimed ${matched}/${total} lines (${percent}%), median shift ${ms} ms';
	String video_subtitle_retime_dropped({required Object count}) => '${count} malformed lines were left out';
	String get video_subtitle_retime_failed => 'Subtitle retiming failed';
	String video_subtitle_retime_low_match({required Object percent}) => 'Only ${percent}% of lines matched. Check the spoken language and whether this subtitle belongs to this episode.';
	String get video_subtitle_retime_no_track => 'Load a subtitle track first';
	String get video_subtitle_retime_running => 'Retiming subtitles with the speech model…';
	...
	String get video_subtitle_source_search_hint => 'Tap “Find subtitles” above, then pick a source here.';
	...
	String get video_work_locked_fields_hint => 'Locked fields keep their current values the next time this work is scraped.';
	...
	String get web_video_hosting_builtin => 'Built-in (1080p; super-resolution, screenshots and cards available)';
	String get web_video_hosting_menu => 'Playback mode';
	String get web_video_hosting_windowed => 'Native window (4K, hardware DRM; cards are queued for later)';
	String get web_video_import_hint => 'This is a web page (not a direct stream). It will open in the built-in web player.';
	String get web_video_mine_queue_empty => 'No queued cards';
	String web_video_mine_queue_finished({required Object ok, required Object failed}) => 'Cards created: ${ok}, failed: ${failed}';
	String get web_video_mine_queue_run => 'Create queued cards';
	String web_video_mine_queue_running({required Object done, required Object total}) => 'Creating cards ${done}/${total}...';
	String get web_video_mine_queue_stop => 'Stop card creation';
	String web_video_mine_queued({required Object count}) => 'Queued for card creation (${count} pending)';
	String web_video_mine_switch_builtin({required Object count}) => 'Switch to built-in mode to create ${count} queued cards';
	String get web_video_no_tracks => 'No subtitles captured yet';
	String get web_video_platform_unsupported => 'The built-in web player is only available on Windows for now.';
	String get web_video_player_unavailable => 'The built-in web page player is temporarily disabled; this address cannot be played inside the app for now.';
