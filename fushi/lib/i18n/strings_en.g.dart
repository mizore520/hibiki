...
class _StringsEn implements BaseTranslations<AppLocale, _StringsEn> {
	...
	String get game_lookup_attached_calibration_failed => 'Calibration was not applied. Check the body text, target window, and all three probes.';
	String get game_lookup_attached_calibration_paused => 'Calibration is paused while the game is hidden or in the background. Return with Alt+Tab and wait for the character highlights before clicking. You can still adjust and confirm here.';
	String get game_lookup_attached_calibration_preparing => 'Preparing click protection. Do not click the game dialogue yet.';
	String get game_lookup_attached_calibration_ready => 'Probe clicks are ready. Click inside the highlighted character boxes in order; clicks outside those boxes still control the game.';
	String get game_lookup_attached_calibration_region_help => 'Adjust the region here, or drag it over a screenshot in the sample editor. The game overlay only accepts highlighted character probes.';
	String get game_lookup_attached_calibration_short_text => 'At least three characters are required for calibration probes.';
	...
	String get game_lookup_attached_probe_waiting => 'Waiting for matching in-game click';
	String get game_lookup_attached_probes_hint => 'Click the first, middle, and last highlighted glyphs in the game, then confirm each character below.';
	...
	String get game_lookup_samples_advanced_hint => 'Extra samples and visual grid correction';
	...
	String get game_lookup_samples_auto_current_hint => 'Use the selected screenshot only. It should show the complete dialogue across at least two lines.';
	String get game_lookup_samples_auto_failed => 'No reliable regular grid was found. Use a complete multiline sample, keep the dialogue inside the frame, and exclude the speaker and buttons. Your draft has not changed.';
	String get game_lookup_samples_auto_geometry_out_of_bounds => 'The fitted layout extends beyond the screenshot.';
	String get game_lookup_samples_auto_geometry_weak => 'There are not enough well-spread character positions to determine the layout.';
	String get game_lookup_samples_auto_grid => 'Measured grid · no font adjustment required';
	String get game_lookup_samples_auto_hint => 'Frame the dialogue roughly and automatically measure character spacing, line spacing, and wrapping. Training samples contribute together; validation samples check the result.';
	...
	String get game_lookup_samples_auto_indent_ambiguous => 'The continuation line start could not be determined.';
	...
	String get game_lookup_samples_auto_text_alignment_weak => 'The detected text only weakly matches the hooked text.';
	String get game_lookup_samples_auto_unsupported => 'This sample contains character widths that the grid method cannot verify. Use manual layout for now.';
	...
	String get game_lookup_samples_capture_source => 'There is no dialogue available to capture. Confirm that the game is attached and dialogue text is being received.';
	...
	String get game_lookup_samples_continuation_hint => 'Set where the second and later lines start relative to the first line. One value applies to all text; 0 keeps the same start.';
	...
	String get game_lookup_samples_hint => 'Wait until the line is fully visible, then capture it. Capture several different lines before adjusting the layout.';
	...
	String get game_lookup_samples_narration_hint => 'Only calibrate narration separately when its text layout differs from dialogue. If they use the same layout, no narration calibration is needed.';
	...
	String get game_lookup_samples_search_hint => 'Enclose all dialogue text. Recognition stays inside this frame and keeps your selection. Character boxes are computed separately. Moving the frame requires aligning again.';
