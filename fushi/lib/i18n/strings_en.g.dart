...
class _StringsEn implements BaseTranslations<AppLocale, _StringsEn> {
	...
	String get anki_error_paired_device_unreachable => 'Couldn\'t create the card because no paired device could be reached. Make sure Fushi is running on the paired device, or turn off Mine to paired device in Anki settings to create cards locally.';
	...
	String get asr_models_section_summary => 'Models for on-device audiobook transcription. Download only the languages you need.';
