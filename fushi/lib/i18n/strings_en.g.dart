...
class _StringsEn implements BaseTranslations<AppLocale, _StringsEn> {
	...
	String get video_mining_image_mode_hint => 'How covers on video cards are captured';
	...
	String get video_setting_torrent_backend_embedded => 'Built-in engine (desktop only)';
	...
	String get download_backend_desktop_only_note => 'Built-in engine requires a desktop platform. This device uses external qBittorrent.';
	...
	String get anki_connect_use_on_android_hint => 'Use only on a trusted network. AnkiConnect uses cleartext HTTP; configure a matching API key, then refresh decks and note types after switching.';
	String get anki_connect_api_key_hint => 'Required for remote AnkiConnect; must match the key configured in the add-on';
	String get anki_connect_android_api_key_required => 'Configure a matching AnkiConnect API key before enabling the Android backend.';
