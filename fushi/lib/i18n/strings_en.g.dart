...
class _StringsEn implements BaseTranslations<AppLocale, _StringsEn> {
	...
	String get dict_user_empty => 'No entries yet. Add one to build your own dictionary.';
	String get dict_user_expression_required => 'Headword cannot be empty';
	String get dict_user_rebuild_failed => 'Failed to rebuild the user dictionary';
	...
	String get onboarding_step_anki_body => 'Open card creation settings to connect AnkiConnect (desktop) or AnkiDroid (Android) and test the connection.';
	...
	String get onboarding_step_pack_browser_action => 'Open in browser (Google Drive)';
