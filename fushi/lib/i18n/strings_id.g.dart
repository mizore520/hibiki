...
class _StringsId extends _StringsEn {
	...
	@override String get onboarding_pack_action_download_desc => 'Mengunduh seluruh paket di latar belakang, lalu mengimpornya. Bisa dibatalkan kapan saja; berikutnya dilanjutkan dari titik terakhir.';
	@override String get onboarding_pack_action_import_existing_desc => 'Paket sudah terunduh; tombol ini mengimpornya. Pilih «Gabungkan» pada dialog konfirmasi agar data yang sudah ada tidak tersentuh.';
	@override String get onboarding_pack_action_pick_desc => 'Sudah punya zip paketnya dari tempat lain? Impor dari disk dan lewati proses unduh sepenuhnya.';
	@override String get onboarding_pack_action_website => 'Buka halaman unduh di situs web';
	@override String get onboarding_pack_action_website_desc => 'Membuka situs resmi di peramban. Bagian paket di sana memuat tautan per potongan yang bisa diberikan ke pengelola unduhan; setelah itu kembali ke sini dan gunakan «Pilih berkas paket lokal» untuk mengimpor hasilnya.';
	@override String get onboarding_pack_action_dictionary_desc => 'Sedang belajar bahasa selain Jepang? Lewati paketnya dan impor kamus untuk bahasamu sendiri di sini.';
	@override String get onboarding_pack_action_audio_desc => 'Dari mana audio pelafalan berasal. Paket sudah mencakup bahasa Jepang dan Inggris; untuk bahasa lain tambahkan sumber daring di sini.';
	@override String get onboarding_anki_action_test_desc => 'Memeriksa apakah Fushi bisa menghubungi Anki dan memuat dek serta jenis catatanmu. Belum ada yang dibuat.';
	@override String get onboarding_anki_action_refresh_desc => 'Memuat ulang dek dan jenis catatan dari Anki. Gunakan setelah membuat dek baru di dalam Anki.';
	@override String get onboarding_anki_action_get_ankidroid_desc => 'Membuka halaman toko AnkiDroid. Fushi menulis kartunya ke sana, jadi harus dipasang lebih dulu.';
	@override String get onboarding_anki_action_get_anki_desc => 'Membuka halaman unduh Anki. Pasang Anki dan biarkan tetap berjalan selagi kamu membuat kartu.';
	@override String get onboarding_anki_action_install_addon_desc => 'Mengekstrak add-on AnkiConnect bawaan ke dalam Anki untukmu; itulah yang membuat Fushi bisa berbicara dengannya. Mulai ulang Anki setelahnya.';
	@override String get onboarding_step_anki_action_desc => 'Templat kartu, pemetaan bidang, tangkapan layar, dan audio: yaitu rincian seperti apa kartu yang dihasilkan. Dek dan jenis catatan di atas sudah cukup untuk mulai, jadi buka ini hanya jika kamu ingin mengubah cara kartu disusun.';
	@override String get onboarding_step_backup_action_desc => 'Pilih backend cadangan dan masuk, supaya pustakamu selamat saat perangkat hilang atau diganti.';
	@override String get onboarding_step_interconnect_action_desc => 'Memasangkan perangkat ini dengan perangkatmu yang lain untuk berbagi satu pustaka dan menyelaraskan progres.';
	@override String get onboarding_step_extension_action_desc => 'Menunjukkan cara memasang ekstensi peramban dan menghubungkannya ke Fushi, supaya kamu juga bisa mencari kata di halaman web.';
	@override String get onboarding_step_fonts_action_desc => 'Tambahkan berkas fonmu sendiri dan pilih fon yang dipakai tiap bahasa.';
	@override String get onboarding_pack_sources_hint => 'Diunduh dalam potongan paralel dari GitHub, situs resmi, dan satu cermin cadangan sekaligus, tiap potongan diperiksa checksum-nya. Fushi mengukur kecepatan sumber sambil berjalan dan memberi lebih banyak potongan ke yang tercepat saat itu, jadi tidak ada yang perlu dipilih di sini.';
	...
	@override String get network_proxy_p2p_label => 'Rutekan lalu lintas P2P (torrent) melalui proksi';
	...
	@override String get onboarding_step_click_lookup_title => 'Ketuk untuk mencari kata';
	@override String get onboarding_click_lookup_tap_title => 'Ketuk teksnya';
	@override String get onboarding_click_lookup_nested_title => 'Lanjutkan menelusuri di popup';
	@override String get onboarding_click_lookup_nested_body => 'Ketuk kata lain di dalam definisi untuk membuka pencarian satu tingkat lebih dalam. Tekan kembali atau ketuk di luar untuk menutup satu tingkat.';
	@override String get onboarding_click_lookup_mine_title => 'Ubah hasilnya menjadi kartu';
	@override String get onboarding_click_lookup_mine_body => 'Kalau definisinya sudah pas, ketuk + untuk mengirim kata, kalimat, audio, dan gambar ke pembuat kartu.';
	@override String get onboarding_step_global_lookup_title => 'Mencari teks di luar Fushi';
	@override String get onboarding_global_lookup_windows_body => 'Di Windows, pilih teks di aplikasi lain lalu panggil kamus tanpa harus kembali ke Fushi.';
	@override String get onboarding_global_lookup_windows_select_title => 'Pilih teks di aplikasi mana pun';
	@override String get onboarding_global_lookup_windows_shortcut_title => 'Tekan Ctrl+Alt+D';
	@override String get onboarding_global_lookup_windows_shortcut_body => 'Ini pintasan global bawaan. Fushi mengambil teks yang sedang dipilih dan membuka kartu pencarian di dekat kursor.';
	@override String get onboarding_global_lookup_windows_customize_title => 'Ubah pintasannya bila perlu';
	@override String get onboarding_global_lookup_windows_customize_body => 'Buka Pengaturan → Pintasan → Global (di luar aplikasi) untuk menetapkan kombinasi tombol lain.';
	@override String get onboarding_global_lookup_windows_action => 'Buka pengaturan pintasan';
	@override String get onboarding_global_lookup_windows_action_desc => 'Untuk mengubah pintasan pencarian di luar aplikasi. Pintasan bawaan Ctrl+Alt+D sudah berfungsi, jadi ini opsional.';
	@override String get onboarding_global_lookup_android_body => 'Di Android, sistem meneruskan teks yang dipilih ke Fushi lewat menu teks atau panel Bagikan. Tidak ada tombol pintas global yang bisa diatur ulang.';
	@override String get onboarding_global_lookup_android_select_title => 'Pilih teks di aplikasi lain';
	@override String get onboarding_global_lookup_android_open_title => 'Pilih Fushi';
	@override String get onboarding_global_lookup_android_open_body => 'Ketuk Fushi di menu pemilihan teks. Kalau tidak terlihat, ketuk Bagikan lalu pilih Fushi dari panel berbagi.';
	@override String get onboarding_global_lookup_android_continue_title => 'Gunakan popup terpisah';
	@override String get onboarding_global_lookup_android_continue_body => 'Hasil pencarian terbuka terpisah dari aplikasi asal. Anda bisa mengetuk kata lain di dalamnya, lalu menutupnya untuk kembali ke tempat semula.';
	@override String get onboarding_feature_manual_resources => 'Impor kamus dan audio secara manual';
	...
	@override String get onboarding_step_manual_resources_title => 'Siapkan kamus dan audio secara manual';
	...
	@override String get onboarding_manual_dictionary_action_desc => 'Buka manajer kamus dan impor minimal satu berkas atau arsip kamus yang didukung. Tutorial pencarian baru berguna setelah pencarian benar-benar menghasilkan definisi.';
	@override String get onboarding_manual_audiobook_action => 'Impor buku beserta audio buku audio';
	@override String get onboarding_manual_audiobook_action_desc => 'Buka impor buku dan pilih buku atau teksnya, subtitle yang selaras, serta satu atau beberapa berkas audio. Audio butuh subtitle agar Fushi bisa menyelaraskannya per kalimat.';
	@override String get onboarding_manual_pronunciation_action => 'Atur audio pelafalan kata';
	@override String get onboarding_manual_pronunciation_action_desc => 'Tambahkan sumber pelafalan lokal atau daring yang dipakai entri kamus. Ini berbeda dari audio buku audio yang menempel pada sebuah buku.';
	@override String get onboarding_lookup_verify_action => 'Pastikan kata itu ada di kamus Anda';
	@override String get onboarding_lookup_verify_action_desc => 'Buka pencarian, ketik kata apa pun yang sedang Anda pelajari, dan lanjutkan hanya setelah kamus yang terpasang menampilkan definisinya. Tutorial ini tidak mematok kata contoh.';
	@override String get onboarding_step_first_anki_card_title => 'Buat kartu Anki pertama Anda';
	@override String get onboarding_step_first_anki_card_body => 'Langkah ini hanya muncul setelah panduan ini terhubung ke Anki dan Anda memilih dek serta tipe catatan yang bisa dipakai.';
	@override String get onboarding_first_anki_lookup_title => 'Mulai dari hasil kamus yang nyata';
	@override String get onboarding_first_anki_lookup_body => 'Cari kata yang memang ada di kamus yang Anda pasang. Tidak ada kata contoh tetap yang mungkin justru tidak ada di kamus Anda.';
	@override String get onboarding_first_anki_plus_title => 'Ketuk tombol plus pada entri';
	@override String get onboarding_first_anki_plus_body => 'Tombol plus membuka pembuat kartu berisi kata, cara baca, arti, kalimat, audio, dan gambar yang tersedia saat itu.';
	@override String get onboarding_first_anki_save_title => 'Periksa lalu simpan';
	@override String get onboarding_first_anki_save_body => 'Pastikan dek tujuan, tipe catatan, dan pratinjau bidangnya sudah benar, lalu simpan. Buka Anki untuk memeriksa kartu pertama sudah masuk.';
	@override String get onboarding_first_anki_action => 'Buka pencarian dan buat kartu';
	@override String get onboarding_first_anki_action_desc => 'Pakai kata yang definisinya sudah terlihat, ketuk tombol plusnya, periksa bidang-bidangnya, lalu simpan ke dek Anki yang terhubung.';
	@override String get onboarding_step_click_lookup_body => 'Pastikan dulu ada kata yang memang didefinisikan kamus yang Anda pasang. Lalu pakai kata yang sama untuk berlatih pencarian langsung di buku, teks OCR manga, dan subtitle video.';
	@override String get onboarding_click_lookup_tap_body => 'Di ponsel, ketuk salah satu karakter kata yang sudah dipastikan tadi; di komputer, klik kiri. Fushi mulai dari titik itu dan mengambil kata terpanjang yang cocok.';
	@override String get onboarding_global_lookup_windows_select_body => 'Sorot kata yang sama, yang sudah Anda pastikan ada definisinya di kamus, dan biarkan tetap terpilih.';
	@override String get onboarding_global_lookup_android_select_body => 'Tekan lama kata yang sudah dipastikan itu, lalu geser pegangan seleksi agar menutupi seluruh kata.';
