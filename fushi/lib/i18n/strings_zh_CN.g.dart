...
class _StringsZhCn extends _StringsEn {
	...
	@override String get delete_local_files_video_desc => '视频文件将从本设备删除，对应的下载任务一并清除，无法恢复';
	...
	@override String get lookup_block_capture_hint => '把查词悬浮窗从截图、录屏、直播串流中排除（Windows）。关闭后，截图、录屏和串流即可拍到查词悬浮窗。';
	...
	@override String get manga_ocr_engine_local_onnx_desc => '完全离线，质量最好。需要一次性下载模型，老设备上较慢。';
	...
	@override String get reading_stats_day_reset_hour => '「今日」从几点开始';
	@override String get reading_stats_day_reset_hour_hint => '这个整点之前的阅读算作前一天。影响统计里的「今日」与近 N 天；只有改设置之后写入的记录按新边界归日。';
	...
	@override String get mihon_sources_search_hint => '搜索漫画源';
