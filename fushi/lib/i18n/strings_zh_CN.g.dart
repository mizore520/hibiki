...
class _StringsZhCn extends _StringsEn {
	...
	@override String get game_more_actions => '更多';
	...
	@override String get srt_book_replace_audio => '替换音频文件';
	...
	@override String get video_mining_image_mode_hint => '视频制卡封面用动图还是截图';
	...
	@override String get video_setting_torrent_backend_embedded => '内置引擎（仅桌面）';
	...
	@override String get download_backend_desktop_only_note => '内置引擎仅桌面平台可用，本设备使用外接 qBittorrent。';
	...
	@override String get game_hook_reason_protocol_mismatch => '捕获组件与本体版本不一致。组件已内置在 Fushi 里，不需要单独安装：先彻底关掉游戏再重开一次（游戏进程里可能还挂着上一次注入的旧组件）。若重开后仍提示不一致，说明这份 Fushi 没带上与之匹配的组件。';
	...
	@override String get anki_connect_use_on_android => '在 Android 上使用 AnkiConnect';
	@override String get anki_connect_use_on_android_hint => '仅在可信网络中使用。AnkiConnect 使用明文 HTTP；请配置匹配的 API key，切换后再刷新牌组与笔记类型。';
	@override String get anki_connect_api_key_hint => '远程 AnkiConnect 必填；必须与插件中配置的 key 一致';
	@override String get anki_connect_android_api_key_required => '请先配置匹配的 AnkiConnect API key，再启用 Android 后端。';
