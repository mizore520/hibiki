...
class _StringsZhCn extends _StringsEn {
	...
	// Translations
	@override String get about_tmdb_attribution => '本应用使用 TMDB 及 TMDB API，但未获 TMDB 认可或认证。';
	...
	@override String get ai_assist_empty => 'AI 没有给出可用结果，换个说法再试试。';
	@override String ai_assist_failed({required Object reason}) => 'AI 请求失败：${reason}';
	@override String get ai_assist_generate => '生成';
	@override String get ai_assist_no_provider => '请先在「设置 › AI」里为这个功能指定提供商';
	@override String get ai_assist_section => '让 AI 帮忙';
	@override String get ai_assist_working => '正在询问 AI…';
	@override String get ai_error_bad_response => '响应格式异常';
	@override String get ai_error_empty_response => '模型没有返回内容';
	@override String ai_error_http({required Object code}) => '服务返回错误（${code}）';
	@override String get ai_error_network => '网络错误';
	@override String get ai_error_not_configured => '这家提供商还没配置完整';
	@override String get ai_error_rate_limited => '被限流，请稍后重试';
	@override String get ai_error_unauthorized => 'API Key 被拒绝';
	@override String get ai_feature_custom_theme => '自定义主题';
	@override String get ai_feature_custom_theme_summary => '让 AI 按描述生成自定义主题配色';
	@override String get ai_feature_dict_style => '词典弹窗样式';
	@override String get ai_feature_dict_style_summary => '让 AI 按描述生成弹窗样式规则与 CSS';
	@override String get ai_feature_galgame_text_process => '游戏文本处理';
	@override String get ai_feature_galgame_text_process_summary => '让 AI 为游戏 hook 文本编写清洗规则';
	@override String get ai_feature_lapis_style => 'Lapis 卡片样式';
	@override String get ai_feature_lapis_style_summary => '让 AI 按描述生成 Lapis 卡片样式规则与 CSS';
	@override String get ai_feature_unset => '未指定';
	@override String get ai_feature_video_acquire => 'AI 下视频';
	@override String get ai_feature_video_acquire_summary => '跟 AI 说作品名，由它解析你的要求、在多义作品与版本里选择，然后下载或订阅';
	@override String get ai_feature_video_identify => '视频作品识别';
	@override String get ai_feature_video_identify_summary => '刮削出现多个候选时让 AI 在候选里选出对应作品';
	@override String get ai_feature_video_search => '视频搜索辅助';
	@override String get ai_feature_video_search_summary => '让 AI 补充搜索词并对字幕、资源结果做语义排序';
	@override String get ai_features_section => '功能提供商';
	@override String get ai_features_section_summary => '为每个功能指定使用哪一家提供商';
	@override String get ai_provider_add => '添加提供商';
	@override String get ai_provider_allow_http => '允许明文 HTTP';
	@override String get ai_provider_allow_http_summary => '本地模型服务（http://localhost）需要打开';
	@override String get ai_provider_api_key => 'API Key';
	@override String get ai_provider_base_url => 'Base URL';
	@override String get ai_provider_base_url_invalid => '请填写有效的 HTTP 或 HTTPS 接口地址';
	@override String get ai_provider_delete => '删除';
	@override String get ai_provider_empty => '还没有配置任何提供商';
	@override String get ai_provider_enabled => '启用';
	@override String get ai_provider_incomplete => '尚未配置完整';
	@override String get ai_provider_model => '模型';
	@override String get ai_provider_model_hint => '可留空，再点下方拉取列表';
	@override String get ai_provider_model_pick => '从已获取的模型里挑';
	@override String get ai_provider_models_fetch => '获取模型列表';
	@override String ai_provider_models_fetched({required Object count}) => '找到 ${count} 个模型';
	@override String get ai_provider_name => '名称';
	@override String get ai_provider_protocol => '协议';
	@override String get ai_provider_protocol_locked => '由内置预设固定，不可更改';
	@override String get ai_provider_ready => '已就绪';
	@override String get ai_provider_reasoning => '推理';
	@override String get ai_provider_reasoning_none => '关闭';
	@override String get ai_provider_test => '测试连接';
	@override String ai_provider_test_failed({required Object reason}) => '测试失败：${reason}';
	@override String get ai_provider_test_ok => '连接正常';
	@override String get ai_providers_section => '提供商配置';
	@override String get ai_providers_section_summary => '添加 Fushi 可以调用的提供商。内置多家预设，也可以添加兼容 Chat Completions 的自定义 API。';
	@override String get ai_settings_summary => '配置 AI 提供商，并为每个功能指定使用哪一家';
	@override String get ai_settings_title => 'AI';
	@override String ai_video_acquire_ai_picked({required Object title, required Object confidence}) => '已选：${title}（AI 判定，${confidence}）。想换就点下面的候选。';
	@override String ai_video_acquire_ai_unavailable({required Object reason}) => 'AI 暂不可用（${reason}），请点选。';
	@override String get ai_video_acquire_airing_unknown => '判不出是否还在放送，订阅选项照样给你。';
	@override String ai_video_acquire_already_in_library({required Object title}) => '「${title}」已经在库里了。';
	@override String ai_video_acquire_already_in_library_episode({required Object title, required Object episode}) => '「${title}」已经在库里了（已到第 ${episode} 集）。';
	@override String ai_video_acquire_already_subscribed({required Object title}) => '「${title}」已经订阅了。';
	@override String get ai_video_acquire_ask_mode => '这部还在放送。要现在下载已出的，还是订阅追更？';
	@override String get ai_video_acquire_ask_presence => '仍要继续吗？';
	@override String get ai_video_acquire_ask_quality => '要什么画质？';
	@override String ai_video_acquire_ask_resolution_fallback({required Object wanted}) => '没有 ${wanted} 的版本，要这些里的吗？';
	@override String get ai_video_acquire_ask_resource => '就用这个版本？';
	@override String get ai_video_acquire_ask_season => '哪一季？';
	@override String get ai_video_acquire_ask_subscribe_fallback => '没有可订阅的版本（缺发布组 / 清晰度证据），改为直接下载？';
	@override String get ai_video_acquire_ask_subtitle_language => '字幕语言怎么配？（只问这一次，之后可在设置里改）';
	@override String get ai_video_acquire_ask_target_source => '下到哪个视频来源？';
	@override String get ai_video_acquire_ask_work => '你要的是哪一部？';
	@override String get ai_video_acquire_cancelled => '已取消。';
	@override String get ai_video_acquire_entry => '让 AI 帮我下';
	@override String get ai_video_acquire_evidence_countries => '制作国';
	@override String get ai_video_acquire_evidence_original_language => '作品原语言';
	@override String get ai_video_acquire_evidence_title_script => '标题文字';
	@override String ai_video_acquire_failed({required Object message}) => '失败：${message}';
	@override String get ai_video_acquire_greeting => '想下哪部？我来找作品、挑版本，然后下载或订阅。';
	@override String get ai_video_acquire_input_hint => '说作品名，比如「间谍过家家 第二季」';
	@override String get ai_video_acquire_no_more_versions => '没有更多版本了。';
	@override String get ai_video_acquire_option_all => '全部';
	@override String get ai_video_acquire_option_confirm => '就这个';
	@override String get ai_video_acquire_option_continue => '继续';
	@override String get ai_video_acquire_option_download => '直接下载';
	@override String get ai_video_acquire_option_next => '换一个';
	@override String get ai_video_acquire_option_none => '都不是';
	@override String get ai_video_acquire_option_subscribe => '订阅更新';
	@override String get ai_video_acquire_remember_default => '以后默认';
	@override String get ai_video_acquire_send => '发送';
	@override String ai_video_acquire_submitted_download({required Object count}) => '已入队 ${count} 条下载，进度看下载页。';
	@override String get ai_video_acquire_submitted_subscribe => '已订阅，新集会自动下载。';
	@override String ai_video_acquire_subtitle_remembered({required Object language}) => '字幕语言「${language}」已记为这部作品的偏好。';
	@override String ai_video_acquire_subtitle_resolved({required Object language, required Object evidence}) => '字幕：${language}（跟随作品语言，依据：${evidence}）。';
	@override String get ai_video_acquire_subtitle_unresolved => '这部作品的语言判不出来，字幕要哪种？';
	@override String ai_video_acquire_summary({required Object version, required Object count, required Object seeders}) => '${version} · ${count} 集 · 做种 ${seeders}';
	@override String ai_video_acquire_summary_batch({required Object version, required Object seeders}) => '${version} · 整季合集 · 做种 ${seeders}';
	@override String ai_video_acquire_summary_missing({required Object episodes}) => '没找到：第 ${episodes} 集';
	@override String get ai_video_acquire_title => 'AI 下视频';
	@override String get ai_video_acquire_unclear => '没听懂，请点选或换个说法。';
	@override String ai_video_acquire_work_chosen({required Object title}) => '已选：${title}';
	@override String ai_video_acquire_work_not_found({required Object query}) => '没找到「${query}」，换个名字试试？';
	@override String get ai_video_download_quality => '默认画质';
	@override String get ai_video_download_quality_any => '不限';
	@override String get ai_video_download_quality_ask => '每次询问';
	@override String get ai_video_download_quality_hint => 'AI 下载助手选版本时使用；「每次询问」= 每次都问。';
	@override String get ai_video_download_quality_unset => '未设置（首次使用时询问）';
	@override String get ai_video_download_section => 'AI 下视频';
	@override String get ai_video_download_subtitle_language => '字幕语言';
	@override String get ai_video_download_subtitle_language_ask => '每次询问';
	@override String get ai_video_download_subtitle_language_hint => '字幕总会自动配；这里决定要哪种语言。「跟随作品语言」= 作品原声语言。';
	@override String get ai_video_download_subtitle_language_none => '不配字幕';
	@override String get ai_video_download_subtitle_language_original => '跟随作品语言';
	@override String get ai_video_download_subtitle_language_unset => '未设置（首次使用时询问）';
	...
	@override String get anime_download_generic_title => '粘贴链接下载';
	...
	@override String get anime_download_relocate_hint => 'Fushi 通过下载引擎改名/移动，因此不会掐断做种。外部改名将无法做种。';
	...
	@override String get anime_download_require_subs => '必须有字幕';
	...
	@override String get anime_download_search_start_hint => '在上方搜索作品名，视频会自动匹配字幕。';
	...
	@override String get anime_download_subs_retrying => '字幕：还没上传，稍后自动重试';
	...
	@override String get anki_action_open_settings => '去设置';
	@override String get anki_allow_duplicates => '允许重复';
	@override String get anki_allow_duplicates_hint => '添加卡片时跳过重复检查';
	@override String get anki_ankimobile_imported => '已导入 AnkiMobile 配置。';
	@override String get anki_ankimobile_opened => '已打开 AnkiMobile。请在其中同意该请求，然后返回 Fushi。';
	...
	@override String get anki_connect_port_auto_fix => '换一个空闲端口';
	@override String anki_connect_port_auto_fix_done({required Object port}) => 'AnkiConnect 端口已改为 ${port}。请重启 Anki 后重试。';
	@override String get anki_connect_port_auto_fix_hint => '自动挑一个空闲端口，同时写进 Hibiki 和 Anki 的 AnkiConnect 插件配置。改完重启 Anki 生效。';
	@override String anki_connect_port_auto_fix_manual({required Object port}) => 'Hibiki 已改用端口 ${port}，但没找到 AnkiConnect 的插件配置。请在 Anki 的「工具 → 插件 → AnkiConnect → 配置」里把 webBindPort 也改成 ${port}，然后重启 Anki。';
	@override String get anki_connect_port_auto_fix_none => '本机没有找到空闲端口。';
	...
	@override String get anki_create_lapis => '创建并选用 Lapis';
	...
	@override String get anki_create_lapis_hint => '向 Anki 添加 Lapis 笔记类型和 Lapis 卡组，并选为制卡目标。';
	@override String get anki_create_lapis_not_found => 'Anki 报告 Lapis 牌组和笔记类型已创建，但回读时仍然找不到它们。请打开 Anki 确认它没有卡住，然后重试。';
	...
	@override String get anki_dedup_auto_hint => '默认关闭。打开后 Fushi 会在启动时扫描（最多每周一次）并展示清单。';
	...
	@override String get anki_dedup_run_hint => '先扫描并列出将要删除的文件。';
	...
	@override String get anki_error_ankidroid_unavailable => '未安装 AnkiDroid（或其 API 被禁用），无法授予卡片访问权限。请安装 AnkiDroid 并启用其 API，或改用 AnkiConnect。';
	@override String get anki_error_ankimobile_no_decks => 'AnkiMobile 没有回传任何牌组或笔记类型。';
	@override String get anki_error_ankimobile_not_active => 'Fushi 没能及时回到前台，剪贴板还没被读取。回到 Fushi 后重试即可。';
	@override String get anki_error_ankimobile_pasteboard_denied => 'iOS 阻止了读取剪贴板。返回 Fushi 时请在系统提示里选「允许粘贴」，然后重试。';
	@override String get anki_error_ankimobile_pasteboard_empty => 'AnkiMobile 没有回传配置。请在 AnkiMobile 中同意该请求后再返回 Fushi。';
	@override String get anki_error_ankimobile_unavailable => '无法打开 AnkiMobile。请先安装 AnkiMobile 再试。';
	...
	@override String get anki_error_field_mapping_mismatch => '当前的字段映射没有一个属于所选的笔记类型，Anki 因此拒收了这张卡。请在 Anki 设置里重新映射字段，或使用「一键创建 Lapis 卡组」。';
	@override String get anki_error_first_field_empty => '所选笔记类型的第一个字段为空，Anki 不接受这样的卡片。请在 Anki 设置里给它映射一个字段。';
	@override String get anki_error_http => '无法导出到 Anki：连接 AnkiConnect 时发生 HTTP 错误。';
	@override String get anki_error_paired_device_unreachable => '无法制卡：当前连不上 Fushi 互联服务端。请确认服务端上的 Fushi 正在运行；如果要在本机制卡，请关闭「制卡到 Fushi 互联服务端」。';
	@override String get anki_error_permission_denied => 'AnkiDroid 尚未授予卡片访问权限。请在刚弹出的系统授权对话框中允许，然后再次点击按钮制卡。';
	@override String get anki_error_permission_permanently_denied => 'AnkiDroid 卡片访问权限已被永久拒绝，系统不再弹出授权对话框。请到应用设置里授予该权限后重试。';
	...
	@override String get anki_lapis_suggest_body => '当前选中的牌组和笔记类型做不出 Anki 会接收的卡片。可以让 Hibiki 添加 Lapis 笔记类型和卡组，并直接选用它们。';
	@override String get anki_lapis_suggest_dismiss => '保持当前设置';
	@override String get anki_lapis_suggest_title => '现在还制不出卡';
	...
	@override String get anki_lapis_visual_editor_hint => '预览并修改 Lapis 卡片。';
	...
	@override String get anki_mine_to_server => '制卡到 Fushi 互联服务端';
	@override String get anki_mine_to_server_hint => '把制卡发送到 Fushi 互联服务端的 Anki（用服务端的牌组与设置），而非本机。需先在互联/同步里完成配对。';
	@override String get anki_mined_action_add_duplicate => '新增为重复卡';
	@override String get anki_mined_action_forget => '我已在 Anki 里删了这张卡';
	...
	@override String get anki_mined_forget_done => '已清除制卡记录';
	@override String anki_mined_multiple_matches({required Object count}) => '${count} 张匹配的卡片';
	@override String get anki_mined_unverified_subtitle => 'Fushi 无法回读 AnkiMobile 的卡片库，已制卡标记来自本机记录，无法判断卡片是否还在 Anki 里。';
	@override String get anki_mined_unverified_title => '已标记为已制卡';
	...
	@override String get anki_reposition_aggregate => '多本词典复合方式';
	@override String get anki_reposition_aggregate_harmonic => '调和平均';
	@override String get anki_reposition_aggregate_min => '取最小';
	@override String get anki_reposition_apply => '执行';
	@override String anki_reposition_auto_failed({required Object deck}) => '「${deck}」自动重排失败';
	@override String get anki_reposition_auto_hint => '最后一张卡制好约 30 秒后，自动按词频重排该牌组的新卡。仅 AnkiConnect 可用。';
	@override String get anki_reposition_auto_title => '制卡后自动重排';
	@override String get anki_reposition_cancelled => '已取消，未写入任何改动。';
	@override String get anki_reposition_dicts_hint => '隐藏的词频词典不会装载，先在词典管理里取消隐藏。一本都不勾 = 使用全部已装载词典。';
	@override String get anki_reposition_dicts_none => '没有已装载的词频词典。';
	@override String anki_reposition_done({required Object count}) => '已重排 ${count} 张新卡。';
	@override String anki_reposition_done_skipped({required Object count, required Object skipped}) => '已重排 ${count} 张新卡；${skipped} 张已不再是新卡，未改动。';
	@override String get anki_reposition_empty => '该卡组没有新卡。';
	@override String anki_reposition_failed({required Object error}) => '重排失败：${error}';
	@override String get anki_reposition_gather_order_hint => '若牌组选项里新卡顺序为随机，位置不会生效；请把新卡收集/排序顺序改成按顺序。';
	@override String get anki_reposition_hint => '把卡组里新卡的学习顺序改成常见词在前，绝不碰复习卡。';
	@override String get anki_reposition_include_subdecks_hint => '含子卡组；筛选牌组里的卡片会跳过。';
	@override String get anki_reposition_no_frequency => '无词频';
	@override String anki_reposition_partial({required Object failed, required Object error}) => '${failed} 张卡片写入失败：${error}';
	@override String get anki_reposition_preview => '预览';
	@override String get anki_reposition_progress_fetch => '正在从 Anki 读取卡片…';
	@override String anki_reposition_progress_rank({required Object done, required Object total}) => '正在查词频（${done}/${total}）';
	@override String get anki_reposition_progress_title => '正在重排新卡…';
	@override String get anki_reposition_progress_write => '正在写回位置…';
	@override String get anki_reposition_rare_first => '罕见词优先';
	@override String get anki_reposition_source => '词频来源';
	@override String get anki_reposition_source_dictionaries => '词频词典';
	@override String get anki_reposition_source_field => '笔记字段';
	@override String get anki_reposition_source_field_hint => '直接读映射为 {frequency-harmonic-rank} 的字段（Lapis 的 FreqSort），不查词典。';
	@override String anki_reposition_summary({required Object total, required Object ranked, required Object unranked, required Object changed}) => '新卡 ${total} 张：${ranked} 张有词频，${unranked} 张无词频（保持在末尾）。将改变 ${changed} 张的位置。';
	@override String get anki_reposition_title => '按词频重排新卡';
	@override String get anki_reposition_unchanged => '卡片已经是这个顺序。';
	@override String get anki_reposition_undo => '撤销上次重排';
	@override String anki_reposition_undo_done({required Object count, required Object skipped}) => '已恢复 ${count} 张卡片的原位置（跳过 ${skipped} 张）。';
	@override String anki_reposition_undo_hint({required Object time}) => '恢复上次重排（${time}）前保存的位置，此后已学过的卡片不动。';
	@override String get anki_reposition_unsupported => '仅 AnkiConnect 后端可用。';
	...
	@override String get app_ui_scale_hint => '整体缩放应用界面（文字、图标、控件一起放大缩小），范围 30% 到 300%。';
	@override String get app_version => '应用版本';
	@override String get apply_theme => '应用主题';
	@override String get asr_models_delete => '删除';
	@override String get asr_models_delete_confirm_message => '再转录这种语言时需要重新下载模型。';
	@override String get asr_models_delete_confirm_title => '删除这个模型？';
	@override String asr_models_delete_done_freed({required Object size}) => '已删除，释放 ${size}';
	@override String get asr_models_download => '下载';
	@override String asr_models_download_failed({required Object error}) => '下载失败：${error}';
	@override String get asr_models_section => '语音识别模型';
	@override String get asr_models_section_summary => '本机语音识别模型，只下载你需要的语言。';
	@override String asr_models_status_missing({required Object size}) => '未下载 · 需要 ${size}';
	@override String asr_models_status_partial({required Object obtained, required Object total}) => '已下载一部分 · ${obtained} / ${total}';
	@override String asr_models_status_ready({required Object size}) => '已下载 · 占用 ${size}';
	...
	@override String get audiobook_export_clip_share_unavailable => '片段已保存，但系统分享面板没有打开';
	...
	@override String get audiobook_follow_audio => '跟随音频';
	...
	@override String get audiobook_material_add_dir => '添加目录';
	@override String get audiobook_material_library => '有声书素材库';
	@override String get audiobook_material_library_hint => '存放按作品编号命名的字幕与正文文件的目录。下载完成后自动据此配对。';
	@override String get audiobook_material_missing_dir => '目录不存在';
	@override String get audiobook_material_none => '还没有添加目录';
	@override String audiobook_material_status({required Object dirs, required Object works}) => '${dirs} 个目录，认得 ${works} 部作品';
	...
	@override String get audiobook_subtitle_source_title => '字幕来源';
	@override String get audiobook_subtitle_source_transcribe_hint => '用设备端语音模型从已选音频生成';
	@override String get audiobook_transcribe_accel_auto => '自动（有 GPU 则用）';
	@override String get audiobook_transcribe_accel_coreml => 'CoreML（FP32）';
	@override String get audiobook_transcribe_accel_cpu => '仅 CPU';
	@override String get audiobook_transcribe_accel_label => '加速';
	@override String get audiobook_transcribe_action => '设备端转录生成字幕';
	@override String get audiobook_transcribe_alignment_hint => '生成文字后会再运行一遍模型校准时间，再保存字幕。首次使用会下载所需的调轴模型。';
	@override String get audiobook_transcribe_discard => '放弃进度';
	@override String audiobook_transcribe_done({required Object segments, required Object cues}) => '完成：${segments} 段语音生成 ${cues} 条字幕';
	@override String audiobook_transcribe_elapsed_total({required Object elapsed}) => '总耗时 ${elapsed}';
	@override String get audiobook_transcribe_engine_system => '系统语音识别（Apple）';
	@override String get audiobook_transcribe_engine_system_hint => '用系统自带的语音模型，不下载我们那 1 GB 模型。首次使用时系统仍会下载它自己的语言资产，那份资产由系统保管、多个 app 共用。';
	@override String get audiobook_transcribe_engine_system_install => '安装语言';
	@override String get audiobook_transcribe_engine_system_installing => '正在让系统安装该语言…';
	@override String get audiobook_transcribe_engine_system_no_pause => '这个引擎在文件中途无法暂停，停止会丢掉当前文件的进度。';
	@override String get audiobook_transcribe_export => '导出字幕文件';
	@override String get audiobook_transcribe_export_saved => '字幕文件已导出';
	@override String audiobook_transcribe_failed({required Object error}) => '转录失败：${error}';
	@override String audiobook_transcribe_fallback({required Object reason}) => 'GPU 不可用，已回退到 CPU：${reason}';
	@override String get audiobook_transcribe_intro => '在本机用所选语言的语音模型转录音频并生成用于对齐的字幕，不会上传任何内容。';
	@override String get audiobook_transcribe_language_label => '语音语言';
	@override String get audiobook_transcribe_model_custom_add => '手动指定模型…';
	@override String audiobook_transcribe_model_custom_added({required Object name}) => '已接入 ${name}';
	@override String get audiobook_transcribe_model_custom_advanced => '高级';
	@override String get audiobook_transcribe_model_custom_badge => '自带';
	@override String get audiobook_transcribe_model_custom_blank => 'Blank 记号';
	@override String get audiobook_transcribe_model_custom_blank_hint => 'tokens.txt 里 blank 的记号名。sherpa-onnx 导出一般是 <blk>，Omnilingual 是 <s>。写错会让整篇转录变成乱码。';
	@override String get audiobook_transcribe_model_custom_context => 'Decoder 上下文长度';
	@override String get audiobook_transcribe_model_custom_detach => '移除接入';
	@override String get audiobook_transcribe_model_custom_detach_hint => '只是从模型列表里移除，你的文件不会被删除。';
	@override String get audiobook_transcribe_model_custom_error_model => '这个文件夹里没有 .onnx 模型文件。';
	@override String get audiobook_transcribe_model_custom_error_tokens => '这个文件夹里没有 tokens.txt。';
	@override String get audiobook_transcribe_model_custom_error_transducer => '找到了 encoder，但旁边没有 decoder / joiner。';
	@override String get audiobook_transcribe_model_custom_index => '索引张量整型';
	@override String get audiobook_transcribe_model_custom_intro => '选一个放着 sherpa-onnx 导出模型的文件夹（encoder / decoder / joiner 三件套，或单个 CTC 模型，外加 tokens.txt）。文件留在原处不会复制，只有文件夹里没有 VAD 模型时会补下那 640 KB。';
	@override String get audiobook_transcribe_model_custom_name => '模型名称';
	@override String get audiobook_transcribe_model_custom_pick => '选择文件夹';
	@override String get audiobook_transcribe_model_custom_title => '手动指定模型';
	@override String get audiobook_transcribe_model_discarded => '模型文件读不出来，已自动清除，请重新下载。';
	@override String get audiobook_transcribe_model_download => '下载模型';
	@override String audiobook_transcribe_model_download_needed({required Object size}) => '需要下载模型：${size}';
	@override String audiobook_transcribe_model_downloading({required Object name, required Object received, required Object total}) => '正在下载 ${name}… ${received} / ${total}';
	@override String get audiobook_transcribe_model_fit_desktop => '大模型 · 建议桌面（有独显更好）';
	@override String get audiobook_transcribe_model_fit_heavy_mobile => '大模型 · 手机上能跑，但很慢';
	@override String get audiobook_transcribe_model_fit_light => '轻量 · 手机和桌面都合适';
	@override String get audiobook_transcribe_model_label => '模型';
	@override String audiobook_transcribe_model_ready({required Object variant}) => '模型已就绪（${variant}）';
	@override String get audiobook_transcribe_model_scope_dedicated => '专用模型 · 这门语言识别最准';
	@override String get audiobook_transcribe_model_scope_multilingual => '通用模型 · 语言覆盖广，单语言精度不如专用模型';
	@override String get audiobook_transcribe_needs_audio => '请先选择音频文件';
	@override String get audiobook_transcribe_pause => '暂停';
	@override String get audiobook_transcribe_paused_hint => '进度已保存，之后选同一组音频文件即可继续。';
	@override String get audiobook_transcribe_pausing => '将在下一个检查点暂停…';
	@override String get audiobook_transcribe_preparing => '正在加载模型…';
	@override String audiobook_transcribe_probe_failed({required Object reason}) => 'GPU 探测失败，按 CPU 规划：${reason}';
	@override String audiobook_transcribe_progress({required Object done, required Object total, required Object file, required Object files}) => '${done} / ${total} · 文件 ${file}/${files}';
	@override String audiobook_transcribe_remote_model_missing({required Object device}) => '${device} 没有该语言的模型';
	@override String audiobook_transcribe_remote_running({required Object device, required Object percent}) => '${device} 转录中… ${percent}%';
	@override String audiobook_transcribe_remote_uploading({required Object device, required Object done, required Object total}) => '正在上传音频到 ${device}…（${done}/${total}）';
	@override String get audiobook_transcribe_result_name => '设备端转录生成';
	@override String get audiobook_transcribe_resume => '继续转录';
	@override String get audiobook_transcribe_run_local => '本机';
	@override String get audiobook_transcribe_run_location => '运行位置';
	@override String audiobook_transcribe_run_remote({required Object device}) => '${device}（互联主机）';
	@override String audiobook_transcribe_running_on({required Object provider}) => '运行于 ${provider}';
	@override String audiobook_transcribe_running_on_static({required Object provider}) => '运行于 ${provider} · 静态融合图';
	@override String audiobook_transcribe_speed({required Object elapsed, required Object eta, required Object speed}) => '已用 ${elapsed} · 剩余 ${eta} · ${speed} 倍速';
	@override String get audiobook_transcribe_start => '开始转录';
	@override String get audiobook_transcribe_title => '设备端语音转录';
	@override String get audiobook_transcribe_unavailable => '此平台不支持设备端转录';
	@override String get audiobook_transcribe_use_result => '使用字幕';
	@override String get auto_add_book_name_to_tags => '自动添加书名到标签';
	@override String get auto_add_char_position_to_tags => '自动添加制卡位置到标签';
	@override String get auto_add_char_position_to_tags_hint => '给卡片加上 chars_12345 标签，记录制卡时读到全书第几个字。';
	...
	@override String get backup_category_games => '游戏';
	@override String get backup_category_games_desc => '游戏库、元数据来源与封面';
	...
	@override String backup_export_dictionaries_skipped({required Object n, required Object names}) => '导出完成，但有 ${n} 本词典被跳过：这台设备上找不到它们的文件（${names}）';
	@override String backup_export_failed({required Object message}) => '备份导出失败：${message}';
	@override String get backup_export_hint => '选择要包含的内容。';
	...
	@override String batch_hidden_by_filter_note({required Object n}) => '另有 ${n} 项被当前筛选隐藏，本次不会处理。';
	...
	@override String get book_rename_label => '标题';
	...
	@override String get browser_extension_step_done_auto => '完成。扩展已自动配置好，装好后会直接连上本应用查词。';
	...
	@override String get browser_extension_test_page_action => '打开试用网页';
	@override String get browser_extension_test_page_action_desc => '在浏览器里打开一张由 Fushi 提供的网页，验证右上角弹窗与 Shift 查词。';
	@override String get browser_extension_test_page_intro => '这张页面由 Fushi 自己提供，扩展一定能注入它。按下面两步试一下。';
	@override String get browser_extension_test_page_probe_checking => '正在检测扩展是否已注入本页…';
	@override String get browser_extension_test_page_probe_missing => '没有检测到扩展。请先在浏览器里加载扩展，然后刷新本页。';
	@override String get browser_extension_test_page_probe_ok => '扩展已注入本页，连接正常。';
	@override String get browser_extension_test_page_sample_label => '练习句';
	@override String get browser_extension_test_page_server_off => '请先开启查词服务器，再打开试用网页。';
	@override String get browser_extension_test_page_step_lookup_body => '按住 Shift 并把鼠标移到下面句子里的词上，应该弹出词典查词结果。';
	@override String get browser_extension_test_page_step_lookup_title => '按 Shift 查词';
	@override String get browser_extension_test_page_step_popup_body => '点击浏览器右上角的 Fushi 图标，应该弹出扩展面板。';
	@override String get browser_extension_test_page_step_popup_title => '从右上角打开扩展';
	@override String get browser_extension_test_page_title => '试一试浏览器扩展';
	...
	@override String get card_source_review_after => '修改后';
	@override String get card_source_review_before => '原内容';
	@override String get card_source_review_changes => '选择要更新的字段';
	@override String get card_source_review_conflict_warning => '请避免同时在 Anki 和 Fushi 编辑这张卡；发生冲突时，修改会保留为本地草稿。';
	@override String get card_source_review_continue => '从这里继续阅读';
	@override String get card_source_review_draft_discard => '丢弃草稿';
	@override String get card_source_review_draft_existing => '已有未提交草稿，请先恢复或丢弃草稿，再进行新的修改。';
	@override String get card_source_review_draft_resume => '恢复草稿';
	@override String get card_source_review_draft_saved => '修改已保留为本地草稿，请恢复草稿后重新核对并手动提交。';
	@override String get card_source_review_failed => '修改尚未保存，原卡可能已被修改或设备不可达。';
	@override String get card_source_review_fingerprint_mismatch => '当前文件与卡片来源不一致，请使用对应的原文件。';
	@override String get card_source_review_invalid => '来源链接无效或版本暂不支持。';
	@override String get card_source_review_local_required => '请先下载视频，再进行不影响服务器进度的回看。';
	@override String get card_source_review_media_missing => '此设备没有对应来源，请先导入或下载作品。';
	@override String get card_source_review_missing => '找不到原卡，请同步 Anki 或连接原卡所在的 Fushi 互联服务端。';
	@override String get card_source_review_no_changes => '未选择要更新的字段';
	@override String get card_source_review_return => '返回';
	@override String get card_source_review_save => '保存选中修改';
	@override String get card_source_review_saved => '原卡已更新';
	@override String get card_source_review_source => '卡片来源';
	@override String get card_source_review_title => '正在回看卡片来源 · 不影响阅读进度';
	@override String get card_source_review_video_continue => '从这里继续观看';
	@override String get card_source_review_video_return => '返回原观看位置';
	@override String get card_source_review_video_title => '正在回看卡片片段 · 不影响观看进度';
	@override String get card_source_review_video_watching => '正在正常观看 · 会记录观看进度';
	...
	@override String get collection_cover_failed => '封面设置失败';
	@override String get collection_cover_reset => '恢复默认封面';
	@override String get collection_cover_set => '设置封面';
	@override String get collection_cover_updated => '封面已更新';
	@override String get collection_empty => '合集为空';
	@override String collection_episode_anidb_number({required Object number}) => 'AniDB 第 ${number} 集';
	@override String get collection_episode_download => '下载本集';
	@override String get collection_episode_fill_missing => '补齐缺集';
	@override String get collection_episode_link_clear => '清除手动指定';
	@override String get collection_episode_link_cleared => '已清除手动指定，下次刮削回到自动链接';
	@override String collection_episode_link_episode({required Object number}) => '第 ${number} 集';
	@override String get collection_episode_link_hint => '钉死这个文件对应的季集，之后每次刮削都保留（Shoko UserVerified）。';
	@override String get collection_episode_link_manual => '手动指定季集…';
	@override String get collection_episode_link_saved => '已手动指定季集，刮削时保留';
	@override String collection_episode_link_season({required Object number}) => '第 ${number} 季';
	@override String get collection_episode_link_unavailable => '先刮出作品资料再指定';
	...
	@override String get collection_export_all_sources => '全部来源';
	...
	@override String get collection_export_pick_source => '选择来源';
	...
	@override String get collection_rescrape => '重新刮削资料与封面';
	@override String get collection_rescrape_failed => '重新刮削失败';
	@override String get collection_rescrape_not_planned => '这个合集不在任何本地视频来源的刮削计划里';
	@override String get collection_rescrape_pick_work => '选择要重新刮削的作品';
	@override String get collection_rescrape_started => '已开始重新刮削';
	...
	@override String get collection_tmdb_ordering => 'TMDB 集编排…';
	@override String collection_tmdb_ordering_counts({required Object groups, required Object episodes}) => '${groups} 组 · ${episodes} 集';
	@override String get collection_tmdb_ordering_default => 'TMDB 默认排序';
	@override String get collection_tmdb_ordering_hint => '选定这部剧按 TMDB 哪一套排序划分季集；AniDB 集级链接随之按该排序重算。';
	@override String get collection_tmdb_ordering_none => 'TMDB 上这部剧没有备选排序';
	@override String get collection_tmdb_ordering_saved => '已选定排序，正在重刮…';
	@override String get collection_tmdb_ordering_unavailable => '作品还没有 TMDB 身份，先刮削';
	...
	@override String data_root_unavailable_message({required Object path}) => '你设置的数据位置 ${path} 暂时读不到（盘可能在休眠、被占用或未连接）。请点「重试」,等盘就绪重启Fushi即可用回你的数据；或选择用默认位置临时启动（不会改动你原来的数据）。';
	...
	@override String get db_cannot_open_message => 'Fushi 无法在配置的数据位置打开或创建数据库。数据没有损坏——该文件夹可能不存在、只读，或位于已断开的磁盘上。请在设置中检查数据位置，或重启以使用默认位置。';
	@override String get db_cannot_open_title => '数据位置不可用';
	...
	@override String get delete_choices_remember => '记住这些选择';
	@override String get delete_collection => '删除合集';
	@override String get delete_collection_also_books => '同时删除其中的书';
	@override String get delete_collection_also_videos => '同时删除其中的视频';
	...
	@override String get delete_disclosure_audio_source_files => '你导入时选择的原始音频文件';
	...
	@override String get delete_disclosure_book_source_kept => '你导入时选择的原始书籍与字幕文件';
	...
	@override String get delete_local_files => '同时删除本地文件';
	@override String get delete_local_files_audio_desc => '原始音频文件将从本设备删除；书籍与字幕原件保留，无法恢复';
	@override String delete_local_files_failed({required Object n}) => '有 ${n} 个本地文件删除失败，可能正在被使用';
	@override String get delete_local_files_video_desc => '视频文件与紧邻的外挂字幕将从本设备删除，下载任务一并清除，无法恢复';
	...
	@override String get delete_statistics => '同时删除统计数据';
	@override String get delete_statistics_video_desc => '该视频的观看时长、字幕字数与查词/制卡计数将从统计中移除，并同步到其他设备';
	...
	@override String get dialog_background_close => '关闭（任务继续在后台运行）';
	...
	@override String dict_error_connect_timeout({required Object host}) => '连接 ${host} 超时，当前网络可能访问不了这个站点';
	@override String dict_error_connection({required Object host}) => '无法连接 ${host}';
	@override String dict_error_http_status({required Object host, required Object status}) => '${host} 返回 HTTP ${status}';
	@override String dict_error_stall_timeout({required Object host}) => '${host} 传输中断，长时间没有收到数据';
	...
	@override String get dict_rename_label => '词典名称';
	@override String get dict_style_ai_applied => 'AI 建议已填入草稿，看过预览再保存。';
	@override String get dict_style_ai_hint => '描述想要的样子，例如：词头加粗改蓝色，释义字号调小';
	@override String get dict_style_global_only => '此部位只能对全部词典设置';
	@override String get dict_style_part_deinflection_tag => '去屈折链';
	@override String get dict_style_part_dictionary_label => '词典名';
	@override String get dict_style_part_entry_card => '词条卡';
	@override String get dict_style_part_expression => '词头';
	@override String get dict_style_part_expression_tag => '表达标签';
	@override String get dict_style_part_frequency => '频率';
	@override String get dict_style_part_glossary_content => '释义正文';
	@override String get dict_style_part_glossary_tag => '释义标签';
	@override String get dict_style_part_pitch => '音调';
	@override String get dict_style_part_reset => '重置此部位';
	@override String get dict_style_part_ruby => '振假名';
	@override String get dict_style_pick_hint => '点预览里的部位可直接跳过去';
	@override String get dict_style_preview_title => '预览';
	@override String get dict_style_prop_background => '高亮底色';
	@override String get dict_style_prop_bold => '粗体';
	@override String get dict_style_prop_corner_radius => '圆角';
	@override String get dict_style_prop_default => '默认';
	@override String get dict_style_prop_font_scale => '字号';
	@override String get dict_style_prop_italic => '斜体';
	@override String get dict_style_prop_off => '关';
	@override String get dict_style_prop_on => '开';
	@override String get dict_style_prop_text_color => '文字颜色';
	@override String get dict_style_prop_underline => '下划线';
	@override String get dict_style_reset_all => '全部重置';
	@override String get dict_style_scope_all => '全部词典';
	@override String get dict_style_tab_code => '手写 CSS';
	@override String get dict_style_tab_visual => '可视化';
	@override String get dict_style_title => '词典样式';
	@override String dict_task_failed_download({required Object name, required Object reason}) => '下载失败：${name}（${reason}）';
	@override String dict_task_failed_import({required Object name, required Object reason}) => '导入失败：${name}（${reason}）';
	@override String dict_task_failed_summary({required Object n}) => '${n} 本词典处理失败';
	...
	@override String get dictionary_collapse_follow_global => '跟随全局设置';
	...
	@override String get discovery_alist_add => '添加站点';
	@override String get discovery_alist_allow_http => '允许明文 HTTP';
	@override String get discovery_alist_allow_http_hint => '局域网自建站点需要';
	@override String get discovery_alist_enabled => '启用';
	@override String get discovery_alist_kinds => '显示在';
	@override String get discovery_alist_kinds_hint => '至少选择一个要显示此站点的库';
	@override String get discovery_alist_name => '显示名称';
	@override String get discovery_alist_name_hint => '留空则使用主机名';
	@override String get discovery_alist_password => '密码';
	@override String get discovery_alist_remove => '移除';
	@override String get discovery_alist_settings_hint => '浏览并下载 AList 或 OpenList 站点上的文件；账号留空即以游客访问';
	@override String get discovery_alist_settings_title => 'AList / OpenList 站点';
	@override String get discovery_alist_test => '测试连接';
	@override String discovery_alist_test_failed({required Object reason}) => '连接失败：${reason}';
	@override String discovery_alist_test_ok({required Object count}) => '已连接，根目录有 ${count} 个条目';
	@override String get discovery_alist_url => '站点地址';
	@override String get discovery_alist_url_hint => '站点根地址，例如 https://od.example.com';
	@override String get discovery_alist_url_invalid => '请输入有效的 HTTP 或 HTTPS 站点地址';
	@override String get discovery_alist_url_needs_http_optin => '明文 HTTP 需要先打开下方开关';
	@override String get discovery_alist_username => '用户名';
	@override String get discovery_alist_username_hint => '留空则以游客访问';
	@override String get discovery_all_sources => '全部源';
	@override String get discovery_badge_remake => 'Remake';
	@override String get discovery_badge_trusted => '信任发布者';
	@override String get discovery_content_hint_manga => '疑似漫画';
	@override String get discovery_download_queued => '已加入下载';
	@override String get discovery_empty => '无结果';
	@override String get discovery_enter_query_hint => '输入关键词搜索';
	@override String get discovery_filter_hide_suspected_manga => '隐藏疑似漫画';
	@override String get discovery_filter_hide_zero_seeders => '隐藏无人做种';
	@override String get discovery_game_type_all => '全部';
	@override String get discovery_game_type_mobile => '手机';
	@override String get discovery_game_type_raw => '生肉';
	@override String get discovery_game_type_translated => '熟肉';
	@override String get discovery_game_type_unlabelled => '未标注';
	@override String get discovery_hidden_show => '显示';
	@override String discovery_hidden_suspected_manga_count({required Object n}) => '已隐藏 ${n} 条疑似漫画';
	@override String discovery_hidden_zero_seeders_count({required Object n}) => '已隐藏 ${n} 条无人做种';
	@override String get discovery_kind_audiobook => '有声书';
	@override String get discovery_kind_manga => '漫画';
	@override String get discovery_kind_novel => '小说';
	@override String get discovery_load_more => '加载更多';
	@override String get discovery_nyaa_filter_all => '全部';
	@override String get discovery_nyaa_filter_no_remakes => '排除 remake';
	@override String get discovery_nyaa_filter_trusted_only => '仅信任发布者';
	@override String get discovery_opds_add => '添加 OPDS 服务器';
	@override String get discovery_opds_allow_http => '允许明文 HTTP';
	@override String get discovery_opds_allow_http_hint => '局域网自建服务器需要打开';
	@override String get discovery_opds_enabled => '启用';
	@override String get discovery_opds_name => '显示名';
	@override String get discovery_opds_name_hint => '留空则使用主机名';
	@override String get discovery_opds_password => '密码';
	@override String get discovery_opds_remove => '移除';
	@override String get discovery_opds_settings_hint => '从你自己的 OPDS 服务器浏览并下载书籍与漫画，例如 BookOrbit、Calibre-Web、Komga、Kavita';
	@override String get discovery_opds_settings_title => 'OPDS 书目服务器';
	@override String get discovery_opds_test => '测试连接';
	@override String discovery_opds_test_failed({required Object reason}) => '连接失败：${reason}';
	@override String discovery_opds_test_ok({required Object count}) => '连接成功，根目录有 ${count} 个条目';
	@override String get discovery_opds_url => '目录地址';
	@override String get discovery_opds_url_hint => 'OPDS 端点，例如 https://books.example.com/api/v1/opds';
	@override String get discovery_opds_url_invalid => '请填写有效的 HTTP 或 HTTPS 目录地址';
	@override String get discovery_opds_url_needs_http_optin => '明文 HTTP 需要打开下面的开关';
	@override String get discovery_opds_username => '用户名';
	@override String get discovery_opds_username_hint => '公开目录留空即可';
	@override String get discovery_partial_failure => '部分源不可用';
	@override String get discovery_search_hint => '搜索在线资源';
	@override String discovery_source_kinds_label({required Object kinds}) => '覆盖：${kinds}';
	@override String get discovery_source_pick_hint => '选择来源浏览，或输入关键词搜索全部来源';
	@override String get discovery_source_query_required => '该来源只支持关键词搜索';
	@override String get discovery_sources_settings_hint => '哪些内置来源参与发现页「全部源」聚合搜索。在源下拉里显式单选某个源不受此处影响。';
	@override String get discovery_sources_settings_title => '发现来源';
	@override String get discovery_sources_unavailable => '全部来源都不可用';
	@override String get discovery_torrent_failed => '种子任务添加失败';
	@override String get discovery_torrent_pushed => '种子任务已添加';
	@override String get dismiss_swipe_sensitivity => '滑动关闭灵敏度';
	@override String get display_settings => '排版设置';
	@override String get download_add_video_source => '添加视频来源';
	...
	@override String get download_backend_embedded_hint => '推荐。下载在 Fushi 内部完成，无需另外安装软件。';
	@override String get download_backend_embedded_unavailable => '本次安装缺少内置引擎运行库。请重装完整安装包，或改用外接 qBittorrent。';
	@override String get download_backend_not_configured => '请先配置下载后端。';
	@override String get download_backend_qb_hint => '连接到你已经在运行的 qBittorrent WebUI。';
	@override String get download_backend_qb_url_invalid => '请填完整地址，例如 http://127.0.0.1:8080';
	@override String get download_backend_setup_intro => '选择由哪个引擎执行下载任务，之后可随时在下载设置里更改。';
	@override String get download_backend_setup_start => '开始配置';
	@override String get download_backend_setup_title => '配置下载后端';
	@override String get download_backend_unsupported_note => '本平台无内置引擎，下载使用外接 qBittorrent。';
	@override String download_batch_delete_confirm({required Object n}) => '删除 ${n} 个下载任务？';
	@override String download_batch_done({required Object n}) => '已处理 ${n} 项';
	@override String download_batch_failed({required Object n}) => '${n} 项失败';
	@override String download_batch_unsupported({required Object n}) => '${n} 项不支持此操作';
	...
	@override String get download_direct_queue_section => '直链下载';
	@override String get download_execution_host_hint => '新下载任务交给这台设备执行，下到它自己的库里。先在「互联」里配对设备。';
	@override String get download_execution_host_title => '下载执行设备';
	@override String get download_execution_host_unreachable => '下载设置里指定的执行设备连不上，没有开始下载。';
	@override String get download_execution_remote_kind_unsupported => '下载执行设备不支持导入这类内容';
	@override String get download_execution_remote_magnet_only => '下载执行设备只接受磁力链接';
	@override String get download_execution_remote_queued => '已交给下载执行设备';
	@override String get download_no_managed_video_source => '还没有受管视频来源。请添加一个存放下载文件的本地文件夹，下载完成的视频才能入库。';
	...
	@override String get download_remote_jobs_empty => '主机上还没有任务';
	@override String download_remote_jobs_title({required Object device}) => '${device} 上的任务';
	@override String get download_request_failed => '无法创建下载。请检查下载设置和任务列表后重试。';
	@override String get download_resource_resolve_failed => '无法获取下载资源。请检查网络和代理设置后重试。';
	...
	@override String download_subscription_choice_hint_batch({required Object group, required Object resolution}) => '一次性下载 ${group} · ${resolution} 整包。合集没有可追的下一集。';
	...
	@override String get download_subscription_source_unavailable => '当前目标库（当前不可用）';
	@override String download_subscription_start_episode({required Object episode}) => '从第 ${episode} 集开始';
	@override String get download_subscription_start_episode_invalid => '请填 0 或更大的整数，留空表示不限';
	...
	@override String get download_target_label => '下载到';
	@override String get download_target_local => '本机';
	@override String download_target_remote({required Object device}) => '${device}（互联主机）';
	@override String download_task_action_failed({required Object error}) => '任务操作失败：${error}';
	@override String get download_task_add => '添加任务';
	@override String get download_task_add_content_kind => '内容类型';
	@override String get download_task_add_invalid => '无法识别的磁力链接或种子文件';
	@override String get download_task_add_pick_torrent => '选择种子文件';
	@override String get download_task_add_submitted => '已添加任务';
	@override String get download_task_add_title_label => '标题';
	@override String get download_task_audiobook_needs_alignment => '只下到音频 - 还需要一个对齐文件（字幕）才能作为书打开。';
	@override String get download_task_audiobook_pair => '补对齐文件';
	@override String get download_task_collection_unassigned => '未归属合集';
	...
	@override String get download_task_delete_files_failed => '已下载的数据未能删除：下载后端没有确认';
	...
	@override String get download_task_group_by => '分组';
	@override String get download_task_group_collection => '合集／作品';
	@override String get download_task_group_kind => '媒体类型';
	@override String get download_task_group_none => '不分组';
	@override String get download_task_group_status => '状态';
	@override String get download_task_groups_collapse => '收起所有分组';
	@override String get download_task_groups_expand => '展开所有分组';
	@override String get download_task_kind_all => '全部类型';
	@override String get download_task_kind_filter => '按类型筛选';
	...
	@override String get download_task_no_match => '没有匹配的任务';
	...
	@override String get download_task_search_hint => '搜索任务';
	@override String get download_task_sort_created => '添加时间';
	@override String get download_task_sort_direction => '切换升降序';
	@override String get download_task_sort_progress => '进度';
	@override String get download_task_sort_status => '状态';
	...
	@override String get download_task_status_active => '进行中';
	@override String get download_task_status_attention => '需要处理';
	...
	@override String get download_task_status_filter => '任务状态';
	...
	@override String get download_torrent_invalid => '来源返回的种子数据无效。请稍后重试或更换来源。';
	@override String get download_torrent_selection_failed => '无法在种子中唯一匹配这本书。请刷新目录或更换来源。';
	@override String get download_tracker_auto_add => '自动把订阅 Tracker 加到新下载';
	@override String get download_tracker_auto_add_hint => '列表缓存 6 小时；订阅获取失败不会阻止下载任务创建。';
	@override String download_tracker_fetch_failed({required Object message}) => '获取 Tracker 失败：${message}';
	@override String download_tracker_preview_count({required Object count}) => '已获取 ${count} 个 Tracker';
	@override String get download_tracker_preview_empty => '获取订阅后可预览受支持的 HTTP、HTTPS 和 UDP Tracker。';
	@override String get download_tracker_refresh => '获取 Tracker';
	@override String get download_tracker_section => 'Tracker 订阅';
	@override String get download_tracker_url => '订阅地址';
	@override String get download_video_source_required => '需要视频来源';
	@override String get drag_drop_failed => '拖入的文件处理失败，请重试。';
	@override String get drag_drop_folder_source_added => '已把文件夹添加为来源并开始扫描';
	@override String get drag_drop_folder_source_exists => '该文件夹已经是来源了';
	...
	@override String get drag_drop_unsupported_on_downloads => '请把 .torrent 种子文件拖到这里以添加下载任务。其它文件请拖到书架、漫画库或视频页。';
	...
	@override String get floating_lyric_topmost => '保持置顶';
	...
	@override String get font_target_game_lookup => '游戏查词窗口字体';
	@override String get font_target_video_subtitle => '视频字幕字体';
	@override String get gal_card_lookup_independent_size => '游戏内查词卡独立尺寸';
	@override String get gal_card_lookup_independent_size_hint => '让游戏内查词卡与桌面覆盖查词窗各自设置大小';
	@override String get gal_card_lookup_max_height => '游戏内查词卡最大高度';
	@override String get gal_card_lookup_max_width => '游戏内查词卡最大宽度';
	@override String get gal_hook_click_lookup => '单击文字查词';
	@override String get gal_hook_click_lookup_hint => '关掉后点台词不再触发查词。开着鼠标穿透时尤其有用——不想一不小心点到单词。';
	@override String get gal_hook_fold_progressive_lines => '合并分段吐出的台词';
	@override String get gal_hook_fold_progressive_lines_hint => '有些引擎每次点击都重绘整行，一句台词会被抓成好几条。开启后把同一句的多次快照折成一条。';
	@override String get gal_hook_ingame_lookup => '游戏内查词';
	@override String get gal_hook_ingame_lookup_engine_unsupported => '当前游戏引擎不支持游戏内查词';
	@override String get gal_hook_ingame_lookup_exe_hash_copied => '已复制 exe 的 SHA-256';
	@override String get gal_hook_ingame_lookup_exe_hash_copy => '复制游戏 exe 的 SHA-256';
	@override String get gal_hook_ingame_lookup_exe_hash_unavailable => '无法读取游戏 exe（可能权限不足）';
	@override String get gal_hook_ingame_lookup_hint => '在游戏画面内直接显示词典卡片（KiriKiri 引擎，仅 Windows）';
	@override String get gal_hook_ingame_lookup_version_unsupported => '当前游戏版本未在支持列表中';
	@override String get gal_hook_lookup_trigger => '查词触发方式';
	@override String get gal_hook_lookup_trigger_hint => '用哪个鼠标键查指针底下的词。与上面的开关正交：可以关掉单击查词，仍用侧键查。';
	@override String get gal_hook_lookup_trigger_left => '左键单击';
	@override String get gal_hook_lookup_trigger_middle => '鼠标中键';
	@override String get gal_hook_lookup_trigger_side => '鼠标侧键';
	@override String get gal_hook_overlay_legibility_section => '窗口与可读性';
	@override String get gal_hook_passthrough_blocks_mouse => '穿透时台词仍拦截点击';
	@override String get gal_hook_passthrough_blocks_mouse_hint => '开：文字行仍接鼠标，能点字查词。关：整个浮窗对鼠标彻底透明，能点到底下的东西，但点字查词也就没了。';
	@override String get gal_hook_text_alignment => '文字对齐';
	@override String get gal_hook_text_alignment_center => '居中';
	@override String get gal_hook_text_alignment_left => '左对齐';
	@override String get gal_hook_text_background_color => '窗口背景颜色';
	@override String get gal_hook_text_background_opacity => '窗口背景透明度';
	@override String get gal_hook_text_background_opacity_hint => '设为 0% 可得到桌面歌词式透明窗口。';
	@override String get gal_hook_text_bold => '粗体文字';
	@override String get gal_hook_text_bold_hint => '使用半粗体，提高文字在游戏画面上的可读性。';
	@override String get gal_hook_text_color => '文字颜色';
	@override String get gal_hook_text_corner_radius => '窗口圆角';
	@override String get gal_hook_text_corner_radius_hint => '调整窗口背景的圆角半径。';
	@override String get gal_hook_text_font => '游戏查词窗口字体';
	@override String get gal_hook_text_font_family => 'Galgame 台词字体';
	@override String get gal_hook_text_font_hint => '从管理字体库中选择，按顺序使用第一个启用的字体。';
	...
	@override String get gal_hook_text_letter_spacing => '字间距';
	@override String get gal_hook_text_letter_spacing_hint => '调整字符之间的距离，不影响点字查词命中。';
	@override String get gal_hook_text_line_height => '行高';
	@override String get gal_hook_text_line_height_hint => '调整换行文本的垂直间距。';
	@override String get gal_hook_text_outline_color => '描边颜色';
	@override String get gal_hook_text_outline_width => '描边宽度';
	@override String get gal_hook_text_outline_width_hint => '设为 0 可关闭描边，轻微投影仍会保留。';
	@override String get gal_hook_text_padding => '文字左右边距';
	@override String get gal_hook_text_padding_hint => '让文字与窗口边缘和缩放手柄保持距离。';
	@override String get gal_hook_text_vertical_alignment => '垂直对齐';
	@override String get gal_hook_text_vertical_alignment_center => '居中';
	@override String get gal_hook_text_vertical_alignment_top => '顶部';
	@override String get gal_hook_toolbar_auto_hide => '自动隐藏功能栏';
	@override String get gal_hook_toolbar_auto_hide_hint => '平时把功能栏整条隐藏，鼠标移到台词框附近才现身（LunaHook 那样）。隐藏就是真隐藏，那块像素还给游戏。';
	...
	@override String get gal_mining_image_mode_video_clip => '视频片段';
	@override String get gal_mining_image_mode_video_clip_hint => '从台词出现到制卡这段时间的游戏画面，并混入句子音频。未开始录制或不足 2 帧时降级为动图/截图。';
	...
	@override String get game_hook_btn_close => '关闭浮窗';
	@override String get game_hook_btn_follow => '跟随新台词';
	@override String get game_hook_btn_lock => '锁定位置';
	@override String get game_hook_btn_passthrough => '鼠标穿透到游戏';
	@override String get game_hook_btn_recapture => '重新录制语音';
	@override String get game_hook_btn_replay => '重播本句语音';
	@override String get game_hook_btn_topmost => '保持置顶';
	@override String get game_hook_btn_transparency => '切换底板';
	@override String get game_hook_btn_workbench => '打开取材工作台';
	@override String get game_hook_code_label => '备注（可选）';
	@override String get game_hook_code_paste_body => '特殊码会绑定到当前运行游戏的可执行文件，下次自动复用。';
	@override String get game_hook_code_paste_hint => '粘贴原始特殊码，例如 /HQN4@4CE90:game.exe';
	@override String get game_hook_code_paste_invalid => '这看起来不是一条特殊码';
	@override String get game_hook_code_paste_saved => '特殊码已保存到当前游戏';
	@override String get game_hook_code_paste_title => '粘贴特殊码';
	...
	@override String get game_hook_mining_no_session_lines => '本局还没有捕获到任何台词，卡片无处挂靠。请在工作台换一条文本线程。';
	...
	@override String get game_hook_reason_capability_probe_failed => '捕获组件没有回应能力探测：文件在，但跑不起来或没在时限内回应。多为杀毒软件拦截、权限不足，或上一局残留的 helper 进程挂住了。请关闭所有游戏、检查杀软隔离区后重试。';
	...
	@override String get game_hook_reason_native_loopback_ack_timeout => '音频采集策略未在超时内确认。文本采集不受影响；若缺少游戏内语音可重试一次。';
	@override String get game_hook_reason_protocol_mismatch => '捕获组件与本体版本不一致。组件内置在 Fushi 里，不用单独安装。先完全关掉游戏再重开一次：游戏进程里可能还挂着上次注入的旧组件。若仍不匹配，说明磁盘上的组件比本体旧（上次更新时游戏正开着，换不掉被占用的文件）——关掉所有游戏，再重跑一次 Fushi 安装程序。';
	@override String get game_hook_reason_ready_timeout => '钩子库未能在超时内加载完成，杀毒软件扫描可能是原因。';
	@override String get game_hook_reason_resident_hook_mismatch => '游戏里还残留上一次的捕获会话，请重启一次游戏。';
	...
	@override String get game_hook_reason_stale_session => '上一次捕获会话还没释放干净，Fushi 正在自动重试，不用做任何操作。';
	...
	@override String get game_japanese_locale_evidence_dir_file_name_chinese_patch => '目录文件名含汉化标记';
	@override String get game_japanese_locale_evidence_dir_file_name_japanese => '目录文件名含假名';
	@override String get game_japanese_locale_evidence_dir_text_gbk => '目录文本为 GBK 编码';
	@override String get game_japanese_locale_evidence_dir_text_shift_jis => '目录文本为 Shift-JIS 编码';
	@override String get game_japanese_locale_evidence_dir_text_simplified_hanzi => '目录文本含简体中文';
	@override String get game_japanese_locale_evidence_exe_shift_jis_strings => '程序内含 Shift-JIS 字符串';
	@override String get game_japanese_locale_evidence_manifest_utf8_code_page => '程序清单声明 UTF-8 代码页';
	@override String get game_japanese_locale_evidence_user_language_japanese => '内容语言设为日语';
	@override String get game_japanese_locale_evidence_user_language_other => '内容语言非日语';
	@override String get game_japanese_locale_evidence_version_info_chinese => '版本资源为中文';
	@override String get game_japanese_locale_evidence_version_info_japanese => '版本资源为日语';
	...
	@override String get game_library_download_queued => '排队中';
	@override String get game_library_download_retrying => '重试中';
	@override String get game_library_downloading => '下载中';
	...
	@override String get game_lookup_attached_align_center => '居中';
	@override String get game_lookup_attached_align_left => '左对齐';
	@override String get game_lookup_attached_align_right => '右对齐';
	@override String get game_lookup_attached_align_top => '顶部';
	@override String get game_lookup_attached_body_rect => '正文框';
	@override String get game_lookup_attached_calibrate => '校准';
	@override String get game_lookup_attached_calibration_commit => '保存校准';
	@override String get game_lookup_attached_calibration_ended => '校准已结束，请关闭此窗口后重新开始。';
	@override String get game_lookup_attached_calibration_failed => '校准未能应用。请确认游戏窗口和台词都正常后再试一次。';
	@override String get game_lookup_attached_calibration_paused => '游戏在后台或已隐藏，校准暂停。用 Alt+Tab 切回游戏，等字框高亮出现后再点击；这里仍可调整和确认。';
	@override String get game_lookup_attached_calibration_preparing => '正在准备点击保护，请先不要点击游戏台词。';
	@override String get game_lookup_attached_calibration_ready => '准备好了。请按顺序点击高亮的字框；点字框外面仍会操作游戏。';
	@override String get game_lookup_attached_calibration_region_help => '在这里调整正文区域，或在校准窗口的截图上拖框。游戏里只会响应高亮字框的点击。';
	@override String get game_lookup_attached_calibration_short_text => '台词至少要有三个字才能校准。';
	@override String get game_lookup_attached_calibration_text_changed => '台词已变化，请取消并重新打开校准，以当前台词重新确认。';
	@override String get game_lookup_attached_calibration_title => '校准正文区域';
	@override String get game_lookup_attached_calibration_unavailable => '校准暂不可用。请停止点击游戏台词，调整参数或取消校准。';
	@override String get game_lookup_attached_font_family => '字体';
	@override String get game_lookup_attached_font_size => '字号 / 客户区高度';
	@override String get game_lookup_attached_height => '高';
	@override String get game_lookup_attached_left => '左';
	@override String get game_lookup_attached_letter_spacing => '字距 / 客户区高度';
	@override String get game_lookup_attached_line_height => '行高';
	@override String get game_lookup_attached_mode => '模式';
	@override String get game_lookup_attached_mode_attached_only => '仅校准层';
	@override String get game_lookup_attached_mode_auto => '自动';
	@override String get game_lookup_attached_mode_native_only => '仅原生几何';
	@override String get game_lookup_attached_mode_off => '关闭';
	@override String get game_lookup_attached_native_status => '原生状态';
	@override String get game_lookup_attached_no_ocr => '不使用 OCR · 仅横排正文';
	@override String get game_lookup_attached_preview => '当前正文预览';
	@override String get game_lookup_attached_probe_end => '最后一个字';
	@override String get game_lookup_attached_probe_middle => '中间的字';
	@override String get game_lookup_attached_probe_start => '第一个字';
	@override String get game_lookup_attached_probe_waiting => '等待在游戏里点击对应的字';
	@override String get game_lookup_attached_probes_hint => '请在游戏里依次点击高亮的第一个、中间和最后一个字，再确认下面的字符。';
	@override String get game_lookup_attached_profile => '校准档案';
	@override String get game_lookup_attached_profile_clear => '清除档案';
	@override String get game_lookup_attached_profile_clear_body => '将删除已保存的正文框、文字布局及该 exe 的点击风险授权。';
	@override String get game_lookup_attached_profile_clear_title => '清除查词档案？';
	@override String get game_lookup_attached_profile_missing => '未校准';
	@override String get game_lookup_attached_profile_ready => '已校准';
	@override String get game_lookup_attached_provider => '几何来源';
	@override String get game_lookup_attached_provider_unknown => '未上报';
	@override String get game_lookup_attached_risk => '点击风险';
	@override String get game_lookup_attached_risk_accept => '确认点击风险';
	@override String get game_lookup_attached_risk_active => '已接受风险 · 可能双触发';
	@override String get game_lookup_attached_risk_body => '当前可执行文件的输入盾尚未验证。点击字形可能同时推进台词或触发选项。授权仅绑定当前 exe 哈希，游戏更新后会自动失效。';
	@override String get game_lookup_attached_risk_pending => '等待确认';
	@override String get game_lookup_attached_risk_safe => '未授权';
	@override String get game_lookup_attached_risk_title => '确认裸左击风险';
	@override String get game_lookup_attached_shield => '输入盾';
	@override String get game_lookup_attached_shield_faulted => '故障';
	@override String get game_lookup_attached_shield_known_uncovered => '已知未覆盖';
	@override String get game_lookup_attached_shield_partial => '部分覆盖';
	@override String get game_lookup_attached_shield_unknown => '未知';
	@override String get game_lookup_attached_shield_verified => '已验证';
	@override String get game_lookup_attached_status => '状态';
	@override String get game_lookup_attached_text_align => '水平对齐';
	@override String get game_lookup_attached_thread_required => '请先选择一个正文线程，再开始校准。';
	@override String get game_lookup_attached_title => '游戏内查词';
	@override String get game_lookup_attached_top => '上';
	@override String get game_lookup_attached_vertical_align => '垂直对齐';
	@override String get game_lookup_attached_width => '宽';
	@override String get game_lookup_samples_advanced => '高级选项';
	@override String get game_lookup_samples_advanced_hint => '手动微调字格';
	@override String get game_lookup_samples_anchor_hint => '先选择一个字，再点击截图中该字的中心。请在线首和行末附近各标一个点。';
	@override String get game_lookup_samples_apply => '应用到游戏';
	@override String get game_lookup_samples_auto_align => '从截图自动对齐';
	@override String get game_lookup_samples_auto_align_all => '用全部校准样本自动对齐';
	@override String get game_lookup_samples_auto_align_current => '按当前截图自动对齐';
	@override String get game_lookup_samples_auto_all_hint => '高级模式会将所有校准样本共同拟合，并用完整样本集检查结果。';
	@override String get game_lookup_samples_auto_character_positions_inconsistent => '生成的字格与识别位置偏差较大，未应用此次结果。';
	@override String get game_lookup_samples_auto_current_hint => '用这张截图测量。最好是两行以上的完整台词，这样才能测出一行放几个字。';
	@override String get game_lookup_samples_auto_failed => '无法可靠测出字格。请换一张两行以上的完整台词截图，并确认橙框框住了全部台词、避开了人名和按钮。原来的结果没有改动。';
	@override String get game_lookup_samples_auto_geometry_out_of_bounds => '测出的字格超出了截图范围。请把橙框调整到台词区域内再试。';
	@override String get game_lookup_samples_auto_geometry_weak => '能识别的字太少，无法确定排版。请换一句字数更多的台词。';
	@override String get game_lookup_samples_auto_grid => '字格已自动测出';
	@override String get game_lookup_samples_auto_hint => '已测出字格。把鼠标移到蓝色小框上，核对它对应的字；对不上就调整橙框，再重新自动对齐。';
	@override String get game_lookup_samples_auto_inconsistent => '样本的换行或字格不一致，无法应用同一套排版。请检查标出的样本是否截到了完整台词。';
	@override String get game_lookup_samples_auto_indent_ambiguous => '无法确定第二行从哪一格开始。请换一句两行以上、第二行较长的台词。';
	@override String get game_lookup_samples_auto_line_spacing_missing => '未能测出可靠行距，请换一张完整的两行或三行台词图。';
	@override String get game_lookup_samples_auto_line_wrap_inconsistent => '按测出的格宽排不出截图里的换行位置。请换一张截图再试。';
	@override String get game_lookup_samples_auto_multiline => '请选择或采集一张完整的两行或三行台词；短句无法确定换行位置。';
	@override String get game_lookup_samples_auto_pending => '还没有自动对齐。用橙框框住台词文字（避开人名和按钮），再点「按当前截图自动对齐」。';
	@override String get game_lookup_samples_auto_preview_failed => '自动测量结果未能通过完整台词校验，未应用此次结果。';
	@override String get game_lookup_samples_auto_preview_text_overflow => '测出的字格超出了橙框。请把橙框放大一些再试。';
	@override String get game_lookup_samples_auto_preview_unavailable => '排版预览暂时不可用，请稍后再试。';
	...
	@override String get game_lookup_samples_auto_text_alignment_failed => '截图里识别到的字和获取到的台词对不上。请确认截图停在完整显示的当前台词上。';
	@override String get game_lookup_samples_auto_text_alignment_weak => '截图里识别到的字和获取到的台词只有部分对得上，结果可能不准。';
	@override String get game_lookup_samples_auto_unsupported => '这张截图里有暂时无法测量宽度的字符。请换一句台词，或用「手动微调字格」。';
	@override String get game_lookup_samples_boxes => '显示点击区域';
	@override String get game_lookup_samples_busy => '处理中…';
	@override String get game_lookup_samples_capture => '采集当前台词';
	@override String get game_lookup_samples_capture_changed => '采集时台词或窗口发生变化。请停在完整台词上，再采集一次。';
	@override String get game_lookup_samples_capture_failed => '未能采集样本。请重试；若仍失败，保留当前窗口并反馈此提示。';
	@override String get game_lookup_samples_capture_overlay => '未能安全隐藏或恢复查词层。请关闭校准窗口并重新附着后再采集。';
	@override String get game_lookup_samples_capture_replace => '替换当前样本';
	@override String get game_lookup_samples_capture_source => '还没有获取到台词。请确认游戏已附着，并在台词工作台选好正文线程。';
	@override String get game_lookup_samples_capture_surface_mapping => '游戏窗口与超分画面的位置暂时无法对应，无法采集校准截图。';
	@override String get game_lookup_samples_capture_surface_not_ready => '查词层正在切换状态，暂时不能采集。请等一两秒再试；如果一直失败，请重新附着游戏。';
	@override String get game_lookup_samples_capture_unavailable => '未能采集这个窗口。已保存的校准不受影响；采集失败原因已记录到日志，便于排查。';
	@override String get game_lookup_samples_capture_unsupported => '当前文本包含暂不支持的注音格式，请换一条普通台词采集。';
	@override String get game_lookup_samples_capture_window => '未能取得完整的游戏画面。请确认游戏窗口未最小化，再采集一次。';
	@override String get game_lookup_samples_clear_anchors => '清除标记点';
	@override String get game_lookup_samples_continuation_cells => '格';
	@override String get game_lookup_samples_continuation_hint => '第二行起比第一行向右（正数）或向左（负数）偏移几格；0 表示和第一行对齐。';
	...
	@override String get game_lookup_samples_few_points => '校准点较少，微小标记误差也会影响结果。建议在多句样本上补充分散标记后再判断精度。';
	@override String get game_lookup_samples_fit => '按标记点对齐';
	@override String get game_lookup_samples_fit_all => '将所有校准样本共同拟合';
	@override String get game_lookup_samples_fit_all_hint => '多张完整台词共用同一字格时使用；完整样本集会一起检查。';
	@override String get game_lookup_samples_fit_failed => '标记点无法匹配同一套排版，请检查标记或调整字体和换行。';
	...
	@override String get game_lookup_samples_grid_advance => '格宽';
	...
	@override String get game_lookup_samples_grid_edit_hint => '拖动蓝框内部可以整体移动，拖动四角可以缩放；拖动任意小格的右边缘可以统一调整格宽。';
	@override String get game_lookup_samples_grid_end => '修正字格终点';
	@override String get game_lookup_samples_grid_height => '调整格高';
	@override String get game_lookup_samples_grid_line_spacing => '调整行距';
	@override String get game_lookup_samples_grid_line_width => '按整数调整每行格数';
	@override String get game_lookup_samples_grid_move => '移动字格';
	@override String get game_lookup_samples_grid_start => '修正字格起点';
	@override String get game_lookup_samples_hint => '等台词完整显示后再采集。尽量选一句两行以上的台词，自动对齐会更准。';
	@override String get game_lookup_samples_hover => '把鼠标移到框上，检查它对应的字。';
	@override String get game_lookup_samples_layout_title => '文字排版（蓝色字框）';
	@override String get game_lookup_samples_limit => '最多保留八个样本，请先删除一个再采集。';
	@override String get game_lookup_samples_load_failed => '无法读取已保存的样本草稿。';
	@override String get game_lookup_samples_manual_layout => '手动微调字格';
	@override String get game_lookup_samples_measured => '已标记样本';
	@override String get game_lookup_samples_narration => '旁白校准';
	@override String get game_lookup_samples_narration_hint => '旁白和对话排版一样时，只校准对话就够了；不一样时再单独校准旁白。';
	@override String get game_lookup_samples_native_fallback_hint => '这款游戏现在由引擎直接提供字的位置，查词不需要校准。这里做的校准会作为备用，只在引擎位置不可用时使用。';
	@override String get game_lookup_samples_native_hint => '方框表示实际用于选字的区域。调整排版，让它们覆盖原文对应的字。';
	@override String get game_lookup_samples_nudge_down => '向下微调1个截图像素';
	@override String get game_lookup_samples_nudge_left => '向左微调1个截图像素';
	@override String get game_lookup_samples_nudge_right => '向右微调1个截图像素';
	@override String get game_lookup_samples_nudge_up => '向上微调1个截图像素';
	@override String get game_lookup_samples_pan_mode => '浏览图片';
	@override String get game_lookup_samples_pixel_advanced_hint => '这些数值是橙色识别框在原始截图中的像素位置，是手动备用定位，不是字的字号。';
	@override String get game_lookup_samples_pixel_hint => '数值使用截图像素，可输入后按回车，或用减号、加号微调。';
	@override String get game_lookup_samples_point_mode => '标记文字';
	...
	@override String get game_lookup_samples_region_hint => '拖动橙框内部可以移动，拖动四角可以缩放。';
	@override String get game_lookup_samples_region_mode => '拖动外框';
	@override String get game_lookup_samples_region_title => '台词区域（橙色外框）';
	@override String get game_lookup_samples_remove => '删除样本';
	@override String get game_lookup_samples_residual => '标记点偏差';
	@override String get game_lookup_samples_residual_hint => '此数值是与人工标记点的偏差，不代表游戏真实字形精度。';
	@override String get game_lookup_samples_save => '保存草稿';
	@override String get game_lookup_samples_save_failed => '自动保存失败，当前样本仍保留在本窗口；请重试。';
	@override String get game_lookup_samples_saved => '已自动保存到本机';
	@override String get game_lookup_samples_saved_hint => '样本和截图会自动保存在本机，关闭窗口后也不会丢失。';
	@override String get game_lookup_samples_search_hint => '框住整个台词文字区域，避开人名和按钮；框稍大一些没关系。程序只在框内找字，改动框后需要重新自动对齐。';
	@override String get game_lookup_samples_search_title => '识别范围（橙色外框）';
	@override String get game_lookup_samples_special_chars_add => '添加特殊字符';
	@override String get game_lookup_samples_special_chars_hint => '为占用较窄或较宽格子的标点单独设置格宽；未添加的字符仍使用普通格宽。';
	@override String get game_lookup_samples_special_chars_input => '输入特殊字符';
	@override String get game_lookup_samples_special_chars_input_hint => '可一次输入多个字符，例如 、。';
	@override String get game_lookup_samples_special_chars_remove => '移除特殊字符';
	@override String get game_lookup_samples_special_chars_title => '特殊字符格宽';
	@override String get game_lookup_samples_title => '多句样本校准';
	@override String get game_lookup_samples_unavailable => '当前排版容不下完整台词，请调整区域或字号。';
	@override String get game_lookup_samples_validation => '用于验证';
	@override String get game_lookup_samples_validation_hint => '验证样本的标记只用于检查，不参与自动对齐。';
	@override String get game_lookup_samples_zoom_in => '放大截图';
	@override String get game_lookup_samples_zoom_out => '缩小截图';
	@override String get game_lookup_samples_zoom_reset => '显示完整截图';
	...
	@override String get game_session_japanese_locale => '已转区';
	@override String game_session_japanese_locale_evidence({required Object evidence}) => '判据：${evidence}';
	@override String get game_session_japanese_locale_evidence_insufficient => '证据不足';
	@override String get game_session_japanese_locale_hint => '本局以日文区域 (CP932) 启动。若游戏文字乱码或脚本报错，可把该游戏的日语区域改为「永不转区」。';
	@override String get game_session_japanese_locale_skipped => '未转区';
	@override String game_session_japanese_locale_skipped_hint({required Object evidence}) => '本局未转区（自动判定：${evidence}）。若游戏文字乱码，可把该游戏的日语区域改为「始终开启」。';
	@override String get game_session_japanese_locale_skipped_hint_not_32bit => '本局未转区：自动判定需要日文区域，但 Locale Emulator 只支持 32 位游戏。';
	@override String get game_session_japanese_locale_skipped_hint_system_japanese => '本局未转区：系统本就是日文区域 (CP932)，无需转区。';
	...
	@override String get game_stream_active_sessions => '正在串流';
	@override String get game_stream_android_only => '游戏串流接收端仅支持 Android。';
	@override String get game_stream_audio_mute => '静音游戏声音';
	@override String get game_stream_audio_unmute => '播放游戏声音';
	@override String get game_stream_available => '可加入游戏串流';
	@override String get game_stream_busy => '正在更新串流…';
	@override String get game_stream_connected => '当前连接设备';
	@override String get game_stream_controls_toggle => '显示或隐藏手柄';
	@override String get game_stream_disconnected => '串流连接中断';
	@override String get game_stream_failed => '串流操作失败';
	@override String get game_stream_hook_required => '请先启动一个已连接 Hook 的游戏';
	@override String get game_stream_host_connecting => '正在连接…';
	@override String get game_stream_host_launch_off => '这台主机未开启远程启动，仍可加入电脑上已开始的串流。';
	@override String game_stream_host_online({required Object n}) => '在线 · ${n} 款游戏';
	@override String get game_stream_host_outdated => '主机版本过旧，没有游戏库。请更新 Windows 端 Fushi。';
	@override String get game_stream_host_rejected => '主机拒绝了请求';
	@override String get game_stream_input_failed => '输入未送达';
	@override String get game_stream_input_pointer_unsupported => '该游戏不接受触控点击，请使用手柄按键';
	@override String get game_stream_input_rejected => '输入未送达。请在主机将游戏窗口切换到前台。';
	@override String get game_stream_input_window_hidden => '主机上的游戏窗口已最小化或隐藏';
	@override String get game_stream_join => '加入游戏串流';
	@override String get game_stream_join_action => '加入';
	@override String get game_stream_join_failed => '无法加入串流';
	@override String get game_stream_key_default => '默认';
	@override String get game_stream_keyboard => '键盘';
	@override String get game_stream_keys => '配置手柄按键';
	@override String get game_stream_keys_hint => '按键映射仅用于本次串流会话。';
	@override String game_stream_last_played({required Object time}) => '${time}游玩';
	@override String get game_stream_launch_busy => '主机正在运行另一款游戏。请先在电脑上关闭它，或加入它的串流。';
	@override String get game_stream_launch_connecting => '正在连接串流…';
	@override String get game_stream_launch_disabled => '这台主机未开启远程启动。请在 Windows 端的「互联」设置里打开「允许远程启动」。';
	@override String get game_stream_launch_exe_missing => '主机上找不到这款游戏的可执行文件。';
	@override String get game_stream_launch_failed => '主机无法启动这款游戏。';
	@override String get game_stream_launch_helper_missing => '主机缺少捕获组件，请在 Windows 端重新安装或更新 Fushi。';
	@override String get game_stream_launch_starting => '正在启动游戏…';
	@override String get game_stream_launch_stream_failed => '游戏已运行，但主机无法开始串流。';
	@override String get game_stream_launch_superseded => '此次启动已被另一次启动取代。';
	@override String get game_stream_launch_timeout => '主机未能在限定时间内完成启动。';
	@override String get game_stream_launch_unknown_game => '这款游戏已不在主机游戏库中，请刷新后重试。';
	@override String get game_stream_launch_waiting_window => '等待游戏窗口…';
	@override String get game_stream_launch_window_missing => '游戏已启动，但游戏窗口没有及时出现。';
	@override String get game_stream_leave_failed => '未能通知主机结束串流';
	@override String get game_stream_library_empty => '主机游戏库是空的，请先在 Windows 端添加游戏。';
	@override String get game_stream_library_subtitle => '在电脑上启动游戏并串流到这里';
	@override String get game_stream_line => '当前台词';
	@override String get game_stream_line_empty => '尚无 Hook 台词';
	@override String get game_stream_lookup_hint => '选中台词或释义中的文字查词';
	@override String get game_stream_lookup_toggle => '展开或收起查词面板';
	@override String get game_stream_mine_audio_fallback_disabled => '这句台词没有对应语音，而主机设置为只用游戏原始语音制卡';
	@override String get game_stream_mine_capture_failed => '主机未能截取这张卡的媒体';
	@override String get game_stream_mine_duplicate => '主机的 Anki 中已有这张卡';
	@override String get game_stream_mine_failed => '主机制卡失败';
	@override String get game_stream_mine_host_error => '主机制卡失败，请检查主机上的 Anki';
	@override String get game_stream_mine_line_expired => '这句台词在主机上已过期，请对当前台词查词';
	@override String get game_stream_mine_snapshot_missing => '主机没有这句台词的画面，请对当前台词查词制卡';
	@override String get game_stream_mine_success => '主机已创建卡片';
	@override String get game_stream_module_hint => '从 Windows 电脑启动并串流游戏';
	@override String get game_stream_more => '更多';
	@override String get game_stream_no_hosts => '还没有配对的 Windows 主机。请先在「互联」设置中与电脑配对。';
	@override String get game_stream_none => '没有已开启串流的已配对主机。请先在 Windows 游戏页开始串流。';
	@override String get game_stream_open_interconnect => '打开互联设置';
	@override String get game_stream_remote_launch_hint => '已配对的安卓设备可从本机游戏库启动游戏并直接串流';
	@override String get game_stream_remote_launch_title => '允许远程启动';
	@override String get game_stream_running => '运行中';
	@override String get game_stream_settings_adaptive => '自适应码率';
	@override String get game_stream_settings_adaptive_hint => '网络拥塞时自动降低码率';
	@override String get game_stream_settings_apply_failed => '未能应用串流设置';
	@override String get game_stream_settings_audio => '播放游戏声音';
	@override String get game_stream_settings_bitrate => '码率';
	@override String get game_stream_settings_capped => '主机当前的采集上限更低，需重新开始串流才能提高';
	@override String get game_stream_settings_codec => '视频编码';
	@override String get game_stream_settings_codec_auto => '自动';
	@override String get game_stream_settings_codec_hint => '下次连接生效；设备不支持时自动回退';
	@override String get game_stream_settings_degradation => '带宽不足时';
	@override String get game_stream_settings_degradation_balanced => '均衡';
	@override String get game_stream_settings_degradation_framerate => '保持帧率';
	@override String get game_stream_settings_degradation_resolution => '保持清晰度';
	@override String get game_stream_settings_fps => '帧率';
	@override String get game_stream_settings_input_background => '仅窗口';
	@override String get game_stream_settings_input_focus => '游戏窗口输入';
	@override String get game_stream_settings_input_focus_hint => '「仅窗口」时游戏可留在后台。部分引擎在后台不接收输入，触控无效时改为「切到前台」。';
	@override String get game_stream_settings_input_foreground => '切到前台';
	@override String get game_stream_settings_reset => '推荐值';
	@override String get game_stream_settings_resolution => '分辨率上限';
	@override String get game_stream_settings_resolution_hint => '不会超过主机窗口尺寸放大';
	@override String get game_stream_settings_save => '保存';
	@override String get game_stream_settings_title => '串流设置';
	@override String get game_stream_start => '开始串流';
	@override String get game_stream_stats_codec_fallback => '首选编码不可用，已使用默认编码';
	@override String get game_stream_stats_dropped => '丢帧';
	@override String get game_stream_stats_hide => '隐藏性能统计';
	@override String get game_stream_stats_loss => '丢包';
	@override String get game_stream_stats_show => '显示性能统计';
	@override String get game_stream_stats_target => '目标';
	@override String get game_stream_stop => '停止串流';
	@override String get game_stream_touch_direct => '切换为直接点击';
	@override String get game_stream_touch_trackpad => '切换为触控板';
	@override String get game_stream_unreachable => '无法连接主机';
	@override String get game_stream_video_waiting => '正在等待游戏画面';
	@override String get game_stream_waiting => '串流已开启，等待已配对设备加入';
	...
	@override String get game_text_process_add_step => '添加步骤';
	@override String game_text_process_ai_added({required Object count}) => '已添加 ${count} 个步骤';
	@override String get game_text_process_ai_empty => 'AI 没有给出可用的规则，换个说法再试一次。';
	@override String game_text_process_ai_failed({required Object reason}) => '生成失败：${reason}';
	@override String get game_text_process_ai_generate => '生成';
	@override String get game_text_process_ai_hint => '描述你想清洗掉什么';
	@override String get game_text_process_ai_no_provider => '请先在「设置 › AI」里指定一家提供商';
	@override String get game_text_process_ai_section => '让 AI 生成';
	@override String get game_text_process_empty => '还没有任何步骤。可在下方添加，或让 AI 生成。';
	@override String get game_text_process_fold_warning => '自动去重会打断渐进重绘折叠，同一句可能在工作台留下多条';
	@override String get game_text_process_kind_dedupe_ascending => '去除逐字重绘';
	@override String get game_text_process_kind_dedupe_ascending_desc => 'AABABCABCD → ABCD';
	@override String get game_text_process_kind_dedupe_block_fixed => '去除整块重复';
	@override String get game_text_process_kind_dedupe_block_fixed_desc => 'ABCDABCDABCD → ABCD';
	@override String get game_text_process_kind_dedupe_chars => '去除重复字符';
	@override String get game_text_process_kind_dedupe_chars_desc => 'AAAABBBBCCCC → ABC';
	@override String get game_text_process_kind_dedupe_descending => '去除递减重绘';
	@override String get game_text_process_kind_dedupe_descending_desc => 'ABCDBCDCDD → ABCD';
	@override String get game_text_process_kind_dedupe_lines_auto => '去除重复行';
	@override String get game_text_process_kind_dedupe_lines_auto_desc => 'S1S1S1S2S2S2 → S1S2';
	@override String get game_text_process_kind_filter_ascii_punctuation => '过滤英文标点';
	@override String get game_text_process_kind_filter_ascii_punctuation_desc => '移除半角标点';
	@override String get game_text_process_kind_filter_control_chars => '过滤控制字符';
	@override String get game_text_process_kind_filter_control_chars_desc => '移除 ASCII 控制符；换行与制表符不动';
	@override String get game_text_process_kind_filter_digits => '过滤数字';
	@override String get game_text_process_kind_filter_digits_desc => '移除半角与全角数字';
	@override String get game_text_process_kind_filter_latin_letters => '过滤英文字母';
	@override String get game_text_process_kind_filter_latin_letters_desc => '移除半角与全角英文字母';
	@override String get game_text_process_kind_filter_line_breaks => '过滤换行符';
	@override String get game_text_process_kind_filter_line_breaks_desc => '删除换行，或替换成指定内容';
	@override String get game_text_process_kind_filter_non_japanese => '过滤非日语字符集字符';
	@override String get game_text_process_kind_filter_non_japanese_desc => '移除无法用 Shift-JIS 表示的字符';
	@override String get game_text_process_kind_keep_japanese_quotes => '只保留「」内的文本';
	@override String get game_text_process_kind_keep_japanese_quotes_desc => '只留台词、丢掉旁白；没有「」的整行会被丢弃';
	@override String get game_text_process_kind_normalize_width => '全角半角正规化';
	@override String get game_text_process_kind_normalize_width_desc => '全角 ASCII 转半角，半角片假名转全角';
	@override String get game_text_process_kind_replace => '字符串替换';
	@override String get game_text_process_kind_replace_desc => '自定义正则或字面替换';
	@override String get game_text_process_kind_strip_angle_brackets => '过滤尖括号标记';
	@override String get game_text_process_kind_strip_angle_brackets_desc => '移除 ruby、br 之类的标记';
	@override String get game_text_process_kind_strip_curly_braces => '去除花括号注音';
	@override String get game_text_process_kind_strip_curly_braces_desc => '带斜杠的花括号保留基字；不带斜杠的整体删除';
	@override String get game_text_process_kind_take_lines => '截取指定行数';
	@override String get game_text_process_kind_take_lines_desc => '只保留开头或末尾的 N 行';
	@override String get game_text_process_param_from_end => '从末尾截取';
	@override String get game_text_process_param_line_replacement => '换行替换为';
	@override String get game_text_process_param_lines => '行数';
	@override String get game_text_process_param_pattern => '匹配式';
	@override String get game_text_process_param_pattern_invalid => '正则表达式无效';
	@override String get game_text_process_param_regex => '按正则表达式';
	@override String get game_text_process_param_repeat => '重复次数';
	@override String get game_text_process_param_repeat_auto => '自动分析';
	@override String get game_text_process_param_replacement => '替换为';
	@override String get game_text_process_preview => '预览';
	@override String get game_text_process_preview_emptied => '这一步会把整行清空，该行将被丢弃';
	@override String get game_text_process_preview_input => '样例文本';
	@override String get game_text_process_preview_input_hint => '粘贴一行抓到的文本';
	@override String get game_text_process_preview_result => '结果';
	@override String get game_text_process_preview_step_unchanged => '未改变';
	@override String get game_text_process_preview_unchanged => '无变化';
	@override String get game_text_process_preview_use_latest => '使用最近抓到的一行';
	@override String get game_text_process_ruby_warning => '这一步会删掉注音标记，相应的行将没有振假名';
	@override String game_text_process_step_count({required Object count}) => '已启用 ${count} 个步骤';
	@override String get game_text_process_summary => '对所选线程的文本做清洗';
	@override String get game_text_process_title => '文本处理';
	...
	@override String get game_text_thread_artifact_hint => '逐字重复伪影线程，不会有可用台词';
	@override String game_text_thread_audio_count({required Object count}) => '${count} 行有音频';
	@override String get game_text_thread_hint => '选择干净的台词线程';
	...
	@override String get game_track_exclusion_hint => '把 BGM/环境音轨标记为排除，自动选源便不会把它当成语音。';
	...
	@override String get global_context_capture_hint => '从前台应用读取选区周围文本，在查词弹窗显示当前句（Windows / macOS）';
	...
	@override String get handlebar_clip_timestamp => '片段时间';
	...
	@override String get handlebar_source_link => '来源链接';
	...
	@override String get import_step_importing_book => '导入书籍…';
	...
	@override String get interconnect_backup_backend_active => '备份已写到 Fushi 互联服务端。要换回云盘，去「同步与备份」里改后端。';
	...
	@override String get interconnect_backup_backend_hint => '备份与同步写到 Fushi 互联服务端，而不是云盘。写过去的内容由上面「上传到互联对端」的几个开关决定。';
	@override String get interconnect_backup_backend_needs_pairing => '请先在上面连接一台设备。';
	@override String get interconnect_devices_hint => '对端地址、配对与 LAN 发现';
	@override String get interconnect_devices_page => '配对与设备';
	@override String interconnect_devices_paired_count({required Object n}) => '已配对 ${n} 台';
	...
	@override String get interconnect_host_hint => '端口、TLS、访问令牌与已配对设备';
	@override String get interconnect_host_off => '未开启';
	@override String get interconnect_host_page => '主机服务';
	@override String interconnect_host_running({required Object port}) => '运行中 · 端口 ${port}';
	...
	@override String get interconnect_profile_download => '从对端下载配置';
	@override String get interconnect_profile_download_desc => '把对端当前配置作为一份新配置导入本机，不动你正在用的那份。';
	@override String interconnect_profile_downloaded({required Object name}) => '配置已导入：${name}';
	@override String interconnect_profile_failed({required Object message}) => '配置传输失败：${message}';
	@override String get interconnect_profile_host_toggle => '允许已配对设备读写本机配置';
	@override String get interconnect_profile_host_toggle_desc => '默认关闭。需要 HTTPS 与已配对设备令牌；收到的配置一律作为新配置追加，不覆盖现有配置。';
	@override String get interconnect_profile_section => '配置文件';
	@override String get interconnect_profile_unsupported => '对端不提供配置传输（需要 HTTPS 且对端版本较新）。';
	@override String get interconnect_profile_upload => '上传配置到对端';
	@override String get interconnect_profile_upload_desc => '把本机当前配置发给已配对的对端，在那边落成一份新配置。';
	@override String interconnect_profile_uploaded({required Object name}) => '配置已上传：${name}';
	@override String get interconnect_related_entry => '远端查词、音频源与远端条目';
	@override String get interconnect_related_entry_hint => '在「查词」与「同步」分类里设置';
	@override String get interconnect_section_client => '连接到其他设备';
	@override String get interconnect_section_delegate => '交给 Fushi 互联服务端';
	@override String get interconnect_section_related => '远端内容与查词';
	@override String get interconnect_share_favorites => '共享收藏夹';
	@override String get interconnect_share_favorites_hint => '收藏的词与句子，取消收藏也会同步';
	@override String get interconnect_share_section => '与已配对设备共享';
	@override String get interconnect_share_section_footer => '这些内容与已配对设备双向合并，默认开启。关掉后本设备既不再发送，也不再接收。';
	@override String get interconnect_share_statistics => '共享统计';
	@override String get interconnect_share_statistics_hint => '阅读与观看时长、字数、查词与制卡计数';
	@override String get interconnect_summary => '设备间直连同步与本机作为服务器';
	@override String get interconnect_transcode_host_toggle => '为对端转码视频';
	@override String get interconnect_transcode_host_toggle_desc => '配对设备在弱网下播放本机视频时，实时转码成更低码率。需要 ffmpeg，会占用本机 CPU。';
	...
	@override String get jellyfin_auto_list_hint => '关闭后：进入视频页不向媒体服务器发任何请求，需在视频库下拉刷新手动列出。超大服务器建议关闭——自动枚举看起来像刮削，可能触发服务器的滥用检测。';
	@override String get jellyfin_auto_list_title => '进入视频页时自动列出条目';
	@override String get jellyfin_host_lookup_hint => '本机无法解析这个主机名。Android / iOS 不能解析 .local 或 Windows 计算机名，请改用服务器的 IP 地址（例如 http://192.168.1.10:8096）。';
	@override String get jellyfin_libraries_hint => '不选 = 列出全部视频媒体库。只勾你真正会看的库，超大服务器就不会被整台枚举。';
	@override String get jellyfin_libraries_load_failed => '读取媒体库清单失败';
	@override String get jellyfin_libraries_title => '要列出的媒体库';
	@override String get jellyfin_route_active_label => '使用中';
	@override String get jellyfin_route_add => '添加线路';
	@override String get jellyfin_route_add_failed => '添加线路失败';
	@override String get jellyfin_route_exists => '这条线路已经在列表里';
	@override String get jellyfin_route_primary_label => '登录地址';
	@override String get jellyfin_route_remove => '删除线路';
	@override String jellyfin_route_switched({required Object url}) => '已切换到 ${url}';
	@override String get jellyfin_route_url => '线路地址';
	@override String jellyfin_route_verify_failed({required Object url, required Object reason}) => '${url} 上的服务器不接受当前登录，可能不是同一台服务器，或登录已过期：${reason}';
	@override String get jellyfin_routes_hint => '为这台服务器添加其它访问地址（局域网 / 公网 / 反代），随时切换；登录状态在每条线路上通用。';
	@override String get jellyfin_routes_title => '线路';
	@override String jellyfin_server_unreachable({required Object url, required Object reason}) => '无法连接服务器 ${url}：${reason}';
	@override String get jellyfin_server_url => '服务器地址';
	@override String get jellyfin_servers_add_title => '添加服务器';
	@override String get jellyfin_servers_empty_hint => '尚未登录任何服务器';
	@override String get jellyfin_servers_signed_in_title => '已登录的服务器';
	@override String get jellyfin_settings_hint => '服务器上的视频会出现在媒体库中，点击直接串流播放。';
	@override String get jellyfin_settings_title => '媒体服务器（Jellyfin / Emby）';
	@override String get jellyfin_show_in_library_hint => '把媒体服务器条目混排进首页、系列与全部视频。关闭后只在「媒体服务器」分区浏览。';
	@override String get jellyfin_show_in_library_title => '在视频库中混排显示';
	@override String get jellyfin_sign_in => '登录';
	@override String get jellyfin_sign_in_failed => '登录失败';
	@override String get jellyfin_sign_out => '退出登录';
	...
	@override String get lapis_style_ai_applied => 'AI 建议已填入编辑器，看过预览再应用。';
	@override String get lapis_style_ai_hint => '描述卡片想要的样子，例如：例句放大、隐藏频率';
	@override String get library_empty_go_import => '去导入';
	@override String get library_search => '搜索库';
	@override String get library_view_browse => '发现';
	@override String get library_view_discover => '发现';
	...
	@override String get local_audio_file_reselect => '重新选择发音库';
	@override String get local_audio_file_unavailable => '发音库文件不可用，请重新选择原始 DB 文件。';
	...
	@override String get local_audio_reference_unavailable => '所选文件是临时副本，已改为导入持久副本。';
	...
	@override String get lookup_accessibility_permission_granted => '已授权辅助功能';
	@override String get lookup_accessibility_permission_hint => 'macOS 需要辅助功能权限才能读取其他应用中选中的文字；未授权时快捷键只查当前剪贴板文本。';
	@override String get lookup_accessibility_permission_missing => '尚未授权辅助功能。请在「隐私与安全性 > 辅助功能」中启用 Fushi 后重试。';
	@override String get lookup_accessibility_permission_request => '为应用外查词授权辅助功能';
	@override String get lookup_audio_volume => '查词音量';
	@override String get lookup_block_capture => '防截屏 / 防录屏';
	@override String get lookup_block_capture_hint => '把查词悬浮窗从截图、录屏、直播串流中排除（Windows / macOS）。关闭后，截图、录屏和串流即可拍到查词悬浮窗。';
	@override String get lookup_hover_leave_resume => '离开查词即继续播放';
	@override String get lookup_hover_leave_resume_hint => '悬停查词后，鼠标离开字幕与查词窗即自动关闭查词窗并继续播放，不必再点一下';
	...
	@override String get manga_background => '背景色';
	@override String get manga_background_black => '黑';
	@override String get manga_background_gray => '灰';
	@override String get manga_background_theme => '跟随主题';
	@override String get manga_background_white => '白';
	@override String get manga_chapter_download_action => '下载';
	@override String get manga_chapter_download_delete_action => '删除下载';
	@override String get manga_chapter_download_queued => '已加入下载队列';
	@override String get manga_chapter_download_retry_action => '重试下载';
	@override String get manga_chapter_download_status_downloaded => '已下载';
	@override String manga_chapter_download_status_downloading({required Object done, required Object total}) => '下载中 ${done}/${total}';
	@override String get manga_chapter_download_status_failed => '下载失败';
	@override String get manga_chapter_download_status_queued => '排队中';
	@override String get manga_chapter_locked_download_anyway => '仍然下载';
	@override String get manga_chapter_locked_hint => '源站要求登录并购买或租借后才能下载本章。';
	@override String get manga_chapter_locked_login_unsupported_hint => '本章需在源站购买或租借；这类作品暂不支持在应用内登录解锁。';
	@override String get manga_chapter_locked_title => '章节已锁定';
	@override String get manga_chapter_not_downloaded => '本章尚未下载';
	@override String get manga_chapter_ocr_action => '识别本章';
	@override String get manga_chapter_ocr_status_queued => '等待识别';
	@override String manga_chapter_ocr_status_running({required Object done, required Object total}) => '识别中 ${done}/${total}';
	@override String get manga_chapter_transition => '进入下一章';
	@override String get manga_chrome_floating => '悬浮工具栏';
	@override String get manga_chrome_floating_subtitle => '工具栏收起不遮挡页面，点页面中央或鼠标移到顶边唤出；关闭则常驻在页面上方';
	@override String get manga_cover_cache_max_age => '封面缓存保留时长';
	@override String get manga_cover_cache_max_age_subtitle => '在线源封面超过此天数后重新下载';
	...
	@override String get manga_discovery_load_failed => '发现内容加载失败。';
	@override String get manga_discovery_match_none => '已启用来源中未找到匹配。';
	@override String get manga_discovery_match_running => '正在已启用来源中匹配…';
	@override String get manga_discovery_match_section => '来源匹配';
	@override String get manga_discovery_section_latest_finished => '最新完结';
	@override String get manga_discovery_section_popular => '热门';
	@override String get manga_discovery_section_publishing => '连载热门';
	@override String get manga_discovery_section_top_rated => '高分';
	@override String manga_discovery_source_popular({required Object source}) => '${source} · 热门';
	@override String get manga_discovery_sources_browse => '浏览来源';
	@override String get manga_discovery_status_cancelled => '已腰斩';
	@override String get manga_discovery_status_finished => '已完结';
	@override String get manga_discovery_status_hiatus => '休刊中';
	@override String get manga_discovery_status_not_yet_released => '未发售';
	@override String get manga_discovery_status_releasing => '连载中';
	@override String get manga_global_search_hint => '搜索所有已启用来源';
	@override String get manga_global_search_no_sources => '还没有已启用的漫画来源，去「导入」添加一个。';
	@override String get manga_global_search_open_sources => '去导入';
	...
	@override String get manga_import_folder_as_source_hint => '以后自动扫描此文件夹里的新漫画';
	@override String get manga_import_hint => '选择漫画文件夹、.cbz/.zip 页图压缩包、.pdf，或 .mokuro 文件。';
	...
	@override String get manga_interface_hide => '隐藏界面';
	@override String get manga_interface_show => '显示界面';
	...
	@override String get manga_ocr_baberu_desc => '含横排文字模型约 284 MB。在 Windows 上自动使用 GPU 图像编码与 CPU 文字解码，不可用时使用 CPU。部分名字和手写文字可能更不准确。对新启动的 OCR 任务生效。';
	@override String get manga_ocr_baberu_model => 'Baberu（快速，可用时使用 GPU）';
	@override String get manga_ocr_boxes_toggle => '显示识别范围';
	@override String get manga_ocr_cuda_desc => '原版 manga-ocr，使用 GPU 批量识别。需要 NVIDIA 显卡；首次下载约 4 GB，应用自动安装独立的 Python 和 CUDA 运行库。';
	@override String get manga_ocr_cuda_model => 'manga-ocr（NVIDIA GPU 加速）';
	...
	@override String manga_ocr_delete_done_freed({required Object size}) => '模型已删除，释放 ${size}';
	...
	@override String get manga_ocr_download_resume => '继续下载';
	...
	@override String get manga_ocr_engine_auto_desc => '优先用你已配好的离线引擎，不会自作主张上传到 Lens。';
	@override String get manga_ocr_engine_builtin => '内置';
	@override String get manga_ocr_engine_external => '外部 mokuro';
	@override String get manga_ocr_engine_external_desc => '调用你自己安装的 mokuro 命令行，仅桌面可用。';
	@override String get manga_ocr_engine_google_lens => 'Google Lens';
	@override String get manga_ocr_engine_google_lens_desc => '需要联网，会把页面图片上传给 Google。速度快、不用下模型，但质量不如本地模型。';
	@override String get manga_ocr_engine_local_onnx => '本地 ONNX';
	@override String get manga_ocr_engine_local_onnx_desc => '完全离线。首次使用需下载所选模型，速度和准确度取决于模型与硬件。';
	@override String get manga_ocr_engine_none => '没有可用的 OCR 引擎。请在设置中下载内置模型或配置 mokuro 命令行路径。';
	@override String get manga_ocr_engine_paired_host_desc => '交给已配对的 Fushi 互联服务端来跑，本机不下任何模型。';
	@override String get manga_ocr_engine_system => '设备自带';
	@override String get manga_ocr_engine_system_desc => '用设备自带的文字识别。不用下载、完全离线、不上传任何内容；但对竖排气泡和手写体明显不如本地模型。';
	@override String get manga_ocr_engine_system_unavailable => '此设备没有可用的系统文字识别';
	...
	@override String get manga_ocr_import => '导入本地模型';
	@override String get manga_ocr_import_copy_urls => '复制下载链接';
	@override String manga_ocr_import_done({required Object count}) => '已导入 ${count} 个文件';
	@override String get manga_ocr_import_failed => '模型导入失败';
	@override String get manga_ocr_import_intro => '如果应用内下载不通，可以自行下载下面的文件后从这里导入；也支持包含这些文件的 zip 包。';
	@override String get manga_ocr_import_matched_nothing => '没有认出可用的模型文件';
	@override String get manga_ocr_import_pick_files => '选择文件';
	@override String get manga_ocr_import_pick_folder => '选择文件夹';
	@override String get manga_ocr_import_running => '正在导入…';
	@override String manga_ocr_import_size_mismatch({required Object file, required Object expected, required Object actual}) => '${file} 大小不对：应为 ${expected}，实为 ${actual}';
	@override String manga_ocr_import_still_missing({required Object count}) => '还缺 ${count} 个文件';
	@override String get manga_ocr_import_title => '导入已下载的模型';
	@override String get manga_ocr_import_urls_copied => '下载链接已复制';
	@override String get manga_ocr_lens_language_label => '识别语言';
	@override String get manga_ocr_local_model => '本机 OCR 模型';
	@override String get manga_ocr_manga_model => 'manga-ocr（经典）';
	@override String get manga_ocr_manga_model_desc => '日文漫画模型，配合横排文字识别。在 Windows 上使用 CPU。';
	@override String get manga_ocr_mobile_note => '移动端下载的模型供漫画阅读页的本地引擎使用：整卷、点击、框选区域识别都走它。';
	@override String manga_ocr_model_disk_usage({required Object size}) => '已占用 ${size}';
	@override String manga_ocr_model_download_size({required Object size}) => '需下载 ${size}';
	@override String get manga_ocr_model_status_missing => 'OCR 模型未下载';
	@override String get manga_ocr_model_status_ready => 'OCR 模型已就绪';
	@override String get manga_ocr_model_unused_by_engine => '当前引擎用不到这些本地模型文件。';
	@override String get manga_ocr_parallel_auto => '自动（1–2 个任务）';
	@override String get manga_ocr_parallel_tasks => '并行 OCR 任务';
	@override String get manga_ocr_parallel_tasks_desc => '同时识别不同书籍，同一本书的章节按顺序处理。数量越大占用内存越多；低内存模式下最多运行一个任务。';
	@override String get manga_ocr_runtime_installing => '正在安装本地 OCR 引擎…';
	@override String get manga_ocr_section => '漫画 OCR';
	@override String get manga_ocr_section_summary => '内置 OCR 模型与外部 mokuro 命令行';
	@override String get manga_ocr_settings_open => 'OCR 设置';
	...
	@override String get manga_online_detail_load_failed => '无法载入这部漫画。';
	@override String get manga_online_download_all => '下载全部';
	@override String get manga_online_download_selected => '下载所选';
	@override String get manga_online_downloaded => '已入库';
	@override String get manga_online_error_view_detail => '查看详情';
	...
	@override String get manga_online_select_all => '全选';
	@override String get manga_online_series_empty => '这个系列没有可下载的卷。';
	...
	@override String get manga_page_actions => '页面操作';
	...
	@override String get manga_page_copy => '复制图片';
	@override String manga_page_number_hint({required Object total}) => '页码（1-${total}）';
	@override String get manga_page_save => '保存图片';
	@override String get manga_page_set_cover => '设为封面';
	@override String get manga_page_share => '分享图片';
	@override String get manga_panel_detect_failed => '分镜检测失败';
	@override String manga_panel_index({required Object index}) => '分镜 ${index}';
	@override String get manga_panel_model => 'AI 分镜模型';
	@override String get manga_panel_model_delete => '删除模型';
	@override String get manga_panel_model_desc => '下载、校验或删除分镜检测模型';
	@override String get manga_panel_model_download => '下载';
	@override String manga_panel_model_download_failed({required Object error}) => '分镜模型下载失败：${error}';
	@override String get manga_panel_model_downloading => '下载中';
	@override String manga_panel_model_downloading_bytes({required Object bytes}) => '下载中 ${bytes} 字节';
	@override String get manga_panel_model_missing => '未下载';
	@override String get manga_panel_model_ready => '已就绪';
	@override String get manga_panel_model_unavailable => '分镜模型不可用';
	@override String get manga_panel_navigation => 'AI 分镜逐格导航';
	@override String get manga_panel_navigation_subtitle => '翻页前先聚焦检测到的分镜';
	@override String get manga_panel_none => '未检测到分镜';
	@override String get manga_previous_page => '上一页';
	@override String get manga_reader_animate_transitions => '翻页动画';
	@override String get manga_reader_auto_scroll => '自动滚动';
	@override String get manga_reader_auto_scroll_speed => '自动滚动速度（像素/秒）';
	@override String get manga_reader_automatic_background => '自动背景';
	@override String get manga_reader_back_to_start => '回到开头';
	@override String get manga_reader_brightness => '亮度';
	@override String get manga_reader_color_filter_color => '滤镜颜色';
	@override String get manga_reader_color_filter_opacity => '滤镜不透明度';
	@override String get manga_reader_contrast => '对比度';
	@override String get manga_reader_crop_borders => '裁剪白边';
	@override String get manga_reader_custom_color_filter => '自定义颜色滤镜';
	@override String get manga_reader_defaults => '默认阅读行为';
	@override String get manga_reader_disable_zoom_out => '禁止缩小至适应大小以下';
	@override String get manga_reader_double_tap_animation => '双击缩放动画';
	@override String get manga_reader_eink_mode => '墨水屏模式';
	@override String get manga_reader_filters => '自定义滤镜';
	@override String get manga_reader_flash_on_page_change => '翻页闪屏';
	@override String get manga_reader_fullscreen => '全屏';
	@override String get manga_reader_general => '常规';
	@override String get manga_reader_global => '使用全局默认';
	@override String get manga_reader_grayscale => '灰度';
	@override String get manga_reader_hide_threshold => '滚动隐藏工具栏阈值（像素）';
	@override String get manga_reader_invert_both => '双向反转点击区';
	@override String get manga_reader_invert_colors => '反色';
	@override String get manga_reader_invert_horizontal => '水平反转点击区';
	@override String get manga_reader_invert_vertical => '垂直反转点击区';
	@override String get manga_reader_invert_volume => '反转音量键翻页方向';
	@override String get manga_reader_keep_screen => '保持亮屏';
	@override String get manga_reader_lookup_on_hover => '悬停查词';
	@override String get manga_reader_mode_hint => '进入时显示阅读模式';
	@override String get manga_reader_ocr_automatic => '打开即识别';
	@override String get manga_reader_ocr_engine_note => '设为「打开即识别」时，打开卷或章节会在后台从当前页开始识别整卷，右上角显示进度，使用下方选择的引擎。设为「手动」则在工具栏提供「识别本卷」按钮。';
	@override String get manga_reader_ocr_manual => '手动';
	@override String get manga_reader_ocr_queued => '排队中';
	@override String get manga_reader_ocr_rerun => '重新识别本卷…';
	@override String get manga_reader_ocr_trigger => 'OCR 触发方式';
	@override String get manga_reader_ocr_unavailable => '没有可用的 OCR 引擎：请在 OCR 设置中下载本地模型或换用其他引擎。';
	@override String get manga_reader_ocr_unavailable_short => '没有可用的 OCR 引擎 · 请在 OCR 设置中下载模型或换引擎';
	@override String get manga_reader_ocr_volume => '识别本卷';
	@override String get manga_reader_override => '当前作品';
	@override String get manga_reader_padding => '长条漫左右留白';
	@override String get manga_reader_page_number => '显示页码';
	@override String get manga_reader_restore => '恢复全部全局默认';
	@override String get manga_reader_rotate_wide_pages => '旋转以适应屏幕';
	@override String get manga_reader_saturation => '饱和度';
	@override String get manga_reader_save_book => '按作品';
	@override String get manga_reader_save_chapter => '按作品及章节';
	@override String get manga_reader_save_directory => '图片保存目录';
	@override String get manga_reader_save_failed => '无法保存阅读设置';
	@override String get manga_reader_save_flat => '统一目录';
	@override String get manga_reader_scale => '图片缩放';
	@override String get manga_reader_settings => '阅读设置';
	@override String get manga_reader_show_page_gaps => '显示页间距';
	@override String get manga_reader_skip_duplicate => '跳过重复章节';
	@override String get manga_reader_skip_filtered => '跳过已过滤章节';
	@override String get manga_reader_skip_read => '跳过已读章节';
	@override String get manga_reader_split_wide_pages => '拆分宽页';
	@override String get manga_reader_tap_default => '默认';
	@override String get manga_reader_tap_disabled => '关闭';
	@override String get manga_reader_tap_edge => '边缘';
	@override String get manga_reader_tap_hint => '显示点击区提示';
	@override String get manga_reader_tap_kindle => 'Kindle';
	@override String get manga_reader_tap_l_shaped => 'L形';
	@override String get manga_reader_tap_right_left => '左右';
	@override String get manga_reader_transition => '始终显示章节过渡';
	@override String get manga_reader_webtoon_double_tap_zoom => '长条模式双击缩放';
	@override String get manga_reading_direction => '阅读方向';
	@override String get manga_reading_mode => '阅读模式';
	@override String get manga_reading_mode_auto => '自动';
	@override String get manga_reading_mode_gaps => '带间距长条漫';
	@override String get manga_reading_mode_spread => '翻页';
	@override String get manga_reading_mode_vertical => '纵向分页';
	@override String get manga_reading_mode_webtoon => '条漫';
	@override String get manga_remote_ocr_cancelled => '主机侧已取消远程 OCR。';
	@override String get manga_remote_ocr_engine => 'Fushi 互联服务端';
	@override String get manga_remote_ocr_failed => '远程 OCR 失败';
	@override String get manga_remote_ocr_no_host => '没有可用的支持漫画 OCR 的 Fushi 互联服务端。';
	@override String get manga_remote_ocr_not_ready => 'Fushi 互联服务端的 OCR 模型未下载，请先在服务端下载模型。';
	@override String get manga_remote_ocr_running => 'Fushi 互联服务端正在识别…';
	@override String get manga_remote_ocr_unsupported => 'Fushi 互联服务端不支持漫画 OCR。';
	...
	@override String get manga_rescan_failed => '重新识别框选区域失败';
	@override String get manga_rescan_hint => '拖动框选要重新识别的文字。识别结果会替换框内已有的文字层。';
	@override String get manga_rescan_region_updated => '已重新识别该区域并回写本页';
	@override String get manga_rescan_run => '重新识别框选区域';
	@override String get manga_rescan_running => '正在识别所选区域…';
	@override String get manga_rescan_undo_failed => '还原上一版文字层失败';
	@override String get manga_rescan_undone => '已还原重新识别前的文字层';
	@override String get manga_scale_fit_height => '适应高度';
	@override String get manga_scale_fit_screen => '适应屏幕';
	@override String get manga_scale_fit_width => '适应宽度';
	@override String get manga_scale_original => '原始大小';
	@override String get manga_scale_smart => '智能适应';
	@override String get manga_scale_stretch => '拉伸';
	@override String get manga_section_viewing => '浏览与翻页';
	@override String get manga_series_all_read => '所有章节都已读完';
	@override String get manga_series_auto_download => '新章自动下载';
	@override String get manga_series_auto_ocr => '完成后自动识别';
	@override String get manga_series_chapters_action => '章节';
	@override String get manga_series_download_all => '下载全部';
	@override String manga_series_download_all_locked_skipped({required Object count}) => '已跳过 ${count} 个锁定章节';
	@override String get manga_series_download_all_none => '所有章节都已下载或在队列中';
	@override String manga_series_download_all_queued({required Object count}) => '已加入 ${count} 章到下载队列';
	@override String get manga_series_first_chapter_reached => '已经是第一章了';
	@override String get manga_series_last_chapter_reached => '已经是最新一章了';
	@override String get manga_series_local_volume => '本地卷';
	@override String get manga_series_mark_previous_read => '标记此章及更早为已读';
	@override String get manga_series_mark_read => '标记为已读';
	@override String get manga_series_mark_unread => '标记为未读';
	@override String get manga_series_next_chapter => '下一章';
	@override String get manga_series_no_chapters => '还没有章节';
	@override String manga_series_no_chapters_in_language({required Object language}) => '该源只收录 ${language} 语言的章节';
	@override String get manga_series_ocr_all_downloaded => '识别全部已下载';
	@override String get manga_series_ocr_all_none => '没有需要识别的已下载章节';
	@override String get manga_series_ocr_no_engine => '没有可用的识别引擎';
	@override String get manga_series_ocr_queued => '已加入识别队列';
	@override String manga_series_ocr_queued_count({required Object count}) => '${count} 章排队中';
	@override String manga_series_ocr_running({required Object chapter, required Object done, required Object total}) => '识别中 ${chapter}：第 ${done}/${total} 页';
	@override String get manga_series_offline_hint => '显示的是本机已保存的章节';
	@override String get manga_series_open_series => '作品页';
	@override String get manga_series_page_count => '页数';
	@override String get manga_series_platform_unsupported => '该来源运行时在本平台不可用';
	@override String get manga_series_previous_chapter => '上一章';
	@override String manga_series_read_progress({required Object page, required Object total}) => '读到第 ${page}/${total} 页';
	@override String manga_series_read_progress_partial({required Object page}) => '读到第 ${page} 页';
	@override String get manga_series_refresh => '刷新章节';
	@override String get manga_series_refresh_failed => '无法从来源刷新';
	@override String get manga_series_remove_confirm => '把这部作品移出书架？已下载的章节和阅读进度会一并删除。';
	@override String get manga_series_remove_from_bookshelf => '移出漫画书架';
	@override String get manga_series_sort_newest => '最新在前';
	@override String get manga_series_sort_oldest => '最早在前';
	@override String get manga_series_source_disabled => '该来源未安装或已停用';
	@override String get manga_series_subscribe => '订阅';
	@override String manga_series_try_sibling_language({required Object language}) => '试试 ${language}';
	@override String get manga_series_unread_only => '只看未读';
	@override String get manga_series_unsubscribe => '取消订阅';
	@override String get manga_series_volume_info => '卷信息';
	@override String get manga_source_cloudflare_blocked => '该来源受 Cloudflare 保护，内置阅读器暂时无法访问。';
	@override String get manga_source_cloudflare_verify_hint => '在下方完成 Cloudflare 验证，通过后会自动继续加载。';
	@override String get manga_source_cloudflare_verify_title => '站点验证';
	@override String get manga_source_interconnect_disabled => '在设置里开启 Fushi 互联后即可使用此来源';
	@override String get manga_source_interconnect_subtitle => '浏览 Fushi 互联服务端上的漫画库';
	@override String get manga_spread_offset => '跨页偏移';
	@override String get manga_spread_offset_cover => '封面独占';
	@override String get manga_spread_offset_none => '从第一页起配对';
	@override String get manga_spread_offset_subtitle => '双页配对从第几页开始';
	@override String get manga_tap_ocr_notice_body => '这一页还没有文字数据。Fushi 会用你在设置里选的 OCR 引擎就地识别，识别完就能点词查询。可以在「设置 › 漫画 OCR」里更换引擎或关掉这个行为。';
	@override String get manga_tap_ocr_notice_confirm => '开始识别';
	@override String get manga_tap_ocr_notice_title => '点一下就识别';
	@override String get manga_tap_ocr_online_lens_only => '在线章节的页面不在本地，只能用 Google Lens 识别——页面图片会上传给 Google。';
	@override String get manga_tap_ocr_running => '正在识别本页…';
	@override String get manga_tap_to_ocr => '点击即识别';
	@override String get manga_tap_to_ocr_desc => '点一下还没识别的对话框，就地识别本页并直接查词。';
	@override String get manga_tap_zone_layout => '点击区域布局';
	@override String get manga_tap_zone_layout_kindle => 'Kindle';
	@override String get manga_tap_zone_layout_l_shaped => 'L 型';
	@override String get manga_tap_zone_layout_left_right => '左右';
	@override String get manga_tap_zone_layout_subtitle => '点击页面哪些位置会翻页';
	@override String get manga_tap_zone_layout_top_bottom => '上下';
	...
	@override String get manga_wide_page_solo => '宽页独占一屏';
	@override String get manga_wide_page_solo_subtitle => '见开き页单独占一屏显示';
	...
	@override String get media_file_location_failed => '无法打开文件位置。';
	@override String get media_file_location_open => '打开文件位置';
	@override String get media_import_folder => '导入文件夹';
	@override String get media_import_folder_as_source => '设为常驻来源';
	@override String get media_import_folder_once => '仅导入这一次';
	@override String get media_import_segment_extensions => '扩展';
	@override String get media_import_segment_local => '本地';
	@override String get media_import_segment_sources => '在线源';
	@override String get media_import_segment_stores => '仓库';
	@override String get media_server_item_folder => '文件夹';
	@override String get media_server_items_empty => '没有条目';
	@override String get media_server_items_load_failed => '无法从服务器加载条目';
	@override String get media_server_libraries_title => '媒体库';
	@override String get media_server_route_switch => '切换线路';
	@override String get media_server_row_view_all => '查看全部';
	@override String get media_server_search_hint => '搜索此服务器';
	@override String get media_server_servers_empty_hint => '还没有登录任何媒体服务器';
	@override String get media_server_servers_go_settings => '去设置添加服务器';
	@override String get media_server_servers_title => '选择服务器';
	@override String get media_server_sort_date_added => '添加时间';
	@override String get media_server_sort_name => '名称';
	...
	@override String get media_source_alist_account_hint => '账号留空即以游客访问';
	@override String get media_source_alist_folder => '站内目录';
	@override String get media_source_alist_missing_fields => '请填写站点地址（http 或 https）';
	@override String get media_source_alist_url => '站点地址';
	...
	@override String get media_source_network_subtitle_video => 'WebDAV 远程库（原地串流）';
	...
	@override String get media_source_rename_label => '来源名称';
	@override String get media_source_rescan => '重新扫描';
	@override String media_source_root_already_added({required Object path}) => '该位置已是来源，正在重新扫描：${path}';
	...
	@override String get mihon_extension_bulk_install => '批量安装';
	@override String mihon_extension_bulk_install_confirm({required Object count}) => '从该仓库安装 ${count} 个扩展？扩展会运行来自源站的代码。';
	@override String mihon_extension_bulk_install_done({required Object installed, required Object skipped, required Object failed}) => '已安装 ${installed} 个，跳过 ${skipped} 个，失败 ${failed} 个';
	@override String get mihon_extension_bulk_install_nothing => '当前筛选下的扩展都已经装过了。';
	@override String mihon_extension_bulk_install_progress({required Object current, required Object total, required Object name}) => '正在安装 ${current}/${total}：${name}';
	@override String get mihon_extension_disabled => '已停用';
	@override String mihon_extension_download_count({required Object count}) => '${count} 次下载';
	@override String get mihon_extension_download_count_unknown => '无下载数据';
	@override String get mihon_extension_error => '扩展错误';
	...
	@override String get mihon_extension_min_downloads => '最低下载量';
	...
	@override String get mihon_extension_sources_less => '收起源列表';
	@override String mihon_extension_sources_more({required Object count}) => '展开全部 ${count} 个源';
	@override String get mihon_extension_uninstall => '卸载';
	@override String get mihon_extension_update => '更新';
	@override String get mihon_extension_update_all => '一键更新';
	@override String mihon_extension_update_all_confirm({required Object count}) => '把 ${count} 个已安装扩展更新到仓库里的最新版？';
	@override String mihon_extension_update_all_done({required Object installed, required Object skipped, required Object failed}) => '已更新 ${installed} 个，跳过 ${skipped} 个，失败 ${failed} 个';
	@override String get mihon_extension_update_all_nothing => '已安装的扩展都是最新版。';
	@override String mihon_extension_update_all_progress({required Object current, required Object total, required Object name}) => '正在更新 ${current}/${total}：${name}';
	...
	@override String get mihon_source_login => '登录';
	@override String get mihon_source_login_done => '完成';
	@override String get mihon_source_login_empty => '没有捕获到会话 cookie，未保存';
	@override String get mihon_source_login_forward => '前进';
	@override String get mihon_source_login_hint => '在网站上登录后，点「完成」保存会话';
	@override String get mihon_source_login_import_browser => '从浏览器导入';
	@override String get mihon_source_login_import_hint => '已在系统浏览器打开源站，Fushi 扩展会把会话送过来；还没登录就在浏览器里登录，然后点「完成」。';
	@override String get mihon_source_login_import_none => '还没收到浏览器送来的会话';
	@override String mihon_source_login_import_received({required Object count}) => '已从浏览器导入 ${count} 条 cookie';
	@override String get mihon_source_login_saved => '已登录该源';
	@override String get mihon_source_move_down => '下移';
	@override String get mihon_source_move_up => '上移';
	@override String get mihon_source_no_results => '没有找到漫画。';
	@override String get mihon_source_pin => '置顶';
	...
	@override String get mihon_source_unpin => '取消置顶';
	@override String get mihon_source_website_open => '在网站打开';
	@override String get mihon_source_website_unavailable => '该源没有这部作品的网页';
	@override String get mihon_sources_search_hint => '搜索在线源';
	@override String get mihon_sources_sort_by_downloads => '按下载量排序';
	@override String get mihon_sources_sort_by_downloads_done => '已按扩展下载量重排源';
	@override String get mihon_sources_sort_by_downloads_no_data => '还没有下载量数据，先刷新扩展仓库';
	@override String get mihon_store_add => '添加扩展仓库';
	@override String get mihon_store_edit => '编辑仓库地址';
	@override String get mihon_store_empty => '还没有扩展仓库。可添加兼容的 Mihon 仓库，或导入本地 APK。';
	@override String mihon_store_extension_count({required Object count}) => '${count} 个扩展';
	@override String get mihon_store_refresh => '刷新仓库';
	@override String get mihon_store_remove => '移除扩展仓库';
	@override String get mihon_store_url => '扩展仓库地址';
	@override String get mihon_store_zero_extensions => '该仓库返回 0 个扩展，地址可能指向了旧版索引。';
	@override String get mining_animated_format_avif => 'AVIF（体积最小，最推荐）';
	@override String get mining_animated_format_gif => 'GIF（兼容性最好，体积最大，无压缩）';
	@override String get mining_animated_format_webp => 'WebP（兼容性更广）';
	@override String get mining_audio_follow_playback_speed => '句子音频跟随播放倍速';
	@override String get mining_audio_follow_playback_speed_hint => '有声书以非 1 倍速播放时，卡片的句子音频按同一倍率变速不变调；仅对有声书制卡生效。';
	@override String get mining_audio_head_pad => '句子音频开头余量';
	@override String get mining_audio_head_pad_hint => '字幕开始前多保留这么多音频，避免首音被切掉；不会越过上一句。';
	@override String mining_audio_pad_readout({required Object ms}) => '${ms} 毫秒';
	...
	@override String get mining_audio_tail_pad => '句子音频结尾余量';
	@override String get mining_audio_tail_pad_hint => '字幕结束后多保留这么多音频，避免句尾被切短；不会越过下一句。';
	...
	@override String get mining_still_format_png => 'PNG';
	@override String get module_disabled_hint => '该功能模块已在「设置 → 外观 → 功能模块」中关闭。';
	@override String get module_downloads_hidden_hint => '「下载」页已在 设置 → 外观 → 功能模块 中隐藏；重新打开它才能管理订阅。';
	@override String get module_extension_label => '浏览器扩展';
	...
	@override String get network_proxy_address_hint => '供应用全部公网请求使用的 HTTP 代理服务器';
	@override String get network_proxy_auto_hint => '应用的全部联网请求都走这里：更新、云同步、词典、下载、字幕与元数据。留空为自动：先读环境变量，再读已启用的系统代理。P2P（torrent）传输默认直连，可在下方单独开启。';
	@override String get network_proxy_credentials_scope_hint => '凭据仅用于 HTTP 请求；内置 torrent 引擎无法使用';
	@override String get network_proxy_hint => 'host:port，例如 127.0.0.1:7890（仅 IPv4/域名）';
	@override String get network_proxy_invalid => '代理格式无效，请用 host:port';
	@override String get network_proxy_label => '网络代理';
	@override String get network_proxy_mode_auto => '自动';
	@override String get network_proxy_mode_auto_hint => '先读取环境变量，再读取已启用的系统代理';
	@override String get network_proxy_mode_direct => '直连';
	@override String get network_proxy_mode_direct_hint => '应用不使用任何代理';
	@override String get network_proxy_mode_label => '代理模式';
	@override String get network_proxy_mode_manual => '手动';
	@override String get network_proxy_mode_manual_hint => '使用下方服务器与可选认证信息';
	@override String get network_proxy_p2p_label => 'P2P（torrent）代理';
	@override String get network_proxy_p2p_mode_direct => '直连';
	@override String get network_proxy_p2p_mode_mixed => '混合';
	@override String get network_proxy_p2p_mode_proxy => '走代理';
	@override String get network_proxy_p2p_warning => '默认直连。走代理：全部 P2P 流量经全局代理——可能降速，且不少代理服务商禁止 BT 流量（限速、警告甚至封号）。混合：tracker 请求经代理、DHT 与 peer 直连——节点获取范围最大，但真实 IP 会暴露给 tracker/DHT/peer（只解决连通性，无隐私作用）。仅对内置引擎生效，外接 qBittorrent 请在其自身设置中配置。';
	@override String get network_proxy_password => '代理密码（可选）';
	@override String get network_proxy_username => '代理用户名（可选）';
	...
	@override String get onboarding_action_badge_optional => '可选';
	@override String get onboarding_action_badge_recommended => '推荐';
	@override String get onboarding_action_badge_required => '必做';
	@override String get onboarding_action_next => '下一步';
	@override String get onboarding_action_skip => '暂时跳过';
	@override String get onboarding_action_start => '开始使用';
	@override String get onboarding_actions_more => '其他方式';
	@override String get onboarding_anki_action_get_anki_desc => '打开 Anki 下载页。制卡时让它开着。';
	@override String get onboarding_anki_action_get_ankidroid_desc => '打开商店页。卡片写进 AnkiDroid，得先装上。';
	@override String get onboarding_anki_action_install_addon_desc => '把内置的 AnkiConnect 插件解压进 Anki。装完重启 Anki。';
	@override String get onboarding_anki_action_refresh_desc => '重新拉取牌组和笔记类型。在 Anki 里新建牌组后点它。';
	@override String get onboarding_anki_action_test_desc => '检查能否连上 Anki，并拉取牌组和笔记类型。不会创建任何东西。';
	@override String onboarding_anki_addon_failed({required Object message}) => '安装失败：${message}';
	@override String get onboarding_anki_addon_installed => '已装好 AnkiConnect。启动或重启 Anki，然后测试连接。';
	@override String get onboarding_anki_addon_no_anki => '没找到 Anki 数据目录。先安装 Anki 并打开一次，再重试。';
	@override String get onboarding_anki_backend_label => '连接方式';
	@override String get onboarding_anki_fsrs_body => 'Anki 内置了 FSRS —— 目前最好的间隔重复算法之一，但你不打开它，排程就一直走三十多年前的 SM-2。FSRS 拿你的真实复习记录预测遗忘时点，同样的记忆效果复习量更少。这个开关只在 Anki 里开一次，Fushi 这边不用改任何设置。';
	@override String get onboarding_anki_fsrs_step_optimize_desc => '在开关下方点「优化」，让参数贴合你自己的复习记录，然后保存。复习记录不足约 1000 条时默认参数已经比 SM-2 准，攒够以后再优化一次即可。';
	@override String get onboarding_anki_fsrs_step_optimize_title => '点「优化」再保存';
	@override String get onboarding_anki_fsrs_step_options_desktop_desc => '在 Anki 主界面点牌组右侧的齿轮，选「选项」。';
	@override String get onboarding_anki_fsrs_step_options_mobile_desc => '在 AnkiDroid（2.17 及以上）或 AnkiMobile 里长按牌组，选「选项」。';
	@override String get onboarding_anki_fsrs_step_options_title => '打开牌组选项';
	@override String get onboarding_anki_fsrs_step_toggle_desc => '滚到选项页最底部的「FSRS」区块（旧版藏在「高级」里），把开关打开。它对整个收藏生效，开一次就够。';
	@override String get onboarding_anki_fsrs_step_toggle_title => '打开 FSRS 开关';
	@override String get onboarding_anki_fsrs_title => '在 Anki 里开启 FSRS';
	@override String get onboarding_anki_get_anki_action => '下载 Anki（桌面版）';
	@override String get onboarding_anki_get_ankidroid_action => '下载 AnkiDroid';
	@override String get onboarding_anki_install_addon_action => '一键安装 AnkiConnect 插件';
	@override String get onboarding_anki_intro_body => 'Anki 是免费的间隔重复记忆软件。查词后，Fushi 一键把单词、释义、例句、发音和截图做成卡片。';
	@override String get onboarding_anki_mobile_ankiconnect_hint => '把卡制进同一局域网里电脑上的 Anki：在制卡设置里开启 AnkiConnect 并填电脑地址。';
	@override String get onboarding_anki_mobile_ankiconnect_title => '高级：本机改用 AnkiConnect 连电脑';
	@override String get onboarding_anki_setup_android_hint => '装好 AnkiDroid 并打开一次。首次制卡时在授权框里点「允许」，别的不用设。';
	@override String get onboarding_anki_setup_desktop_hint => '先装 Anki，再装 AnkiConnect 插件（下方一键安装，或在 Anki 里填插件代码 2055492159）。制卡时保持 Anki 运行。';
	@override String get onboarding_anki_setup_ios_hint => '装有 AnkiMobile 即可直接加卡。要用完整功能，可经 AnkiConnect 连同一局域网里电脑上的 Anki。';
	@override String get onboarding_anki_status_pending => '尚未测试连接';
	@override String get onboarding_anki_test_action => '测试连接';
	@override String onboarding_anki_test_success({required Object count}) => '连接成功：读到 ${count} 个牌组';
	@override String get onboarding_click_lookup_intro => '在书、漫画或字幕里点任意一个词就能看释义。先用下面这句话练手。';
	@override String get onboarding_click_lookup_mine_body => '点词条上的 ＋，把单词、句子、音频和画面送进制卡器。';
	@override String get onboarding_click_lookup_mine_title => '做成卡片';
	@override String get onboarding_click_lookup_nested_body => '点释义里的词会展开下一层；返回或点弹窗外关闭一层。';
	@override String get onboarding_click_lookup_nested_title => '在弹窗里继续查';
	@override String get onboarding_click_lookup_tap_desc => '轻点（电脑上单击）一个字，Fushi 从这里向后匹配最长的词。句子会在查词页里打开。';
	@override String get onboarding_click_lookup_tap_title => '点一下文字';
	@override String get onboarding_feature_anki => 'Anki 制卡';
	@override String get onboarding_feature_anki_hint => '查词后一键做成卡片';
	@override String get onboarding_feature_backup => '备份与同步';
	@override String get onboarding_feature_backup_hint => 'Google Drive、WebDAV 或本地文件';
	@override String get onboarding_feature_books => '小说';
	@override String get onboarding_feature_books_hint => '读 EPUB，点词查词，有声书同步';
	@override String get onboarding_feature_extension_hint => '在任意网页查词（仅桌面）';
	@override String get onboarding_feature_fonts => '自定义字体';
	@override String get onboarding_feature_fonts_hint => '界面、正文、词典各用自己喜欢的字体';
	@override String get onboarding_feature_games => 'Galgame';
	@override String get onboarding_feature_games_hint => '游戏文本 Hook 查词（仅 Windows）';
	@override String get onboarding_feature_interconnect => '设备互联';
	@override String get onboarding_feature_interconnect_hint => '局域网多设备共享书库和进度';
	@override String get onboarding_feature_manga => '漫画';
	@override String get onboarding_feature_manga_hint => '看漫画，OCR 查词';
	@override String get onboarding_feature_manual_resources => '自备词典和音频';
	@override String get onboarding_feature_manual_resources_hint => '从自己的文件导入词典、有声书和发音来源';
	@override String get onboarding_feature_pack => '推荐包';
	@override String get onboarding_feature_pack_hint => '一次下载：日语词典 + 日/英发音音频';
	@override String get onboarding_feature_video => '视频';
	@override String get onboarding_feature_video_hint => '字幕查词与制卡';
	@override String get onboarding_features_modules_hint => '未勾选的页面不显示在导航栏，之后可在「设置 → 外观」改回。';
	@override String get onboarding_features_modules_title => '库页';
	@override String get onboarding_features_setup_hint => '只有勾选的项目会出现在后面的步骤里。';
	@override String get onboarding_features_setup_title => '接下来配置';
	@override String get onboarding_features_title => '你想用 Fushi 做什么';
	@override String get onboarding_finish_body => '之后随时可以在「设置 → 系统」重新打开本引导。';
	@override String get onboarding_finish_summary_modules => '显示的库页';
	@override String get onboarding_finish_summary_none => '无';
	@override String get onboarding_finish_summary_setup => '本次配置';
	@override String get onboarding_finish_title => '一切就绪';
	@override String get onboarding_first_anki_action => '打开查词页制卡';
	@override String get onboarding_first_anki_action_desc => '在查词页打开练习句子。点词、点加号、检查字段、保存。';
	@override String get onboarding_first_anki_card_intro => 'Anki 已连上。现在做一张真卡，确认整条链路能走通。';
	@override String get onboarding_first_anki_lookup_desc => '打开练习句子，点一个词。';
	@override String get onboarding_first_anki_lookup_title => '查一个词';
	@override String get onboarding_first_anki_plus_body => '制卡器打开，单词、读音、释义、句子、音频和画面已经填好。';
	@override String get onboarding_first_anki_plus_title => '点加号';
	@override String get onboarding_first_anki_save_body => '确认牌组和笔记类型后保存，打开 Anki 就能看到这张卡。';
	@override String get onboarding_first_anki_save_title => '检查后保存';
	@override String get onboarding_global_lookup_android_body => 'Android 通过文字菜单或分享面板把选中文本交给 Fushi。';
	@override String get onboarding_global_lookup_android_continue_body => '查词弹窗盖在原应用上，关掉就回去。';
	@override String get onboarding_global_lookup_android_continue_title => '在弹窗里继续';
	@override String get onboarding_global_lookup_android_open_body => '在文字菜单点 Fushi；没有就点分享，再选 Fushi。';
	@override String get onboarding_global_lookup_android_open_title => '选择 Fushi';
	@override String get onboarding_global_lookup_android_select_desc => '在其他应用里长按一个词，拖动手柄覆盖它。';
	@override String get onboarding_global_lookup_android_select_title => '选中文字';
	@override String get onboarding_global_lookup_windows_action => '打开快捷键设置';
	@override String get onboarding_global_lookup_windows_action_desc => '想换组合键再进来。';
	@override String get onboarding_global_lookup_windows_body => '在其他应用里选中文字，不用切窗口就能查词。';
	@override String get onboarding_global_lookup_windows_customize_body => '设置 → 快捷键 → 全局（应用外）。';
	@override String get onboarding_global_lookup_windows_customize_title => '改快捷键';
	@override String get onboarding_global_lookup_windows_select_desc => '在任意应用里拖选一个词，保持选中。';
	@override String get onboarding_global_lookup_windows_select_title => '选中文字';
	@override String get onboarding_global_lookup_windows_shortcut_body => 'Fushi 抓取选区，在鼠标旁打开查词卡片。';
	@override String get onboarding_global_lookup_windows_shortcut_press => '按下快捷键';
	@override String get onboarding_lookup_practice_action => '用这句话练习查词';
	@override String get onboarding_lookup_practice_desc => '在查词页里打开这句话，点其中的词看释义。查不到就是词典还没装好。';
	@override String get onboarding_manual_audiobook_action => '导入书籍和有声书';
	@override String get onboarding_manual_audiobook_action_desc => '书籍或文本、对齐字幕和音频文件。有字幕，Fushi 才能按句同步音频。';
	@override String get onboarding_manual_dictionary_action => '导入词典';
	@override String get onboarding_manual_dictionary_action_desc => '打开词典管理。装好词典，查词才有结果。';
	@override String get onboarding_manual_pronunciation_action => '配置单词发音';
	@override String get onboarding_manual_pronunciation_action_desc => '词条发音的本地或在线来源。与有声书音频是两回事。';
	@override String get onboarding_online_services_account => '需要个人账号';
	@override String get onboarding_online_services_anidb => '文件指纹辅助识别动画作品和分集。Fushi 已注册应用客户端，你仍需注册自己的 AniDB 账号，在设置中填写账号并自行开启文件哈希识别。';
	@override String get onboarding_online_services_body => '按需配置你要用的服务，也可以跳过。勾选此教程不会启用服务或提交账号，未勾选也不会改变已有设置。';
	@override String get onboarding_online_services_build_missing => '此构建未配置应用身份';
	@override String get onboarding_online_services_configure => '打开在线服务设置';
	@override String get onboarding_online_services_dandanplay => '此构建已内置弹幕服务应用身份，无需每位用户申请 API；按需开启在线弹幕匹配即可。';
	@override String get onboarding_online_services_dandanplay_missing => '此构建未配置弹幕服务应用身份，官方在线匹配暂不可用。应用身份由开发者申请，不需要你注册个人 API。';
	@override String get onboarding_online_services_embedded => '应用身份已内置';
	@override String get onboarding_online_services_hint => '按需了解账号、API 密钥和已有服务';
	@override String get onboarding_online_services_jimaku => '用于查找字幕。注册或登录 Jimaku 后，在账号页面生成个人 API 密钥，填入设置并开启字幕来源。';
	@override String get onboarding_online_services_key => '需要 API 密钥';
	@override String get onboarding_online_services_link => '打开官方账号 / API 页面';
	@override String get onboarding_online_services_opensubtitles => '用于查找和下载字幕。注册账号后在 API 页面创建应用并获取 API 密钥。用户登录为可选项，可使用对应账号的下载配额。';
	@override String get onboarding_online_services_opensubtitles_embedded => '应用已内置 API 密钥。可选登录自己的 OpenSubtitles 账号使用个人下载额度，也可以填写自己的 API 密钥。';
	@override String get onboarding_online_services_public => 'MAL / Jikan 提供作品资料；AniList 用于发现和相关查询。公共只读查询无需个人账号或 API 密钥。';
	@override String get onboarding_online_services_ready => '无需注册';
	@override String get onboarding_online_services_server => '连接已有服务器';
	@override String get onboarding_online_services_servers => '这些服务没有统一注册入口。请填写你已有服务器的地址，以及服务管理员提供的账号或密钥；没有服务器可跳过。';
	@override String get onboarding_online_services_subdl => '用于查找电影与剧集的英文及多语种字幕。注册免费 SubDL 账号后在面板生成 API 密钥，填入设置并开启字幕来源。';
	@override String get onboarding_online_services_title => '在线服务（可选）';
	@override String get onboarding_online_services_tmdb => '此构建已内置 TMDB 密钥，用于资料补缺与兜底。只有需要自己的配额时才配置个人密钥。';
	@override String get onboarding_online_services_tmdb_missing => '此构建未内置 TMDB 密钥。需要 TMDB 资料兜底时，请申请 API 密钥并填入设置；MAL / Jikan 仍可使用。';
	@override String get onboarding_pack_action_audio_desc => '给推荐包没覆盖的语言添加在线发音来源。';
	@override String get onboarding_pack_action_dictionary_desc => '学其他语言？在这里导入对应词典。';
	@override String get onboarding_pack_action_download_desc => '后台从多个来源同时下载，下完自动导入。随时可取消，下次从断点续传。';
	@override String get onboarding_pack_action_import_existing_desc => '包已经在硬盘上了。确认框里选「合并」就不会动你已有的数据。';
	@override String get onboarding_pack_action_pick_desc => '已经拿到包的 zip？直接从硬盘导入，跳过下载。';
	@override String get onboarding_pack_action_website => '打开官网下载页';
	@override String get onboarding_pack_action_website_desc => '给下载工具用的分片直链。下完回来用「选择本地包文件」导入。';
	@override String get onboarding_pack_discard_confirm => '盘上的半截包会被删除，以后要重新下载就得从头开始。';
	@override String get onboarding_pack_discard_failed => '无法删除下载文件。请关闭占用文件的程序后重试。';
	@override String get onboarding_pack_discard_running => '正在清理下载文件…';
	@override String get onboarding_pack_download_background_hint => '下载会在后台继续：可以直接走下一步，也可以关掉向导。进度、取消和导入都在「设置 → 系统」里。';
	@override String get onboarding_pack_download_discard => '放弃下载';
	@override String onboarding_pack_download_failed({required Object message}) => '下载失败：${message}';
	@override String get onboarding_pack_download_finished => '推荐包下载完成。可在「设置 → 系统」里导入。';
	@override String get onboarding_pack_download_ready_hint => '导入后即可使用词典和发音资源，也可以稍后再导入。';
	@override String get onboarding_pack_download_ready_notice => '推荐包已下载。准备好后，点击底部的「现在导入」。';
	@override String get onboarding_pack_download_resume => '继续下载';
	@override String get onboarding_pack_downloading => '下载中……可随时取消，下次续传';
	@override String get onboarding_pack_import_now => '现在导入';
	@override String get onboarding_pack_intro => '一次下载装好日语词典、音调、词频和日/英发音音频。学其他语言可跳过，自行导入词典。';
	@override String get onboarding_pack_mini_bar_hide => '收起';
	@override String get onboarding_pack_paused_desc => '进度留在磁盘上，继续下载会从中断处接着下。';
	@override String onboarding_pack_pick_failed({required Object message}) => '选择包文件失败：${message}';
	@override String get onboarding_pack_pick_no_path => '系统没有交出这个文件的路径。请把包放到手机存储里再选，或授予「所有文件访问」权限。';
	@override String get onboarding_pack_status_downloading => '推荐包下载中';
	@override String get onboarding_pack_status_paused => '推荐包下载已暂停';
	@override String get onboarding_pack_status_ready => '推荐包已下载完成';
	@override String get onboarding_pack_tutorial_desc => '词典和发音资源已就绪，试试第一次查词吧。';
	@override String get onboarding_pack_tutorial_ready => '资源已准备好';
	@override String get onboarding_pack_tutorial_skip => '暂时跳过';
	@override String get onboarding_pack_tutorial_start => '开始查词教程';
	@override String get onboarding_reopen => '新手引导';
	@override String get onboarding_sample_sentence_hint => '点一下在查词页打开，再点其中任意一个词。';
	@override String get onboarding_sample_sentence_label => '练习句子';
	@override String get onboarding_step_anki_action => '制卡设置';
	@override String get onboarding_step_anki_action_desc => '卡片模板、字段映射、截图和音频。上面选好牌组和笔记类型就能开始了。';
	@override String get onboarding_step_anki_title => '配置 Anki';
	@override String get onboarding_step_backup_action => '打开备份设置';
	@override String get onboarding_step_backup_action_desc => '选择备份后端并登录，或导出本地备份文件。';
	@override String get onboarding_step_backup_body => '换机器或丢设备时，库还在。';
	@override String get onboarding_step_backup_title => '备份';
	@override String get onboarding_step_click_lookup_title => '点击查词';
	@override String get onboarding_step_dictionary_action => '打开词典管理';
	@override String get onboarding_step_extension_action => '打开安装引导';
	@override String get onboarding_step_extension_action_desc => '教你安装扩展并连上 Fushi。';
	@override String get onboarding_step_extension_body => '装上配套扩展，在任意网页上查词。';
	@override String get onboarding_step_extension_title => '浏览器扩展';
	@override String get onboarding_step_first_anki_card_title => '第一张卡片';
	@override String get onboarding_step_fonts_action_desc => '导入字体文件，按语言指定。';
	@override String get onboarding_step_fonts_body => '界面、正文、词典各用自己喜欢的字体。';
	@override String get onboarding_step_fonts_title => '字体';
	@override String get onboarding_step_global_lookup_title => '全局查词';
	@override String get onboarding_step_interconnect_action => '打开互联设置';
	@override String get onboarding_step_interconnect_action_desc => '开启互联，把这台设备和其他设备配对。';
	@override String get onboarding_step_interconnect_body => '局域网配对多台设备，共享一个库，进度同步。';
	@override String get onboarding_step_interconnect_title => '设备互联';
	@override String get onboarding_step_manual_resources_body => '查词教程之前至少导入一本词典。有声书和发音音频按需添加。';
	@override String get onboarding_step_manual_resources_title => '自备词典和音频';
	@override String get onboarding_step_pack_download_action => '下载并导入';
	@override String get onboarding_step_pack_import_existing_action => '导入已下载的包';
	@override String get onboarding_step_pack_pick_action => '选择本地包文件';
	@override String get onboarding_step_pack_title => '推荐包';
	@override String get onboarding_title => '新手引导';
	@override String get onboarding_welcome_body => '先选界面语言和明暗主题，剩下的交给后面几步。';
	@override String get onboarding_welcome_headline => '欢迎使用 Fushi';
	...
	@override String get popup_compact_glossaries => '紧凑释义';
	@override String get popup_compact_glossaries_hint => '查词弹窗里的释义条目改为同行显示、用「 | 」分隔，不再每条占一行。';
	...
	@override String get popup_ctx_confirm_failed => '制卡没能开始——回点制卡按钮时查词弹窗已经关掉了。请重试。';
	@override String get popup_ctx_edit_cancel => '放弃修改';
	@override String get popup_ctx_edit_confirm => '确认修改';
	@override String get popup_ctx_edit_start => '编辑句子';
	...
	@override String get popup_ctx_preview_audio => '试听';
	@override String get popup_ctx_preview_stop => '停止';
	@override String get popup_ctx_preview_unavailable => '这句没有可试听的音频';
	...
	@override String get popup_dismiss_animation => '弹窗关闭动画';
	@override String get popup_dismiss_animation_hint => '滑动关闭查词弹窗时播放滑出动画。关掉则瞬间关闭（墨水屏模式下始终关闭）';
	@override String get popup_font_size_decrease => '缩小查词字号';
	@override String get popup_font_size_increase => '放大查词字号';
	@override String get popup_full_width => '弹窗全宽';
	@override String get popup_full_width_hint => '忽略最大宽度，让弹窗横向铺满可用宽度；位置仍跟随选中的词。';
	@override String get popup_history_back => '后退';
	@override String get popup_history_forward => '前进';
	...
	@override String get popup_instant_scroll_touch_step => '瞬时滚动触摸步长';
	@override String get popup_instant_scroll_touch_step_hint => '手指滑过弹窗高度的这一比例后，弹窗跳动一步。';
	@override String get popup_instant_scroll_wheel_step => '瞬时滚动滚轮步长';
	@override String get popup_instant_scroll_wheel_step_hint => '滚轮每格让弹窗跳动的距离，占弹窗高度的比例（再乘以弹窗滚动速度）。';
	...
	@override String get profile_language_bindings => '语言绑定';
	@override String get profile_language_bindings_hint => '在条目已标注内容语言时生效。EPUB 会自动读取文件里的声明；其它格式需要在条目上手动指定。';
	@override String get profile_management => '配置管理';
	@override String get profile_media_audiobook => '有声书';
	@override String get profile_media_browser => '浏览器';
	@override String get profile_media_epub => '普通书';
	@override String get profile_media_game => '游戏';
	@override String get profile_media_lyrics => '歌词模式';
	@override String get profile_media_manga => '漫画';
	...
	@override String get reader_audiobook_current_chapter => '当前章节';
	@override String get reader_audiobook_tab_chapters => '章节';
	@override String get reader_audiobook_tab_files => '资源';
	...
	@override String get reader_control_editor_hint => '把按钮拖到顶栏或底栏的任意位置，或移出。';
	@override String get reader_control_editor_title => '阅读器按钮布局';
	@override String get reader_control_item_play_pause => '播放 / 暂停';
	@override String get reader_control_item_seek_back => '快退 10 秒';
	@override String get reader_control_item_seek_forward => '快进 10 秒';
	@override String get reader_control_reject_required => '必选按钮必须保留在阅读器上。';
	@override String get reader_control_reject_title => '书名只能放在顶栏中间，其它按钮不能放那里。';
	@override String get reader_control_reset_layout => '恢复默认阅读器按钮布局';
	@override String get reader_control_slot_hidden => '移出阅读器';
	@override String get reader_control_title => '书名';
	@override String get reader_copy_image => '复制图片';
	@override String get reader_floating_ball => '悬浮球';
	@override String get reader_floating_ball_hint => '半透明小球停靠在页面边缘。点击后按钮环绕小球展开，再点收起；可拖动上下移动或换边。放哪些按钮在上方的按钮布局编辑器里拖选。';
	@override String get reader_font_size => '字体大小';
	@override String get reader_font_vpal => 'VPAL 纵排替代';
	@override String get reader_font_weight => '字体粗细';
	@override String get reader_furigana_dimmed => '淡显';
	@override String get reader_furigana_hidden => '隐藏';
	@override String get reader_furigana_hide => '隐藏';
	@override String get reader_furigana_mode => '隐藏振假名';
	@override String get reader_furigana_mode_hint => '';
	@override String get reader_furigana_off => '关闭';
	@override String get reader_furigana_partial => '部分';
	@override String get reader_furigana_show => '显示';
	@override String get reader_furigana_toggle => '点击显示';
	@override String get reader_gallery => '插图';
	@override String get reader_gallery_cover => '封面';
	@override String get reader_gallery_current => '正在阅读';
	@override String get reader_gallery_empty => '本书没有插图';
	@override String get reader_gallery_filter_all => '全部';
	@override String get reader_gallery_filter_unlocked => '已解锁';
	@override String get reader_gallery_jump => '跳转到此插图';
	@override String get reader_gallery_locked_back => '回到最近已看';
	@override String get reader_gallery_locked_blur_hint => '已开启图片模糊，揭开后可见';
	@override String get reader_gallery_locked_reveal => '仍要查看';
	@override String get reader_gallery_locked_title => '这张插图尚未读到';
	@override String reader_gallery_locked_unlock_hint({required Object chapter}) => '读到${chapter}后自动解锁';
	@override String get reader_gallery_position_current => '当前阅读位置';
	@override String get reader_gallery_position_jump => '跳到当前阅读位置';
	@override String get reader_gallery_relock => '恢复遮罩';
	@override String get reader_gallery_title => '插图册';
	@override String get reader_gallery_tooltip => '浏览插图';
	@override String reader_gallery_unlocked_count({required Object unlocked, required Object total}) => '已解锁 ${unlocked} / ${total}';
	@override String get reader_gallery_unlocked_empty => '还没有已解锁的插图';
	...
	@override String get reader_popup_scroll_dismiss => '滚动时关闭查词弹窗';
	@override String get reader_popup_scroll_dismiss_hint => '滚动模式下，查词后继续滚动正文（横排竖排均可）即关闭查词弹窗';
	@override String get reader_reader_styles => '优先书籍样式';
	@override String get reader_scroll => '滚动';
	@override String get reader_settings_panel_move_left => '将设置移到左侧';
	@override String get reader_settings_panel_move_right => '将设置移到右侧';
	@override String get reader_settings_section => '阅读设置';
	@override String get reader_stats_book_total => '本书累计';
	@override String reader_stats_cards({required Object n}) => '制卡 ${n}';
	@override String reader_stats_chars_per_hour({required Object n}) => '${n} 字/时';
	@override String get reader_stats_clock_pause => '暂停计时';
	@override String get reader_stats_clock_paused => '已暂停';
	@override String get reader_stats_clock_resume => '继续计时';
	@override String get reader_stats_clock_running => '计时中';
	@override String get reader_stats_finish_book => '全书';
	@override String get reader_stats_finish_chapter => '本章';
	@override String get reader_stats_full_records_open => '打开完整记录';
	@override String reader_stats_lookups({required Object n}) => '查词 ${n}';
	@override String get reader_stats_position => '阅读位置';
	@override String get reader_stats_position_book => '全书';
	@override String get reader_stats_position_chapter => '本章';
	@override String reader_stats_position_progress({required Object current, required Object total}) => '${current} / ${total} 字';
	@override String get reader_stats_remaining_book => '全书还需';
	@override String get reader_stats_remaining_chapter => '本章还需';
	@override String get reader_stats_session => '本次会话';
	@override String get reader_stats_this_book => '本书';
	@override String get reader_stats_time_to_finish => '预计读完';
	@override String get reader_stats_title => '书内统计';
	...
	@override String get reader_timer_show => '显示阅读计时器';
	...
	@override String get reader_vn_click_advance => '点击空白处推进';
	@override String get reader_vn_merge_spoken_sentence => '有声句保持在同一屏';
	@override String get reader_vn_preserve_dialogue => '保持对话完整';
	@override String get reader_vn_reveal_instant => '立即显示';
	@override String get reader_vn_reveal_speed => '文字渐显速度';
	@override String get reader_vn_screen_block => '一个段落';
	@override String get reader_vn_screen_mode => '每屏内容';
	@override String get reader_vn_screen_sentences => '按句子';
	@override String get reader_vn_sentences_per_screen => '每屏句数';
	@override String get reader_vn_settings => '视觉小说设置';
	@override String get reader_volume_open => '打开本卷';
	@override String get reader_volume_peek_failed => '读取本卷失败';
	...
	@override String get reading_stats_idle_timeout => '空闲判定时长';
	@override String get reading_stats_idle_timeout_hint => '这么久没有翻页、滚动或查词就停止计入阅读时长。只对小说、PDF、漫画生效；视频以播放状态为准。';
	...
	@override String get remote_book_audiobook_download => '从互联对端下载有声书';
	...
	@override String get remote_book_list_failed => '无法获取 Fushi 互联服务端的远端书库。';
	@override String get remote_book_unavailable => 'Fushi 互联服务端不可用';
	@override String remote_collection_download_done({required Object ok, required Object failed}) => '已下载 ${ok} 个远端集，${failed} 个失败';
	@override String get remote_collection_download_members => '下载远端集';
	@override String get remote_collection_download_nothing => '没有需要下载的远端集';
	@override String remote_collection_download_started({required Object count}) => '正在后台下载 ${count} 个远端集';
	@override String get remote_collection_scrape_done => '已从主机更新资料';
	@override String get remote_collection_scrape_failed => '远程刮削失败：作品不在主机的刮削计划里';
	@override String remote_collection_scrape_identity_conflict({required Object provider, required Object id}) => '主机上该作品已绑定 ${provider} ID ${id}，要替换吗？';
	@override String get remote_collection_scrape_on_host => '在主机上刮削';
	@override String get remote_collection_scrape_pick_work => '选择要刮削的作品';
	@override String get remote_collection_scrape_push_to_host => '本机刮削并回写主机';
	@override String get remote_collection_scrape_unavailable => '对端主机不支持远程刮削';
	@override String get remote_collection_tmdb_ordering_on_host => '在 host 上选择 TMDB 集编排…';
	...
	@override String get remote_manga_added_to_shelf => '已加入漫画书架，章节从对端下载';
	...
	@override String get remote_video_unavailable => 'Fushi 互联服务端不可用';
	...
	@override String get resource_version_show_files => '显示文件';
	@override String get resource_version_view_flat => '全部条目';
	...
	@override String get section_network => '网络';
	@override String get section_page_turn_direction => '翻页方向';
	@override String get section_services_metadata => '元数据刮削';
	@override String get section_services_resources => '资源索引器';
	@override String get section_services_subtitles => '字幕来源';
	...
	@override String get settings_anki_media => '制卡媒体';
	...
	@override String get settings_destination_appearance_interaction => '外观与交互';
	...
	@override String get settings_destination_profile_presets => '配置方案';
	...
	@override String get settings_destination_services => '在线服务';
	@override String get settings_destination_services_summary => '第三方 API、索引器与媒体服务器';
	@override String get settings_destination_storage => '存储';
	@override String get settings_destination_storage_summary => '数据位置与磁盘占用';
	@override String get settings_destination_sync_backup => '同步与备份';
	@override String get settings_destination_system => '系统';
	@override String get settings_destination_system_about => '系统与关于';
	...
	@override String get settings_downloads_advanced_hint => '连接数、内存、节点发现与防护';
	@override String get settings_downloads_advanced_title => '引擎与做种';
	@override String get settings_downloads_encryption_title => '节点加密';
	@override String get settings_downloads_open_page_hint => '打开下载页（任务 / 资源 / 订阅）';
	@override String get settings_downloads_routing_hint => '路径映射与目标视频来源';
	@override String get settings_downloads_routing_title => '下载完成后';
	@override String get settings_group_app => '应用';
	@override String get settings_group_connections => '连接';
	@override String get settings_group_content => '内容';
	@override String get settings_group_data => '数据与设备';
	@override String get settings_group_interface => '界面';
	@override String get settings_group_learning => '学习';
	@override String get settings_group_tools => '工具';
	@override String get settings_lookup_ime_language_description => '在查词输入框打字时键盘切到哪种语言。需要系统已安装对应输入法。不影响查词结果。';
	@override String get settings_lookup_ime_language_title => '查词输入法语言';
	@override String get settings_lookup_ime_language_unavailable => '系统里还没有安装这个输入法。';
	@override String get settings_lookup_ime_language_unset => '未设置';
	...
	@override String get settings_section_modules => '功能模块';
	@override String get settings_section_page_turn_input => '翻页与交互';
	@override String get settings_section_reader_chrome => '阅读界面';
	@override String get settings_section_reading_stats => '阅读统计';
	@override String get settings_section_update_channel => '更新通道';
	@override String get settings_service_builtin => '使用内置配置';
	@override String get settings_service_configured => '已配置';
	@override String get settings_service_disabled => '已停用';
	@override String get settings_service_not_configured => '未配置';
	@override String get settings_services_link_subtitle => 'Jimaku、OpenSubtitles、Torznab、Jellyfin、AniDB、TMDB 统一在此配置';
	@override String get settings_study_diag_export => '导出统计诊断日志';
	@override String get settings_study_diag_export_hint => '翻页入账、段开封、有声书恢复与跳页流水，用于排查阅读速度异常。保存为文本文件。';
	@override String get settings_video_diag_export => '导出视频诊断日志';
	@override String get settings_video_diag_export_hint => '统一时间轴 + libmpv 自身的详细日志';
	@override String get settings_video_diag_toggle => '视频 / 查词诊断日志';
	@override String get settings_video_diag_toggle_hint => '记录帧耗时、libmpv 播放统计与查词各阶段耗时。默认关闭；打开后复现卡顿或查词慢，再导出。';
	...
	@override String get shortcut_action_global_context_menu => '打开右键菜单';
	@override String get shortcut_action_global_external_lookup => '应用外查词快捷键';
	@override String get shortcut_action_global_external_open_lookup_page => '唤起主窗并打开查词页';
	@override String get shortcut_action_global_scroll_line_down => '向下滚动一行';
	@override String get shortcut_action_global_scroll_line_up => '向上滚动一行';
	...
	@override String get shortcut_action_global_scroll_to_bottom => '滚动到底部';
	@override String get shortcut_action_global_scroll_to_top => '滚动到顶部';
	...
	@override String get shortcut_action_manga_toggle_chrome => '切换漫画界面';
	@override String get shortcut_action_popup_mine_entry => '制卡（加号）';
	@override String get shortcut_action_popup_next_entry => '下一个词条';
	@override String get shortcut_action_popup_play_audio => '播放单词发音';
	...
	@override String get shortcut_action_reader_open_audiobook => '打开有声书面板';
	@override String get shortcut_action_reader_open_gallery => '打开插图画廊';
	...
	@override String get shortcut_action_reader_open_statistics => '打开阅读统计';
	...
	@override String get shortcut_action_reader_toggle_study_clock => '暂停 / 继续阅读计时';
	...
	@override String get shortcut_action_video_dismiss_dict => '关闭词典';
	...
	@override String get shortcut_action_video_screenshot_subtitled => '截图（含字幕）';
	...
	@override String get shortcut_action_video_toggle_mini_chrome => '切换小窗控件';
	@override String get shortcut_action_video_toggle_mini_window => '切换小窗';
	...
	@override String get shortcut_conflict_keep_both => '两者都保留';
	@override String get shortcut_conflict_keep_both_hint => '两个动作都保留这个绑定，按下时由作用域先后仲裁，先命中的那个生效。';
	...
	@override String get shortcut_lookup_page_escape_minimize => '查词页按返回键最小化窗口';
	@override String get shortcut_lookup_page_escape_minimize_hint => '置顶快捷键唤出查词页后，在查词页按返回键（默认 Esc）把窗口收回去，直接回到之前的程序；查询和结果原样保留。';
	@override String get shortcut_mouse_back => '鼠标侧键(后退)';
	@override String get shortcut_mouse_button => '鼠标按键';
	@override String get shortcut_mouse_button_not_supported => '该动作只接受鼠标侧键（后退/前进）。';
	...
	@override String get srt_import_audio_needs_subtitle => '音频需要配合字幕使用（给现有书籍挂音频请在书架长按该书）';
	...
	@override String get srt_import_hint_epub_or_srt => '选择书籍或字幕文件进行导入。';
	@override String get srt_import_missing_input => '请至少选择书籍或字幕文件';
	...
	@override String get srt_import_pick_epub => '选择书籍文件';
	...
	@override String get stat_center_day_reset_action => '重置时刻';
	@override String get stat_center_day_reset_hour => '「今日」从几点开始';
	@override String get stat_center_day_reset_hour_hint => '这个整点之前的阅读、观看与游戏时长都算作前一天。影响统计里的「今日」与近 N 天；只有改设置之后写入的记录按新边界归日。';
	@override String stat_center_profile_scope({required Object name}) => '仅显示配置「${name}」的统计';
	@override String get stat_center_tab_overview => '总览';
	@override String get stat_center_title => '统计中心';
	...
	@override String get stat_clear_all_overview_message => '确定把阅读、观看、游戏三个域的统计一起清空吗？三个域的时长、字数以及查词 / 制卡计数都会被删除；收藏的词、句子、制卡卡片、游戏库与活动时间线不受影响。此操作不可撤销。';
	...
	@override String get stat_detail_empty => '此时段暂无记录';
	@override String get stat_detail_ungrouped => '未分组';
	...
	@override String get stat_session_delete => '删除会话';
	@override String get stat_session_delete_message => '删除这次会话的时长、字数和页数？收藏的词句不受影响。';
	@override String get stat_session_edit => '编辑会话';
	@override String get stat_session_edit_chars => '字数';
	@override String get stat_session_edit_chars_invalid => '字数必须是 0 或更大的整数。';
	@override String get stat_session_edit_date => '日期';
	@override String get stat_session_edit_date_invalid => '日期请按 YYYY-MM-DD 填写。';
	@override String get stat_session_edit_message => '改日期会把整次会话一起挪过去，一天里的时刻不变；字数会按比例分摊回这次会话的各个片段。';
	@override String get stat_sessions_clear_all => '清除全部会话';
	@override String stat_sessions_clear_all_ack({required Object n}) => '我确认要删除这 ${n} 条会话记录。';
	@override String stat_sessions_clear_all_message({required Object n}) => '确定清除全部 ${n} 条会话记录吗？这些会话的时长、字数、页数都会被清掉；收藏的词句、制卡历史和游戏库不受影响。此操作不可撤销。';
	@override String get stat_sessions_clear_all_title => '清除全部会话记录';
	@override String stat_sessions_count({required Object n}) => '${n} 次会话';
	@override String get stat_sessions_empty => '还没有会话记录';
	@override String get stat_sessions_recent => '最近会话';
	@override String get stat_sessions_show_all => '全部会话';
	...
	@override String get storage_bundled_hint => '随安装包携带，删除后下次更新会自动恢复，此处仅展示。';
	@override String get storage_bundled_section => '随包组件';
	@override String get storage_category_backups => '遗留的备份包';
	@override String get storage_category_books => '书籍与有声书';
	@override String get storage_category_cache => '缓存与临时文件';
	@override String get storage_category_covers => '封面与缩略图';
	@override String get storage_category_custom_fonts => '自定义字体';
	@override String get storage_category_database => '数据库与内部数据';
	@override String get storage_category_dictionaries => '词典';
	@override String get storage_category_exports => '导出文件';
	@override String get storage_category_ocr_models => '漫画 OCR 模型';
	@override String get storage_category_other => '其他未归类';
	@override String get storage_category_shaders => '视频着色器';
	@override String get storage_category_subtitles => '字幕';
	@override String get storage_category_video_downloads => '视频下载';
	@override String get storage_category_web => '网页存档与浏览器数据';
	@override String get storage_dictionary_delete_incomplete => '词典删除未完成、条目仍在，详见错误日志';
	@override String storage_entry_backups_label({required Object n}) => '上次导出遗留的 ${n} 个备份包';
	@override String storage_entry_database_snapshots_label({required Object n}) => '数据库备份快照（${n} 个文件）';
	@override String get storage_entry_delete_backups_confirm_body => '确定清除这些临时本地备份吗？请先确认需要保留的副本已经保存或分享出去。';
	@override String get storage_entry_delete_book_confirm_body => '将从本设备删除这本书的正文、阅读进度与配对音频副本。';
	@override String storage_entry_delete_confirm_title({required Object name}) => '删除「${name}」？';
	@override String get storage_entry_delete_database_snapshots_confirm_body => '将删除全部数据库备份快照残留（corrupt-bak / pre-restore / 旧版本迁移副本）。正在使用的数据库及其 -wal/-shm 侧车不受影响。';
	@override String get storage_entry_delete_dictionary_confirm_body => '将删除该词典及其已导入数据。';
	@override String get storage_entry_delete_done => '已删除';
	@override String storage_entry_delete_failed({required Object reason}) => '删除失败：${reason}';
	@override String get storage_entry_delete_files_confirm_body => '将立即从磁盘删除。媒体库里没有条目引用它——这里放的是缓存、导出或可重新获取的数据。';
	@override String get storage_entry_external_audio_hint => '音频引用原文件，不占用应用空间';
	@override String storage_entry_more_rest({required Object n, required Object size}) => '其余 ${n} 项，共 ${size}';
	@override String get storage_models_components => '模型与组件';
	@override String storage_modules_anime4k_delete_done({required Object n}) => '已删除 ${n} 个着色器文件';
	@override String get storage_modules_anime4k_hint => '可随时在视频设置的画质增强里重新下载';
	@override String get storage_modules_anime4k_title => 'Anime4K 着色器';
	@override String get storage_overview_refresh => '重新扫描';
	@override String get storage_overview_scanning => '扫描中…';
	@override String get storage_overview_section => '磁盘占用';
	@override String get storage_overview_total => '总计';
	@override String get storage_permissions => '请授予以下权限以便导出到 AnkiDroid。';
	@override String get storage_shaders_delete_anime4k => '删除 Anime4K 着色器';
	@override String get stream => '流媒体';
	@override String get study_diag_share_subject => 'Fushi 统计诊断日志';
	@override String get subscription_edit_rule_hint => '来源身份与版本规则不可在此修改；要换版本请重新订阅（历史保留）。';
	@override String get subscription_edit_title => '编辑订阅';
	@override String get subscription_item_status_discovered => '待处理';
	@override String get subscription_item_status_failed => '失败';
	@override String get subscription_item_status_processed => '已入库';
	@override String get subscription_item_status_queued => '排队中';
	@override String get subscription_item_status_skipped => '已跳过';
	@override String get subscription_items_empty => '还没有跟踪到任何发布';
	@override String get subscription_items_empty_ongoing_hint => '追更订阅只处理新发布的单集。如果这部作品已完结，或你是从合集资源建的订阅，请改用一次性下载整包。';
	@override String subscription_last_matched({required Object time}) => '最近命中：${time}';
	@override String get subscription_legacy_badge => '旧版订阅';
	@override String get subscription_legacy_hint => '由旧版本导入，不参与自动检查。';
	@override String get subscription_mode_one_shot => '单次';
	@override String get subscription_mode_ongoing => '追更';
	@override String subscription_next_check({required Object time}) => '下次检查：${time}';
	@override String get subscription_no_match => '没有匹配的订阅';
	@override String get subscription_remote_empty => '主机上没有订阅';
	@override String subscription_remote_provider_unavailable({required Object provider}) => '主机上没有这个资源的索引器（${provider}）';
	@override String subscription_remote_section_title({required Object device}) => '${device} 上的订阅';
	@override String get subscription_remote_unsupported => '主机未配置下载后端';
	@override String get subscription_run_local => '本机';
	@override String get subscription_run_location => '运行位置';
	@override String subscription_run_remote({required Object device}) => '主机 ${device}';
	@override String get subscription_search_hint => '搜索订阅';
	@override String get subscription_show_items => '逐集状态';
	@override String get subscription_sort_created => '添加时间';
	@override String get subscription_sort_last_checked => '最近检查';
	@override String get subscription_sort_last_matched => '最近命中';
	@override String get subtitle_version_ai_translated => '机翻';
	...
	@override String get subtitle_version_show_files => '展开文件';
	@override String subtitle_version_unnumbered_count({required Object n}) => '${n} 个未编号';
	@override String get subtitle_version_view_files => '文件视图';
	@override String get swipe_page_turn_sensitivity => '滑动翻页灵敏度';
	@override String get sync_account => '账户';
	@override String get sync_asset_dictionary => '词典';
	@override String get sync_asset_dictionary_download => '下载词典';
	@override String get sync_asset_dictionary_upload => '上传词典';
	@override String get sync_asset_download_action => '下载';
	@override String get sync_asset_download_hint => '把远端有、本机没有的取回来（含你在本机删掉过的）。';
	@override String get sync_asset_legacy_notice_body => '这台设备原先开着词典与本地音频数据库的自动同步。该开关已移除——需要传输时请用下面的上传 / 下载。已有数据不受影响，但新导入的词典不会再自动备份。';
	@override String get sync_asset_legacy_notice_dismiss => '知道了';
	@override String get sync_asset_legacy_notice_title => '词典与本地音频改为手动传输';
	@override String get sync_asset_local_audio => '本地音频数据库';
	@override String get sync_asset_local_audio_download => '下载本地音频数据库';
	@override String get sync_asset_local_audio_upload => '上传本地音频数据库';
	@override String get sync_asset_transfer_hint => '上传本机独有的，或下载远端独有的';
	@override String get sync_asset_transfer_menu => '传输';
	@override String get sync_asset_upload_action => '上传';
	@override String get sync_asset_upload_hint => '把本机有、远端没有的推送过去。包可能很大。';
	...
	@override String get sync_compare_only_conflicts => '只看冲突';
	...
	@override String get sync_desktop_oauth_browser_open_failed => '无法打开浏览器。请复制链接，自行在浏览器中打开。';
	@override String get sync_desktop_oauth_browser_reopen => '重新打开浏览器';
	@override String get sync_desktop_oauth_link_copy => '复制登录链接';
	@override String get sync_desktop_oauth_link_copy_failed => '复制失败。请手动选中链接文本后复制。';
	@override String get sync_desktop_oauth_waiting_body => '已在默认浏览器打开登录页。如果没有打开，或页面显示错误，可复制链接到其他浏览器或无痕窗口打开。';
	@override String get sync_desktop_oauth_waiting_title => '正在等待浏览器完成登录';
	...
	@override String get sync_err_html_page => '服务器返回的是网页而不是同步响应。请确认地址指向的是 WebDAV 或 Fushi 互联端点，而不是网站。';
	@override String sync_err_html_page_detail({required Object title}) => '服务器返回的是网页（「${title}」）而不是同步响应。请确认地址指向的是 WebDAV 或 Fushi 互联端点，而不是网站。';
	...
	@override String get sync_err_not_paired => '尚未配对任何设备，请先在「Fushi 互联」里完成配对。';
	@override String get sync_err_pairing_rejected => '对方设备已拒绝本机的配对凭据，请重新配对后再同步。';
	@override String get sync_err_peer_unreachable => '无法连接 Fushi 互联服务端——对方可能不在线，或未运行 Fushi。';
	@override String get sync_err_quota => '云端存储空间已满（配额已用尽）。';
	@override String get sync_err_scope_upgrade => '同步权限已更新，请重新登录 Google 账号以继续同步。';
	@override String get sync_err_sign_in_cancelled => '已取消登录。';
	...
	@override String get sync_interconnect_service_config_toggle => '同步主机服务配置';
	@override String get sync_interconnect_service_config_toggle_desc => '经加密互联通道接收 Fushi 互联服务端的外部服务设定与 API key（Jimaku、TMDB、Torznab、OpenSubtitles、追番）。需启用 TLS。';
	...
	@override String get sync_pair_invalid_url => '地址格式无效';
	@override String get sync_pair_not_fushi => '此地址未找到 Fushi 设备，已保存该地址。';
	@override String get sync_pair_not_fushi_discovered => '此地址未找到 Fushi 设备。';
	@override String get sync_pair_pairing => '正在配对…';
	@override String get sync_pair_peer_not_https => '对端在该端口未启用 HTTPS，请改用 http:// 开头的地址。';
	@override String get sync_pair_peer_requires_https => '该设备只接受 HTTPS，请改用 https:// 开头的地址。';
	...
	@override String sync_peer_book_delete_confirm({required Object name}) => '确定从对端设备删除「${name}」吗？对端上的文件与阅读进度会被永久删除，本机没有副本，此操作不可撤销。';
	@override String sync_peer_video_delete_confirm({required Object name}) => '确定从对端设备的媒体库移除「${name}」吗？对端自己导入的视频文件会保留，此操作不可撤销。';
	@override String get sync_port => '端口';
	@override String get sync_private_key => '私钥';
	@override String get sync_progress_asset_transfer => '准备传输';
	...
	@override String get sync_section_assets => '词典与本地音频传输';
	...
	@override String get sync_section_when => '何时同步';
	...
	@override String get sync_server_settings => '服务器设置';
	@override String get sync_server_settings_hint => '当前同步方式的凭据与连接测试';
	...
	@override String get sync_show_remote_entries_warning => '把 Fushi 互联服务端或云端有、本机没有的书籍和视频显示为可下载/流播的占位卡。';
	...
	@override String get theme_accent_auto_tone => '按明暗模式自动调整色调';
	@override String get theme_accent_auto_tone_desc => '关闭：直接使用所选原色。开启：为浅色/深色模式各自生成色调，实际显示会与所选不同';
	@override String get theme_accent_follow_system => '主题色跟随系统取色';
	@override String get theme_accent_follow_system_desc => 'Android 用壁纸取色（Material You），桌面用系统强调色，代替手动选的主题色';
	@override String get theme_accent_follow_system_unavailable => '当前设备没有提供系统取色';
	@override String get theme_accent_low_contrast_dark => '在深色模式背景上不易辨认，建议换个更亮的颜色';
	@override String get theme_accent_low_contrast_light => '在浅色模式背景上不易辨认，建议换个更深的颜色';
	@override String get theme_ai_applied => 'AI 建议已填进编辑器，看过预览后再应用。';
	@override String get theme_ai_hint => '描述想要的主题，例如：暖色纸张阅读风格，主题色深绿';
	@override String get theme_ai_undo => '撤销 AI 改动';
	...
	@override String get theme_neutral_derived => '派生色用中性灰';
	@override String get theme_neutral_derived_desc => '标签、选中项、菜单与表面不带主题色相，只留主题色本身作强调（类似 Windows 亮色主题）。主题色选白/灰/黑时自动生效';
	@override String get theme_preview_button => '按钮';
	@override String get theme_preview_card => '卡片';
	@override String get theme_preview_dark => '深色';
	@override String get theme_preview_hint => '点任一颜色，预览里会框出它影响的位置';
	@override String get theme_preview_light => '浅色';
	@override String get theme_preview_tag => '标签';
	@override String get theme_role_accent => '主题色';
	@override String get theme_role_accent_desc => '按钮、开关、图标、进度条直接使用所选原色；其余颜色都由它自动生成';
	@override String get theme_role_actual_color => '实际显示';
	@override String get theme_role_audio_highlight => '当前句高亮';
	@override String get theme_role_audio_highlight_desc => '有声书播放时跟随当前句；对所有主题生效，不限于本主题';
	@override String get theme_role_container => '控件底色';
	@override String get theme_role_container_desc => '开关轨道、悬浮按钮与播放条';
	@override String get theme_role_follows_theme => '跟随主题';
	@override String get theme_role_link => '链接';
	@override String get theme_role_link_desc => '书内超链接与选区拖拽手柄';
	@override String get theme_role_reader_background => '页面背景';
	@override String get theme_role_reader_background_desc => '阅读器页面、工具栏与词典弹窗背景';
	@override String get theme_role_reader_text => '正文文字';
	@override String get theme_role_reader_text_desc => '阅读器正文、工具栏图标与词典弹窗文字';
	@override String get theme_role_reset => '恢复跟随主题';
	@override String get theme_role_secondary => '次要强调色';
	@override String get theme_role_secondary_desc => '标签、徽章与选中的列表项';
	@override String get theme_role_selection => '查词高亮';
	@override String get theme_role_selection_desc => '查词时选中文字的底色';
	@override String get theme_role_surface => '界面背景';
	@override String get theme_role_surface_desc => '页面、卡片、菜单的底色；其余层级由它推出微弱深浅';
	@override String get theme_role_tertiary => '点缀色';
	@override String get theme_role_tertiary_desc => '合集与阅读统计';
	@override String get theme_section_accent => '界面配色';
	@override String get theme_section_audiobook => '有声书';
	@override String get theme_section_fine_tune => '微调派生色';
	@override String get theme_section_reader => '阅读器';
	...
	@override String get update_download_source_auto => '自动（推荐）';
	@override String get update_download_source_cloudflare => 'Cloudflare 镜像';
	@override String get update_download_source_github => 'GitHub 直连';
	@override String get update_download_source_preference => '首选下载源';
	@override String get update_download_source_preference_hint => '优先尝试所选来源；不可用时仍会自动回退到其他来源。';
	@override String update_download_source_proxy({required Object host}) => '代理站：${host}';
	@override String update_download_source_unavailable({required Object source}) => '${source} 不适用于该文件，已回退到自动顺序';
	...
	@override String get updates_center_empty => '暂无更新';
	@override String get updates_center_empty_hint => '订阅的番剧新集、漫画新章、扩展与应用新版本都会出现在这里。';
	@override String get updates_center_title => '更新';
	@override String get updates_check_now => '立即检查更新';
	@override String get updates_checking => '检查中…';
	@override String get updates_filter_all => '全部';
	@override String get updates_kind_app_release => '应用新版';
	@override String get updates_kind_manga_chapter => '漫画新章';
	@override String get updates_kind_manga_extension => '漫画扩展';
	@override String get updates_kind_video_episode => '番剧新集';
	@override String get updates_mark_all_seen => '全部标为已读';
	@override String get updates_notification_header => '订阅更新';
	@override String get updates_notification_open_app_release => '下载';
	@override String get updates_notification_open_manga_chapter => '阅读';
	@override String get updates_notification_open_manga_extension => '更新';
	@override String get updates_notification_open_video_episode => '播放';
	@override String updates_notification_summary({required Object first, required Object count}) => '${first} 等 ${count} 项';
	@override String get updates_notification_view_all => '查看更新';
	@override String get updates_notify_app_release => '应用新版提醒';
	@override String get updates_notify_app_release_hint => '有更新的 Fushi 版本时提醒。';
	@override String get updates_notify_manga_chapter => '漫画新章提醒';
	@override String get updates_notify_manga_chapter_hint => '后台检查已追的在线漫画有没有新章。';
	@override String get updates_notify_manga_extension => '漫画扩展更新提醒';
	@override String get updates_notify_manga_extension_hint => '已装扩展在仓库里有更高版本时提醒。';
	@override String get updates_notify_section => '更新提醒';
	@override String get updates_notify_video_episode => '番剧新集提醒';
	@override String get updates_notify_video_episode_hint => '订阅的番剧下载好新集时提醒。';
	@override String get updates_system_notifications => '系统通知';
	@override String get updates_system_notifications_hint => '同时发送系统通知。关掉后仍保留应用内红点。';
	...
	@override String get video_ajatt_enabled_hint => '关闭后搜索字幕时跳过 AJATT 字幕库。';
	@override String get video_ajatt_settings_hint => '免费日语字幕库（kitsunekko 镜像）。无需账号；字幕文件从 GitHub 下载。';
	@override String get video_all_videos_grid_view => '网格视图';
	@override String get video_all_videos_list_view => '列表视图';
	@override String get video_anidb_hash_enabled => '通过 AniDB ED2K 识别文件';
	@override String get video_anidb_hash_hint => '需要 AniDB 账号和已注册客户端，仅提交文件大小与哈希。AniDB UDP 登录未加密，请仅在可信网络下开启。';
	@override String get video_anidb_login_test => '测试 AniDB 登录';
	@override String video_anidb_login_test_client_update({required Object client}) => 'AniDB 登录成功，但 AniDB 提示客户端 ${client} 有新版本';
	@override String get video_anidb_login_test_failed_auth => 'AniDB 拒绝了用户名或密码';
	@override String get video_anidb_login_test_failed_backoff => 'AniDB 连续无应答，正在退避，请稍后再试';
	@override String get video_anidb_login_test_failed_blocked => 'AniDB 当前限流或维护，请求已暂停，请稍后再试';
	@override String get video_anidb_login_test_failed_client => 'AniDB 拒绝了客户端名称/版本（未注册、已过期或被封禁）';
	@override String get video_anidb_login_test_failed_network => 'AniDB UDP 连接失败：请检查 UDP 9000 端口与防火墙；HTTP 代理不能承载 UDP';
	@override String video_anidb_login_test_failed_other({required Object reason}) => 'AniDB 登录失败（${reason}）';
	@override String get video_anidb_login_test_hint => '用已保存的账号与客户端发一次 UDP 登录后立即登出，不计算任何文件哈希。';
	@override String get video_anidb_login_test_incomplete => '未测试：请先填写用户名、密码及已注册的客户端名称/版本';
	@override String get video_anidb_login_test_running => '正在测试 AniDB 登录…';
	@override String video_anidb_login_test_success({required Object client, required Object version}) => 'AniDB 登录成功（客户端 ${client} v${version}）';
	@override String get video_anidb_password => 'AniDB 密码';
	@override String get video_anidb_username => 'AniDB 用户名';
	@override String get video_anilist_error_api_disabled => 'AniList 官方因服务器稳定性问题暂时停用了公开 API。这不是你的网络或代理的问题——请求已经打到 AniList 并被它当面拒绝了。请稍后再试。';
	@override String get video_anilist_error_rate_limited => 'AniList 正在对本应用限流。稍等一会儿再重试。';
	@override String get video_anilist_error_unreachable => '连不上 AniList（graphql.anilist.co）。请检查网络连接，或在下载设置中配置代理。';
	...
	@override String get video_builtin_apibay_hint => '电影与剧集。公共索引，无需账号。';
	@override String get video_builtin_knaben_hint => '电影与剧集。聚合多家公共索引器。';
	@override String get video_builtin_nyaa_hint => '仅动漫。电影与剧集由下面两个公共索引器覆盖。';
	@override String get video_builtin_sources_hint => '随应用内置：无需账号，无需 API key。关闭后该来源不再参与资源搜索。';
	@override String get video_builtin_sources_title => '内置来源';
	...
	@override String video_clip_export_share_unavailable({required Object path}) => '片段已保存，但系统分享面板没有打开：${path}';
	...
	@override String video_control_custom_action({required Object index}) => '快捷键 ${index}';
	@override String get video_control_custom_action_none => '不绑定';
	...
	@override String get video_diag_share_subject => 'Fushi 视频诊断日志';
	@override String get video_discovery_all_works => '全部作品';
	@override String get video_discovery_anidb_identity_confirm_hint => 'AniDB 上有多个可能的匹配。选中正确的作品后，下载导入将直接按该身份刮削；跳过则可稍后在待确认列表手动指定。';
	@override String get video_discovery_anidb_identity_confirm_title => '确认作品身份';
	@override String get video_discovery_anidb_identity_not_found => '未能在 AniDB 识别该作品：仍会正常下载，导入后在待确认列表等待手动指定身份。';
	@override String video_discovery_cancel_downloads_body({required Object n}) => '本作品有 ${n} 个下载任务会被停止。已下载的分片仍保留在磁盘上，之后可以重新开始下载。';
	@override String get video_discovery_cancel_downloads_failed => '取消下载失败。任务可能已经结束，或下载后端当前不可用。';
	@override String get video_discovery_cancel_downloads_title => '取消下载？';
	...
	@override String get video_discovery_provider_failed => '部分来源暂时请求失败，已显示其余结果';
	@override String get video_discovery_provider_rate_limited => '部分来源请求过于频繁，已显示其余结果';
	...
	@override String get video_download_target_source_title => '默认文件夹';
	...
	@override String get video_extensions_title => '视频源扩展';
	...
	@override String get video_filter_series_in => '系列内';
	...
	@override String get video_import_folder_as_source_hint => '以后自动扫描此文件夹里的新视频';
	...
	@override String get video_jimaku_enabled_hint => '关闭后即使已填 API key 也不再搜索 Jimaku。';
	...
	@override String get video_jimaku_language_follow_video => '跟随视频语言';
	...
	@override String get video_jimaku_scope_hint => '为动漫与日语真人影视提供日语字幕。需要免费 API key。';
	@override String get video_jimaku_search => '搜索';
	@override String get video_jimaku_search_failed => '字幕搜索失败';
	@override String get video_jimaku_series => '系列';
	@override String get video_jimaku_series_lookup_degraded => '这次没能在 AniList 上确认系列，下面是按标题直接搜出来的结果，可能混入同系列其他季。';
	...
	@override String get video_library_media_servers => '媒体服务器';
	@override String get video_library_scrape_auto_backfill => '自动补齐缺失的作品资料';
	@override String get video_library_scrape_auto_backfill_hint => '进入视频库时，自动刮削仍未确认身份的条目。关闭后不再有任何后台元数据下载。';
	@override String video_library_scrape_pending_banner({required Object count}) => '${count} 部作品还没确认身份，资料和封面都没刮出来';
	@override String get video_library_scrape_pending_banner_action => '去确认';
	...
	@override String get video_load_failed_not_opened => '播放器打不开该视频。文件可能被占用，或播放引擎需要重启应用后才能恢复。';
	...
	@override String get video_metadata_download_staff_images => '下载演职员头像';
	@override String get video_metadata_download_staff_images_hint => '刮削时把演职员头像存到本地（每部作品最多 10 张）；关闭时按需从 TMDB 加载。';
	@override String get video_metadata_identifier_words => '识别词';
	@override String get video_metadata_identifier_words_empty => '未配置';
	@override String get video_metadata_identifier_words_hint => '识别前先改写、屏蔽标题或偏移集号';
	@override String get video_metadata_identifier_words_invalid => '无效规则';
	@override String get video_metadata_identifier_words_syntax => '一行一条规则，# 开头是注释。屏蔽：直接写正则。替换：A => B。集偏移：前 <> 后 >> EP+1。组合：A => B && 前 <> 后 >> EP+1。';
	@override String get video_metadata_image_limit_hint => '0 = 不限。按资料语言 → 原语 → 英文 → 无字图的顺序保留评分最高的几张。';
	@override String get video_metadata_max_backdrops => '每部作品保留的背景图数';
	@override String get video_metadata_max_covers => '每部作品保留的封面数';
	@override String get video_metadata_max_logos => '每部作品保留的 Logo 数';
	@override String get video_metadata_primary_provider => '主资料源';
	@override String get video_metadata_primary_provider_hint => '主源没有唯一精确命中或不可用时，自动用另一个源兜底。';
	@override String get video_metadata_provider_anidb => 'AniDB（哈希身份 + 作品 XML）';
	@override String get video_metadata_provider_mal => 'MAL（经 Jikan）';
	@override String get video_metadata_provider_tmdb => 'TMDB';
	@override String get video_mini_window_exit => '退出小窗';
	...
	@override String get video_mining_image_mode_video_clip => '带声音的视频片段';
	@override String get video_mining_image_mode_video_clip_hint => '将画面与例句声音导出为同一个 MP4，由 Anki 媒体播放器同步播放；自动播放遵循卡片设置。不同客户端可能在独立播放器中打开。';
	...
	@override String get video_online_episodes_empty => '没有找到剧集。';
	@override String get video_online_episodes_title => '剧集';
	@override String get video_online_services_setup_description => '按需配置账号或 API 密钥，可增强文件识别和字幕搜索。基础播放不受影响。';
	@override String get video_online_services_setup_dismiss => '永久关闭提示';
	@override String get video_online_services_setup_register => '了解和注册服务';
	@override String get video_online_services_setup_settings => '去设置';
	@override String get video_online_services_setup_title => '配置可选在线服务';
	@override String get video_online_sources_empty => '没有已启用的视频源。请先安装并启用视频扩展。';
	@override String get video_online_sources_hint => '第三方 Aniyomi 扩展（extensions-lib 14）。内容来自各扩展对应的站点，在内置播放器中播放。';
	@override String get video_online_stream_none => '该集没有可播放的流。';
	@override String get video_opensubtitles_app_key_hint => '留空使用应用内置 API 密钥。';
	...
	@override String get video_opensubtitles_settings_hint => 'API 凭据绝不随备份导出；可随互联同步到已配对设备（可在互联设置中关闭）。';
	...
	@override String video_quality_auto_lowered({required Object label}) => '网络较慢，画质已降到 ${label}';
	@override String video_quality_auto_raised({required Object label}) => '网络变好，画质已提到 ${label}';
	...
	@override String get video_resource_identity_provider => '资源身份来源';
	...
	@override String get video_resource_no_provider_hint => '本次搜索没有可用的来源。请到 设置 → 下载 → 外部资源与字幕来源 重新启用内置来源，或添加 Torznab 索引器。';
	@override String get video_resource_no_provider_title => '未配置资源索引器';
	@override String get video_resource_relink_success => '已重新链接视频文件';
	@override String video_scrape_ai_confidence({required Object percent}) => 'AI 置信度 ${percent}%';
	@override String get video_scrape_ai_matched => 'AI 判定';
	...
	@override String get video_scrape_view_source => '查看来源详情';
	@override String get video_screenshot => '截图';
	@override String get video_screenshot_clipboard_unsupported => '当前平台不支持复制图片到剪贴板';
	@override String get video_screenshot_copied => '截图已复制到剪贴板';
	@override String get video_screenshot_destination_ask => '每次询问';
	@override String get video_screenshot_destination_clipboard => '复制到剪贴板';
	@override String get video_screenshot_destination_directory => '保存到目录';
	@override String get video_screenshot_directory_not_set => '未设置';
	@override String get video_screenshot_directory_unset => '尚未设置截图保存目录';
	...
	@override String get video_screenshot_subtitled => '带字幕截图';
	@override String get video_search_ai_expand => 'AI 补充搜索词';
	@override String video_search_ai_expanded({required Object count}) => 'AI 补充了 ${count} 个搜索词';
	@override String get video_search_ai_rank => 'AI 排序';
	@override String get video_search_ai_ranked => '结果已由 AI 重新排序';
	@override String get video_search_ai_recommended => 'AI 推荐';
	...
	@override String get video_setting_auto_scrape_hint => '媒体库扫描后自动识别并获取视频元数据';
	...
	@override String get video_setting_clip_export_video_bitrate => '片段导出视频码率';
	@override String get video_setting_clip_export_video_bitrate_hint => '0 = 跟随源（能直接复制码流就不重编码）；其它值会把视频重编码到该码率';
	...
	@override String get video_setting_hdr_auto => '自动';
	@override String get video_setting_hdr_compute_peak => '动态峰值检测';
	@override String get video_setting_hdr_compute_peak_hint => '逐帧测量真实峰值亮度，而不是相信片源元数据。高光更准，但会占一点 GPU。';
	@override String get video_setting_hdr_off => '关';
	@override String get video_setting_hdr_on => '开';
	@override String get video_setting_hdr_output => 'HDR / 10-bit 输出';
	@override String get video_setting_hdr_output_always => '始终';
	@override String get video_setting_hdr_output_auto => '自动';
	@override String get video_setting_hdr_output_hint => '仅 Windows。自动：显示器开着 HDR 且片源是 HDR 时经原生视频窗口直通；始终：所有视频都走原生窗口（10-bit 输出）；关闭：沿用常规渲染。';
	@override String get video_setting_hdr_output_off => '关闭';
	@override String get video_setting_hdr_tone_mapping => 'HDR 色调映射';
	@override String get video_setting_hdr_tone_mapping_hint => '把 HDR 片源压到 SDR 屏幕上时用的曲线。自动 = 交给 mpv 按片源挑。';
	...
	@override String get video_setting_jimaku_default_language_hint => '默认跟随视频自身的语言（音轨 / 刮削元数据）。选定某个语言则始终优先它。';
	...
	@override String get video_setting_mpv_lua_scripts => '加载 Lua 脚本';
	@override String get video_setting_mpv_lua_scripts_dir_copied => '已复制目录路径';
	@override String get video_setting_mpv_lua_scripts_dir_copy => '复制脚本目录路径';
	@override String get video_setting_mpv_lua_scripts_empty => 'mpv_scripts 目录里还没有脚本';
	@override String get video_setting_mpv_lua_scripts_hint => '装载 mpv_scripts 目录里的全部 .lua 脚本。关闭在下次打开视频时生效。';
	@override String get video_setting_mpv_lua_scripts_import => '导入 Lua 脚本';
	@override String get video_setting_mpv_lua_scripts_imported => '脚本已导入';
	@override String get video_setting_mpv_lua_scripts_input_note => '键盘/鼠标输入由应用层处理、不会到达 mpv：依赖按键绑定或 OSC 的脚本无法触发；监听属性/事件的脚本与 OSD 提示可用。';
	@override String get video_setting_mpv_lua_scripts_status_error => '报错';
	@override String get video_setting_mpv_lua_scripts_status_loaded => '已装载，无报错';
	@override String get video_setting_mpv_lua_scripts_status_not_loaded => '本次播放未装载（开启开关或重新打开视频）';
	@override String get video_setting_mpv_lua_scripts_unavailable => '本平台随包 libmpv 未编入 Lua（-Dlua=disabled），脚本在此无法运行。';
	...
	@override String get video_setting_screenshot_destination => '截图去向';
	@override String get video_setting_screenshot_destination_hint => '截图后是弹保存对话框、复制到剪贴板，还是直接存进指定目录';
	@override String get video_setting_screenshot_directory => '截图保存目录';
	@override String get video_setting_screenshot_directory_hint => '选择「保存到目录」时截图落在这里';
	...
	@override String get video_setting_slim_progress_bar => '底部细进度条';
	@override String get video_setting_slim_progress_bar_hint => '控制条淡出后，在视频最下方保留一条主题色细进度条。小窗模式下它恒常显示——那里完整进度条已被收起。';
	...
	@override String get video_setting_subtitle_backfill => '刮削后自动补字幕';
	@override String get video_setting_subtitle_backfill_hint => '刮削完成后，仍然没有字幕的视频会自动从已配置的在线字幕来源取一条。绝不覆盖已有字幕。';
	...
	@override String get video_setting_subtitle_obscure_reveal => '暂停或悬停时显形';
	@override String get video_setting_subtitle_obscure_reveal_hint => '字幕处于模糊或隐藏时，暂停、查词、桌面悬停或移动端点击可临时显形；关掉后遮蔽始终保持，暂停也不会露出来。';
	...
	@override String get video_setting_subtitle_sources_section => '在线字幕来源';
	@override String get video_setting_subtitle_sync_input => '偏移 (ms)';
	@override String get video_setting_subtitle_text_color => '文字颜色';
	@override String get video_setting_tap_toggles_playback => '点击画面播放/暂停';
	@override String get video_setting_tap_toggles_playback_hint => '关闭后点击画面只唤醒控制条，不再切换播放/暂停';
	...
	@override String get video_setting_youtube_quality => 'YouTube 画质';
	@override String get video_setting_youtube_quality_hint => '起播自动选不超过目标的最高档；「自动」优先流畅（硬解友好编码，最高 1080p）';
	...
	@override String get video_shader_mobile_perf_hint => '手机上的中/高/极高档使用「只去模糊、不放大」的 Anime4K 链：放大 pass 已移除——屏幕不比片源更大，放大收益有限却会占满 GPU，连带整个 app 变卡。实际效果仍因机型 GPU 而异，掉帧或发热就往下退一档。';
	...
	@override String get video_shader_tier_high_hint_mobile => 'Anime4K 去模糊（M），在片源原分辨率上跑。kernel 比「中」更大，同样不含放大 pass。适合较快的手机 GPU。';
	...
	@override String get video_shader_tier_low_hint_mobile => 'mpv 内置锐化（手机上为 spline36）。无需下载，不增加任何 GPU pass。上面几档掉帧时退回这一档最稳。';
	...
	@override String get video_shader_tier_medium_hint_mobile => 'Anime4K 去模糊（S），在片源原分辨率上跑。不含放大 pass，开销不随屏幕分辨率增长。手机建议从这一档开始。';
	...
	@override String get video_shader_tier_ultra_hint_mobile => 'Anime4K 去模糊（M）加一道柔化修复，均在片源原分辨率上跑。手机端最强档，仍不含放大 pass。掉帧就往下退一档。';
	@override String get video_shader_url_hint => '粘贴着色器 .glsl 链接（如 GitHub）';
	@override String get video_shaders_empty => '还没有导入着色器';
	@override String get video_source_grouping_change_hint => '下次扫描使用此设置，已有合集和资料会保留。';
	@override String get video_source_grouping_folder => '按文件夹';
	@override String get video_source_grouping_folder_hint => '每个一级子文件夹创建一个合集，根目录中的视频归入根合集。此模式仅整理视频，不刮削作品资料；如需刮削，请切换为按作品。';
	@override String get video_source_grouping_mode => '视频分组方式';
	@override String get video_source_grouping_series => '按作品';
	@override String get video_source_grouping_series_hint => '按文件名识别作品与分集，再匹配作品资料。';
	@override String get video_source_scrape_action => '刮削此来源';
	@override String get video_source_scrape_anidb_client => 'AniDB 客户端名称';
	@override String get video_source_scrape_anidb_client_hint => 'Fushi 已内置注册的应用客户端，通常留空即可；仅按需填写自定义注册客户端。';
	@override String get video_source_scrape_anidb_client_version => 'AniDB 客户端版本';
	@override String get video_source_scrape_anidb_client_version_hint => '仅自定义客户端需要在此填写其注册版本。默认应用身份由 Fushi 维护，个人 AniDB 登录仍需自行配置。';
	...
	@override String get video_source_scrape_background_hint => '关闭窗口后，任务会继续在后台执行。';
	@override String get video_source_scrape_background_started => '刮削已在后台开始';
	@override String get video_source_scrape_clear_all => '清理全部刮削记录';
	@override String get video_source_scrape_clear_all_busy => '视频扫描或刮削仍在运行，请等待任务结束后重试。';
	@override String get video_source_scrape_clear_all_completed => '已清理全部视频刮削记录。';
	@override String get video_source_scrape_clear_all_completed_protected => '刮削记录已清理；被修改或无法验证的旁车文件已保留。';
	@override String get video_source_scrape_clear_all_confirm_action => '清理';
	@override String get video_source_scrape_clear_all_confirm_body => '这会清除全部视频刮削资料和来源绑定、清空“系列”结果，并删除 Fushi 生成且未被修改的封面与 NFO。视频文件、媒体库条目、底层分组、观看进度、字幕、标签、手动选择的封面及用户修改过的旁车文件都会保留。此操作无法撤销。';
	@override String get video_source_scrape_clear_all_confirm_title => '清理全部视频刮削记录？';
	@override String get video_source_scrape_clear_all_failed => '未能清理全部刮削记录；未删除任何无法验证的用户文件。';
	@override String get video_source_scrape_clear_all_hint => '清除全部视频刮削资料，以及 Fushi 生成的封面和 NFO。';
	@override String get video_source_scrape_clear_all_in_progress => '正在清理刮削记录，请稍候。';
	...
	@override String get video_source_scrape_enabled_toggle => '启用此来源的刮削';
	@override String get video_source_scrape_enabled_toggle_hint => '关闭后：手动、扫描后、下载导入后与后台自动补刮都会跳过此来源。';
	...
	@override String get video_source_scrape_list_load_failed => '列表加载失败，请重试。';
	@override String get video_source_scrape_list_reload => '重新加载';
	@override String get video_source_scrape_locale => '资料语言';
	@override String get video_source_scrape_locale_follow_ui => '留空 = 跟随界面语言';
	@override String get video_source_scrape_locale_hint => 'TMDB 兜底及补充资料的首选语言；MAL 使用其提供的标题和原始文本。';
	@override String get video_source_scrape_manual_ambiguous => '存在多个同名作品。请打开待确认页，选择具体条目进行匹配。';
	@override String get video_source_scrape_manual_by_id => '按作品 ID';
	@override String get video_source_scrape_manual_by_title => '按标题';
	@override String get video_source_scrape_manual_current_work => '当前作品';
	@override String get video_source_scrape_manual_id_invalid => '请输入正整数作品 ID，或与所选来源及类型一致的官方链接。';
	@override String get video_source_scrape_manual_query_hint => '按标题搜索，或选择 MAL、TMDB 电影、TMDB 电视剧并输入 ID 或官方链接。选择结果后才会应用到当前作品。';
	@override String get video_source_scrape_manual_search_action => '搜索';
	@override String get video_source_scrape_manual_search_empty => '没有搜索结果';
	@override String get video_source_scrape_manual_search_hint => '按标题搜索资料源，然后选中正确的作品。';
	@override String get video_source_scrape_manual_search_title => '手动指定作品';
	@override String get video_source_scrape_manual_tmdb_movie => 'TMDB 电影';
	@override String get video_source_scrape_manual_tmdb_tv => 'TMDB 电视剧';
	@override String get video_source_scrape_metadata_locale => '资料语言';
	@override String get video_source_scrape_metadata_locale_hint => 'BCP-47 语言标签，如 ja 或 zh-CN。留空 = 跟随全局资料语言。';
	@override String get video_source_scrape_nfo_policy => 'NFO 写入策略';
	@override String get video_source_scrape_pending_empty => '没有需要手动匹配的作品。';
	@override String get video_source_scrape_pending_tab => '待确认';
	@override String get video_source_scrape_pending_works => '待确认作品';
	@override String get video_source_scrape_pending_works_hint => '这些条目还没有确认的作品身份。搜索并选中正确的作品即可完成刮削。';
	...
	@override String get video_source_scrape_provider_follow_global => '跟随全局默认';
	@override String get video_source_scrape_provider_policy => 'MAL（经 Jikan）为主要资料源，TMDB 兜底。';
	@override String get video_source_scrape_queue_cancel_all => '取消全部任务';
	@override String get video_source_scrape_queue_remove => '撤回此任务';
	@override String get video_source_scrape_queue_submitted => '已加入队列';
	@override String get video_source_scrape_queue_waiting => '排队中';
	@override String get video_source_scrape_rescrape_source => '重新刮削此来源';
	@override String get video_source_scrape_run_detail_title => '刮削结果';
	@override String get video_source_scrape_run_no_issues => '本次刮削没有记录警告或错误。';
	...
	@override String get video_source_scrape_work_missing => '该作品已不在当前来源计划中（文件可能已改名、移动或删除）。请重新刮削此来源刷新待确认列表。';
	@override String get video_source_scrape_write_images => '写入图片文件';
	@override String get video_source_scrape_write_nfo => '写入 NFO 文件';
	@override String get video_specs_audio_tracks => '音轨';
	@override String get video_specs_bit_depth => '色深';
	@override String get video_specs_bitrate => '码率';
	@override String get video_specs_dynamic_range => '动态范围';
	@override String get video_specs_frame_rate => '帧率';
	@override String get video_specs_resolution => '清晰度';
	@override String get video_specs_subtitle_tracks => '字幕轨';
	@override String get video_specs_title => '媒体信息';
	@override String get video_specs_track_commentary => '评论音轨';
	@override String get video_specs_track_default => '默认';
	@override String get video_specs_track_forced => '强制';
	@override String get video_specs_video_codec => '视频编码';
	...
	@override String get video_subdl_api_key_hint => '在 subdl.com/panel/api 免费获取 API key';
	@override String get video_subdl_enabled_hint => '关闭后即使已填 API key 也不再搜索 SubDL。';
	@override String get video_subdl_settings_hint => '为电影与剧集提供英文及多语种字幕，按 IMDb / TMDB id 匹配。需要免费 API key；下载按 IP 计匿名每日额度。';
	...
	@override String get video_subtitle_adjust_expand => '展开';
	@override String get video_subtitle_adjust_title => '字幕调整';
	...
	@override String get video_subtitle_collection_language => '默认字幕语言';
	@override String get video_subtitle_collection_language_hint => '对本合集所有集生效；留空 = 跟随视频自身语言。';
	@override String get video_subtitle_collection_members_hint => '各集按文件名里的集号匹配；整季打包字幕自动拆分。';
	...
	@override String get video_subtitle_collection_release_group_hint => '批量下载优先选这个版本，整季共用一套时间轴。';
	@override String get video_subtitle_collection_settings => '合集字幕设置';
	...
	@override String get video_subtitle_delete => '删除字幕文件';
	@override String video_subtitle_delete_confirm({required Object path}) => '确定从磁盘删除这个字幕文件？此操作不可撤销。\n${path}';
	@override String video_subtitle_delete_failed({required Object label}) => '删除字幕文件失败：${label}';
	@override String video_subtitle_deleted({required Object label}) => '已删除字幕文件：${label}';
	...
	@override String get video_subtitle_list_export_favorites => '导出收藏语句';
	...
	@override String get video_subtitle_list_search_empty => '没有匹配的台词';
	@override String get video_subtitle_list_search_hint => '输入以筛选台词';
	@override String video_subtitle_load_failed({required Object label}) => '无法加载该字幕（可能是图形或不支持的字幕轨）：${label}';
	@override String get video_subtitle_next_cue_align => '下一句对齐到当前';
	@override String get video_subtitle_no_provider_hint => '请在 设置 → 下载 → 外部资源与字幕来源 中填写 Jimaku API key 或启用 OpenSubtitles。';
	@override String get video_subtitle_no_provider_title => '未配置字幕来源';
	@override String get video_subtitle_no_source_configured => '没找到字幕 · 去配置在线字幕来源';
	@override String get video_subtitle_off => '关闭字幕';
	@override String get video_subtitle_prev_cue_align => '上一句对齐到当前';
	@override String video_subtitle_read_failed({required Object label}) => '无法读取该字幕文件（内容损坏或为空）：${label}';
	@override String get video_subtitle_remote_host => 'Fushi 互联服务端字幕';
	@override String video_subtitle_remote_player_rendered({required Object label}) => '服务器无法抽取该字幕轨，已改由播放器直接渲染（不可逐字查词）：${label}';
	@override String get video_subtitle_replay => '重播本句';
	@override String get video_subtitle_retime_action => '用语音模型重定时';
	@override String video_subtitle_retime_done({required Object matched, required Object total, required Object percent, required Object ms}) => '已重定时 ${matched}/${total} 句（${percent}%），中位偏移 ${ms} ms';
	@override String video_subtitle_retime_dropped({required Object count}) => '已剔除 ${count} 条格式异常的字幕';
	@override String get video_subtitle_retime_failed => '字幕重定时失败';
	@override String video_subtitle_retime_low_match({required Object percent}) => '只有 ${percent}% 的句子对上了。检查语音语言是否选对、这份字幕是不是这一集的。';
	@override String get video_subtitle_retime_no_track => '先选一条字幕轨';
	@override String get video_subtitle_retime_running => '正在用语音模型重定时字幕…';
	@override String get video_subtitle_scope_collection => '整个合集';
	@override String get video_subtitle_scope_episode => '本集';
	@override String get video_subtitle_search_open => '在线搜索字幕';
	...
	@override String get video_subtitle_source_label => '来源';
	@override String get video_subtitle_source_search_hint => '先点上方的「查找字幕」，再在这里挑一个来源。';
	...
	@override String get video_torznab_settings_hint => '配置一个或多个 Jackett、Prowlarr 或兼容的 Torznab 端点。密钥绝不随备份导出；可随互联同步到已配对设备（可在互联设置中关闭）。';
	@override String get video_torznab_settings_title => 'Torznab 索引器';
	@override String get video_watch_progress_clear => '清除观看进度';
	@override String get video_watch_progress_cleared => '已清除观看进度';
	...
	@override String get video_work_field_backdrop => '背景图';
	@override String get video_work_field_cover => '封面';
	@override String get video_work_field_episode_group => 'TMDB 集编排';
	@override String get video_work_field_original_title => '原名';
	@override String get video_work_field_overview => '简介';
	@override String get video_work_field_rating => '评分';
	@override String get video_work_field_tagline => '标语';
	@override String get video_work_field_title => '标题';
	@override String get video_work_genres => '类型';
	@override String get video_work_keywords => '标签';
	@override String get video_work_locked_fields => '锁定字段';
	@override String get video_work_locked_fields_hint => '锁定的字段在下次刮削该作品时保留当前值。';
	@override String get video_work_locked_fields_saved => '字段锁已保存';
	@override String get video_work_metadata_pending => '尚未刮削详细资料。请在「来源」中重试此来源，然后重新打开作品。';
	...
	@override String get web_video_hide_native_subtitles => '隐藏站点字幕';
	@override String get web_video_hosting_builtin => '内置（1080p；可超分、可截图制卡）';
	@override String get web_video_hosting_menu => '播放模式';
	@override String get web_video_hosting_windowed => '原生窗口（4K 硬件 DRM；制卡先排队）';
	@override String get web_video_import_hint => '这是网页地址（非直链），将用内置网页播放器打开。';
	@override String get web_video_mine_queue_empty => '制卡队列为空';
	@override String web_video_mine_queue_finished({required Object ok, required Object failed}) => '制卡完成：成功 ${ok}，失败 ${failed}';
	@override String get web_video_mine_queue_run => '制作队列中的卡片';
	@override String web_video_mine_queue_running({required Object done, required Object total}) => '制卡中 ${done}/${total}…';
	@override String get web_video_mine_queue_stop => '停止制卡';
	@override String web_video_mine_queued({required Object count}) => '已加入制卡队列（待制 ${count} 张）';
	@override String web_video_mine_switch_builtin({required Object count}) => '切到内置模式制作 ${count} 张排队卡片';
	@override String get web_video_no_tracks => '尚未采集到字幕';
	@override String get web_video_platform_unsupported => '内置网页播放器目前仅支持 Windows。';
	@override String get web_video_player_unavailable => '内置网页播放器已暂时停用，此地址暂时无法在应用内播放。';
	@override String get web_video_track_live => '实时采集（页面字幕）';
	@override String get web_video_track_menu => '字幕轨';
