...
class _StringsZhCn extends _StringsEn {
	...
	@override String get dict_user_title => '用户词典';
	@override String get dict_user_entry_add => '添加词条';
	@override String get dict_user_entry_edit => '编辑词条';
	@override String get dict_user_entry_delete_confirm => '删除这条词条？';
	@override String get dict_user_field_expression => '词头';
	@override String get dict_user_field_reading => '读音';
	@override String get dict_user_field_meaning => '释义';
	@override String get dict_user_empty => '还没有词条，添加一条开始建立自己的词典。';
	@override String get dict_user_expression_required => '词头不能为空';
	@override String get dict_user_rebuild_failed => '用户词典重建失败';
	...
	@override String get onboarding_step_anki_body => '打开制卡设置，连接 AnkiConnect（桌面）或 AnkiDroid（安卓），并测试连接。';
	...
	@override String get onboarding_step_pack_browser_action => '浏览器下载（Google Drive）';
