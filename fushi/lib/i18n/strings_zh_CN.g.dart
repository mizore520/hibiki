...
class _StringsZhCn extends _StringsEn {
  ...
  @override
  String get game_lookup_samples_reference => '用于校准';
  @override
  String get game_lookup_samples_validation => '用于验证';
  @override
  ...
  String get game_lookup_samples_anchor_hint =>
      '先选择一个字，再点击截图中该字的中心。请在线首和行末附近各标一个点。';
  @override
  String get game_lookup_samples_fit => '按标记点对齐';
  @override
  String get game_lookup_samples_clear_anchors => '清除标记点';
  @override
  String get game_lookup_samples_fit_insufficient => '请在校准样本的同一行上至少标记两个字。';
  @override
  String get game_lookup_samples_fit_failed => '标记点无法匹配同一套排版，请检查标记或调整字体和换行。';
  @override
  String get game_lookup_samples_residual => '标记点偏差';
  @override
