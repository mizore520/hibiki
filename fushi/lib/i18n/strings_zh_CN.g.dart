...
class _StringsZhCn extends _StringsEn {
	...
	@override String get anime_download_search_start_hint => '在上方搜索作品名，自动匹配种子与字幕。下载不限视频：书籍、漫画、有声书、游戏也会自动入库。';
	...
	@override String get sync_err_peer_unreachable => '无法连接配对设备——对方可能不在线，或对端未运行 Fushi。';
	@override String get remote_book_list_failed => '无法获取配对设备的远端书库。';
	...
	@override String get sync_interconnect_service_config_toggle_desc => '经加密互联通道接收已配对主机的外部服务设定与 API key（Jimaku、TMDB、Torznab、OpenSubtitles、追番）。需启用 TLS。';
	...
	@override String get module_toggle_hint => '在底栏/侧栏显示该库页；关闭即隐藏';
	...
	@override String get manga_discovery_section_trending => '趋势';
	...
	@override String get manga_ocr_engine_paired_host_desc => '交给局域网里已配对的设备来跑，本机不下任何模型。';
	...
	@override String get module_tool_toggle_hint => '在底栏/侧栏显示该页；关闭即隐藏';
	...
	@override String get anki_error_paired_device_unreachable => '无法制卡：当前没有可连接的已配对设备。请确认配对设备上的 Fushi 正在运行；如果要在本机制卡，请关闭「制卡到已配对设备」。';
	...
	@override String get asr_models_section_summary => '有声书设备端转录用的模型，只下载你需要的语言。';
