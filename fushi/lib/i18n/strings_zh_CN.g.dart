...
class _StringsZhCn extends _StringsEn {
	...
	@override String get onboarding_welcome_headline => '欢迎使用！';
	@override String get onboarding_feature_anki => 'Anki 制卡';
	@override String get onboarding_feature_anki_hint => '连接 AnkiConnect / AnkiDroid，查词一键制卡';
	@override String get onboarding_feature_backup => '备份与同步';
	@override String get onboarding_feature_backup_hint => '把数据备份到 Google Drive、WebDAV 等后端';
	@override String get onboarding_feature_interconnect => '设备互联';
	@override String get onboarding_feature_interconnect_hint => '局域网配对多台设备，共享书库与进度';
	@override String get onboarding_step_dictionary_action => '打开词典管理';
	@override String get onboarding_step_anki_title => '配置 Anki';
	@override String get onboarding_step_anki_action => '打开制卡设置';
	@override String get onboarding_step_backup_title => '配置备份';
	@override String get onboarding_step_backup_body => '选择备份后端并登录，也可以导出本地备份文件。';
	@override String get onboarding_step_backup_action => '打开备份设置';
	@override String get onboarding_step_interconnect_title => '配置互联';
	@override String get onboarding_step_interconnect_body => '开启互联，与局域网内其他设备配对，共享书库、进度与查词。';
	@override String get onboarding_step_interconnect_action => '打开互联设置';
	@override String get onboarding_finish_title => '一切就绪';
	@override String get onboarding_finish_body => '之后随时可以在「设置 → 系统」里重新打开本引导。';
	...
	@override String get onboarding_welcome_body => '先选好界面语言与明暗主题，接下来会带你逐项完成配置。';
	@override String get onboarding_features_title => '选择要用的功能';
	@override String get onboarding_features_modules_label => '库页显示（未勾选的将从底栏隐藏，可随时在设置里改回）';
	@override String get onboarding_features_setup_label => '接下来要配置';
	@override String get onboarding_feature_manga => '漫画库';
	@override String get onboarding_feature_manga_hint => '看漫画，支持 OCR 查词';
	@override String get onboarding_feature_video => '视频库';
	@override String get onboarding_feature_video_hint => '看视频，字幕查词与制卡';
	@override String get onboarding_feature_games => 'Galgame 库';
	@override String get onboarding_feature_games_hint => '启动 galgame，文本 Hook 查词（仅 Windows）';
	@override String get onboarding_feature_pack => '推荐包（词典 + 发音音频）';
	@override String get onboarding_feature_pack_hint => '一次下载配好日语推荐词典与日/英发音音频库';
	@override String get onboarding_step_pack_title => '安装推荐包';
	@override String get onboarding_step_pack_body => '推荐包内含日语单词/音调/词频词典与日/英发音音频数据库。可在此直接下载并导入；导入会覆盖本地数据，建议在全新安装时进行。学其他语言可用「打开词典管理」自行导入词典。';
	...
	@override String get onboarding_step_extension_body => '安装配套浏览器扩展，在任意网页上查词。';
	@override String get onboarding_step_extension_action => '打开扩展安装引导';
	@override String get onboarding_step_fonts_title => '配置字体';
	@override String get onboarding_step_fonts_body => '导入自定义字体，并选择界面/正文/词典分别使用哪套字体。';
	...
	@override String get download_no_managed_video_source => '还没有受管视频来源。下载完成的视频需要一个本地视频文件夹才能入库。';
	...
	@override String get onboarding_feature_books => '小说库';
	@override String get onboarding_feature_books_hint => '看小说（EPUB），查词与有声书同步';
	@override String get onboarding_feature_extension_hint => '网页查词（仅桌面）';
	...
	@override String get video_source_scrape_anidb_client_hint => '已登记的 AniDB HTTP API 客户端名称；留空时仅使用缓存标题目录';
	@override String get video_source_scrape_anidb_client_version => 'AniDB 客户端版本';
	@override String get video_source_scrape_anidb_client_version_hint => '在 AniDB 登记的正整数版本；两项均有效前不会启用 HTTP API';
	...
	@override String get onboarding_anki_intro_body => 'Anki 是免费的间隔重复记忆软件：把生词做成卡片，按遗忘曲线安排每天复习。Fushi 查词后可一键制卡，把单词、释义、例句、发音和截图写进 Anki。';
	@override String get onboarding_anki_setup_desktop_hint => '先安装桌面版 Anki，再装 AnkiConnect 插件：在 Anki 里打开 工具 → 插件 → 获取插件，填入代码 2055492159。制卡时保持 Anki 在后台运行。';
	@override String get onboarding_anki_setup_ios_hint => '装有 AnkiMobile 即可直接加卡；要用完整功能，可经 AnkiConnect 连接同一局域网里电脑上的 Anki。';
	...
	@override String get onboarding_anki_mobile_ankiconnect_hint => '本机也能把卡制进同一局域网里电脑上的 Anki：在制卡设置里开启「改用 AnkiConnect」并填电脑地址。';
	@override String get onboarding_anki_setup_android_hint => '安装 AnkiDroid 并打开一次完成初始化。回到 Fushi 首次制卡时，在弹出的授权框里点「允许」即可——不需要去 AnkiDroid 设置里改任何开关。';
	@override String get onboarding_anki_install_addon_action => '一键安装 AnkiConnect 插件';
	@override String get onboarding_anki_addon_installed => '已装好 AnkiConnect：启动或重启 Anki，然后点「测试连接」。';
	@override String get onboarding_anki_addon_no_anki => '没找到 Anki 数据目录：请先安装 Anki 并打开一次，再回来重试。';
	...
	@override String get book_file_location_open => '打开文件位置';
	@override String get book_file_location_failed => '无法打开这本书的文件位置。';
	...
	@override String get onboarding_pack_action_download_desc => '在后台下载整个推荐包，下完自动进入导入。随时可以取消，下次从断点续传。';
	@override String get onboarding_pack_action_import_existing_desc => '包已经下好了，这里直接导入。确认框里选「合并到现有库」不会动你已有的数据。';
	@override String get onboarding_pack_action_pick_desc => '已经从别处拿到包的 zip？从硬盘导入，整段下载都可以跳过。';
	@override String get onboarding_pack_action_website => '在官网下载页打开';
	@override String get onboarding_pack_action_website_desc => '在浏览器打开官网。那里的推荐包一节给出可以喂给下载工具的分片直链；下完回到这里，用「选择本地包文件」导入。';
	@override String get onboarding_pack_action_dictionary_desc => '学日语以外的语言？跳过推荐包，在这里按语言导入词典。';
	@override String get onboarding_pack_action_audio_desc => '发音音频从哪里来。推荐包已经含日语和英语；其它语言在这里加在线来源。';
	@override String get onboarding_anki_action_test_desc => '检查 Fushi 能不能连上 Anki，并把你的牌组和笔记类型拉过来。这一步不会创建任何东西。';
	@override String get onboarding_anki_action_refresh_desc => '重新从 Anki 拉牌组和笔记类型。在 Anki 里新建了牌组之后点它。';
	@override String get onboarding_anki_action_get_ankidroid_desc => '打开 AnkiDroid 的商店页。Fushi 的卡片写进它里面，得先装上。';
	@override String get onboarding_anki_action_get_anki_desc => '打开 Anki 的下载页。装好 Anki，制卡时让它开着。';
	@override String get onboarding_anki_action_install_addon_desc => '把内置的 AnkiConnect 插件解压进 Anki——Fushi 靠它和 Anki 通话。装完重启 Anki。';
	@override String get onboarding_step_anki_action_desc => '卡片模板、字段映射、截图和音频——也就是「做出来的卡长什么样」。上面选好牌组和笔记类型就能开始制卡了，想改卡片怎么做才需要进来。';
	@override String get onboarding_step_backup_action_desc => '选备份后端并登录，换机器或丢设备时库还在。';
	@override String get onboarding_step_interconnect_action_desc => '把这台设备和你的其它设备配对，共享同一个库并同步进度。';
	@override String get onboarding_step_extension_action_desc => '告诉你怎么装浏览器扩展并连上 Fushi，之后在网页上也能查词。';
	@override String get onboarding_step_fonts_action_desc => '导入自己的字体文件，并给每种语言指定用哪个。';
	@override String get onboarding_pack_sources_hint => '同时从 GitHub、官网和备用镜像分片并发下载，每片都校验。下载过程中会实测各来源速度，哪家快就多分给哪家，所以这里不用你选。';
	...
	@override String get network_proxy_p2p_label => 'P2P（torrent）传输走代理';
	@override String get network_proxy_p2p_warning => '默认关闭，P2P 直连。走代理可能降低速度；且不少代理服务商禁止 BT 流量，可能导致代理账号被限速、警告甚至封禁。仅对内置引擎生效，外接 qBittorrent 请在其自身设置中配置。';
	...
	@override String get onboarding_click_lookup_nested_body => '点释义里的另一个词会展开下一层查词；返回或点弹窗外可关闭一层。';
	@override String get onboarding_click_lookup_mine_title => '把结果做成卡片';
	@override String get onboarding_click_lookup_mine_body => '确认词义后点加号（＋），把当前词、句子、音频和画面送到制卡器。';
	@override String get onboarding_step_global_lookup_title => '全局查词';
	@override String get onboarding_global_lookup_windows_body => '在 Windows 上，先在其他应用里选中文字，就能直接唤出词典，不必切回 Fushi。';
	@override String get onboarding_global_lookup_windows_select_title => '在任意应用里选中文字';
	@override String get onboarding_global_lookup_windows_shortcut_title => '按 Ctrl+Alt+D';
	@override String get onboarding_global_lookup_windows_shortcut_body => '这是默认全局快捷键。Fushi 会抓取当前选区，并在鼠标附近打开查词卡片。';
	@override String get onboarding_global_lookup_windows_customize_title => '需要时修改快捷键';
	@override String get onboarding_global_lookup_windows_customize_body => '前往设置 → 快捷键 → 全局（应用外），可以换成你习惯的组合键。';
	@override String get onboarding_global_lookup_windows_action => '打开快捷键设置';
	@override String get onboarding_global_lookup_windows_action_desc => '可修改应用外查词快捷键；默认 Ctrl+Alt+D 已可直接使用，因此不改也没关系。';
	@override String get onboarding_global_lookup_android_body => '在 Android 上，由系统通过文字菜单或分享面板把选中文本交给 Fushi；手机没有可自定义的全局快捷键。';
	@override String get onboarding_global_lookup_android_select_title => '在其他应用里选中文字';
	@override String get onboarding_global_lookup_android_open_title => '选择 Fushi';
	@override String get onboarding_global_lookup_android_open_body => '在文字选择菜单中点 Fushi；如果菜单没显示，就点分享，再从分享面板选择 Fushi。';
	@override String get onboarding_global_lookup_android_continue_title => '在独立弹窗中继续';
	@override String get onboarding_global_lookup_android_continue_body => '查词结果会独立打开；你可以继续点释义里的词，关闭后回到刚才的应用。';
	@override String get onboarding_feature_manual_resources => '手动导入词典和音频';
	@override String get onboarding_step_manual_resources_title => '手动准备词典和音频';
	@override String get onboarding_manual_dictionary_action => '导入词典';
	@override String get onboarding_manual_dictionary_action_desc => '打开词典管理，导入至少一个受支持的词典文件或压缩包。只有查词能返回释义后，后面的操作教程才有实际结果。';
	@override String get onboarding_manual_audiobook_action => '导入书籍和有声书音频';
	@override String get onboarding_manual_audiobook_action_desc => '打开书籍导入，选择书籍或文本、对齐字幕和一个或多个音频文件。音频需要配套字幕，Fushi 才能按句同步。';
	@override String get onboarding_manual_pronunciation_action => '配置单词发音音频';
	@override String get onboarding_manual_pronunciation_action_desc => '添加词典词条使用的本地或在线发音来源。它与附加到书籍的有声书音频是两套独立资源。';
	@override String get onboarding_lookup_verify_action => '先验证词典里有这个词';
	@override String get onboarding_lookup_verify_action_desc => '打开查词页，输入你正在学的任意词；确认当前已安装词典返回释义后，再用同一个词练习后续操作。教程不会写死示例词。';
	@override String get onboarding_step_first_anki_card_title => '完成第一张 Anki 卡片';
	@override String get onboarding_step_first_anki_card_body => '只有本次新手引导已连接 Anki，并选好了仍然可用的牌组和笔记类型，才会出现这一步。';
	@override String get onboarding_first_anki_lookup_title => '从真实词典结果开始';
	@override String get onboarding_first_anki_lookup_body => '查一个当前已安装词典确实能返回释义的词，不使用可能不存在于你词典里的固定示例词。';
	@override String get onboarding_first_anki_plus_title => '点词条上的加号';
	@override String get onboarding_first_anki_plus_body => '加号会打开制卡器，并带入当前单词、读音、释义、句子、音频和可用的画面上下文。';
	@override String get onboarding_first_anki_save_title => '检查后保存';
	@override String get onboarding_first_anki_save_body => '确认目标牌组、笔记类型和字段预览后保存，再打开 Anki 检查第一张卡是否已经写入。';
	@override String get onboarding_first_anki_action => '打开查词页并制卡';
	@override String get onboarding_first_anki_action_desc => '选择一个已经显示释义的词，点词条加号，检查字段后保存到刚才连接的 Anki 牌组。';
	@override String get onboarding_step_click_lookup_body => '先验证一个当前已安装词典确实能返回释义的词，再用同一个词练习书籍正文、漫画 OCR 文字和视频字幕里的点击查词。';
	@override String get onboarding_click_lookup_tap_body => '手机轻点刚才验证过的词中的一个字，电脑用鼠标左键单击。Fushi 会从这里开始匹配最长的词。';
	@override String get onboarding_global_lookup_windows_select_body => '拖选刚才已经验证能返回词典释义的同一个词，并保持文字处于选中状态。';
	@override String get onboarding_global_lookup_android_select_body => '长按刚才已经验证能返回词典释义的同一个词，再拖动选区手柄让它完整覆盖。';
	@override String get onboarding_feature_manual_resources_hint => '可补充推荐包，也可单独导入自己的词典、有声书和单词发音来源';
	@override String get onboarding_step_manual_resources_body => '这一项可以与推荐包同时使用，也可以单独使用。进入查词教程前至少导入一本词典；有声书音频和单词发音音频属于按需补充。';
