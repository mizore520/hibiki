...
class _StringsZhCn extends _StringsEn {
	...
	@override String get game_lookup_attached_calibration_failed => '校准未能应用。请检查正文、目标窗口和三个点击探针。';
	@override String get game_lookup_attached_calibration_paused => '游戏在后台或已隐藏，校准暂时暂停。用 Alt+Tab 切回游戏，等字形高亮出现后再点探针；这里仍可调整和确认。';
	@override String get game_lookup_attached_calibration_preparing => '正在准备点击保护，请先不要点击游戏台词。';
	@override String get game_lookup_attached_calibration_ready => '探针已就绪。请按顺序点击高亮字框内部；点击字框外仍会操作游戏。';
	@override String get game_lookup_attached_calibration_region_help => '请在这里调整正文区域，或在样本编辑器的截图上拖框。游戏中的覆盖层只接收高亮字形探针。';
	@override String get game_lookup_attached_calibration_short_text => '正文至少需要三个字符才能完成校准探针。';
	...
	@override String get game_lookup_attached_probe_waiting => '等待游戏内对应字形点击';
	@override String get game_lookup_attached_probes_hint => '请在游戏中依次点击高亮的首、中、尾字形，再确认下列字符。';
	...
	@override String get game_lookup_samples_advanced_hint => '多样本和可视化字格修正';
	@override String get game_lookup_samples_anchor_hint => '先选择一个字，再点击截图中该字的中心。请在线首和行末附近各标一个点。';
	@override String get game_lookup_samples_apply => '游戏校准';
	...
	@override String get game_lookup_samples_auto_current_hint => '默认只用当前选中的截图拟合；请选择一张包含至少两行完整台词的截图。';
	@override String get game_lookup_samples_auto_failed => '暂时无法可靠确定字格。请使用完整的多行台词，把正文框进来，避开名字和按钮；原草稿未改动。';
	@override String get game_lookup_samples_auto_geometry_out_of_bounds => '拟合范围超出截图。';
	@override String get game_lookup_samples_auto_geometry_weak => '缺少足够分散的字位置，无法确定排版。';
	@override String get game_lookup_samples_auto_grid => '已测量字格 · 无需调整字体';
	@override String get game_lookup_samples_auto_hint => '大致框住正文，自动测量字距、行距和换行。已有训练样本会共同参与，验证样本用于检查结果。';
	@override String get game_lookup_samples_auto_inconsistent => '样本的换行或字格不一致，无法应用同一套排版。请检查标出的样本是否截到了完整台词。';
	@override String get game_lookup_samples_auto_indent_ambiguous => '无法确定续行起点。';
	...
	@override String get game_lookup_samples_auto_text_alignment_weak => '检测到的文字与 Hook 正文对应较弱。';
	@override String get game_lookup_samples_auto_unsupported => '这张样本含有暂时无法验证宽度的字符，请暂用手动排版。';
	...
	@override String get game_lookup_samples_capture_source => '当前没有可采集的台词。请确认游戏已附着，且正文文本正在正常获取。';
	...
	@override String get game_lookup_samples_continuation_hint => '自定义第二行及后续行相对第一行的起点，所有文本使用同一数值；0 表示同一起点。';
	...
	@override String get game_lookup_samples_hint => '等台词完整显示后再采集。先采集几句不同台词，再调整排版。';
	...
	@override String get game_lookup_samples_manual_layout => '手动排版（高级）';
	@override String get game_lookup_samples_measured => '已标记样本';
	@override String get game_lookup_samples_narration => '旁白校准';
	@override String get game_lookup_samples_narration_hint => '只有台词和旁白的文字排版不一致时才需要单独校准；排版一致时无需进行旁白校准。';
	...
	@override String get game_lookup_samples_search_hint => '框住完整正文即可。只识别橙框内的内容，并保留你的选区；字符小框另行计算。调整选区后需重新自动对齐。';
