...
class _StringsZhCn extends _StringsEn {
	...
	@override String get onboarding_anki_fsrs_title => '把 Anki 算法换成 FSRS';
	@override String get onboarding_anki_fsrs_body => 'Anki 内置的 FSRS 算法远好于默认的 30 年前的 SM-2：记得更牢、复习量更少。请在 Anki 的 牌组选项 里打开 FSRS 开关（开一次全局生效）。这一步只能在 Anki 内手动完成。';
	@override String get onboarding_step_pack_browser_action => '浏览器下载';
