...
Require-Text '.github/workflows/release-desktop.yml' $desktopWorkflow 'tool/verify_windows_candidate.ps1' 'Windows release must pass the complete candidate bundle gate (BUG-1880)'
