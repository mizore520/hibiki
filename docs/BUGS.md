...
| BUG | 修复 | 测试 | 标题 |
|---|:--:|:--:|---|
| [BUG-1468](bugs/BUG-1468-windows-runtime-lock-preflight.md) | ✅ | ✅ | Windows 完整打包未提前检查运行组件占用 |
| [BUG-1467](bugs/BUG-1467-injector-attach-target-exit.md) | ✅ | ✅ | 附着模式游戏退出后 injector 不结束 |
