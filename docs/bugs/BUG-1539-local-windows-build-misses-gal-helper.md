## BUG-1539 · 本地 Windows 构建成功但未打包 galgame helper
...
- **[x] ② 已加自动化测试** — 测试同在 `6542fbd7d`；`fushi/test/mining/galgame_helper_installer_test.dart` 新增 BUG-1539 静态契约：钉住个人本地组包必须以 `-RunTests` 先调用 helper 构建，再调用共用安装脚本。
